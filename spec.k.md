...
#### forbid_clippy_lint_groups_any
**Description:** Structural: Forbid any allow() attribute (inner #![...] or outer #[...], alone or combined, arbitrary whitespace) for the broad clippy lint groups clippy::style, clippy::suspicious, clippy::complexity, clippy::perf, clippy::nursery, clippy::all across crates/**/*.rs. Also forbid equivalent suppressions in any Cargo.toml across the workspace under [lints.clippy] / [workspace.lints.clippy] (e.g. `clippy::all = "allow"`). These broad groups silence dozens of lints at once and must never be allowed.
...
**Description:** Structural: Forbid any allow() or expect() attribute (inner #![...] or outer #[...], bare or clippy:: prefix, alone or combined, arbitrary whitespace) for unsafe-correctness lints improper_ctypes (rustc), clippy::undocumented_unsafe_blocks, clippy::useless_transmute, clippy::missing_transmute_annotations across crates/**/*.rs. Also forbid equivalent suppressions in any Cargo.toml across the workspace under [lints.rust] / [lints.clippy] / [workspace.lints.rust] / [workspace.lints.clippy] (e.g. `useless_transmute = "allow"` or `= "expect"`). Word boundaries prevent false positives on longer identifiers.
...
#### forbid_unused_mut_assignments_workspace_any
**Description:** Structural: Forbid any allow() attribute (inner #![...] or outer #[...], bare or clippy:: prefix, alone or combined, arbitrary whitespace) for unused_mut and unused_assignments across crates/**/*.rs. Also forbid equivalent suppressions in any Cargo.toml across the workspace under [lints.rust] / [lints.clippy] / [workspace.lints.rust] / [workspace.lints.clippy] (e.g. `unused_mut = "allow"` at workspace root). Word boundaries prevent false positives on longer identifiers.
