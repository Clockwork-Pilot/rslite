...
pub use crate::src::headers::sqliteInt_h::sqlite3;pub use crate::src::src::vdbeapi::sqlite3_column_count;pub use crate::src::headers::vdbeInt_h::sqlite3_context;pub use crate::src::src::vtab::sqlite3_create_module;pub use crate::src::src::vtab::sqlite3_declare_vtab;pub use crate::src::headers::sqlite3_h::sqlite3_destructor_type;pub use crate::src::src::malloc::sqlite3_free;pub use crate::src::headers::sqlite3_h::sqlite3_index_constraint;pub use crate::src::headers::sqlite3_h::sqlite3_index_constraint_usage;pub use crate::src::headers::sqlite3_h::sqlite3_index_info;pub use crate::src::headers::sqlite3_h::sqlite3_index_orderby;pub use crate::src::headers::sqlite3_h::sqlite3_int64;pub use crate::src::src::malloc::sqlite3_malloc64;pub use crate::src::headers::sqlite3_h::sqlite3_module;pub use crate::src::src::vdbeapi::sqlite3_next_stmt;pub use crate::src::src::vdbeapi::sqlite3_result_int;pub use crate::src::src::vdbeapi::sqlite3_result_text;pub use crate::src::src::vdbeapi::sqlite3_sql;pub use crate::src::headers::sqlite3_h::sqlite3_stmt;pub use crate::src::src::vdbeapi::sqlite3_stmt_busy;pub use crate::src::src::vdbeapi::sqlite3_stmt_readonly;pub use crate::src::src::vdbeapi::sqlite3_stmt_status;pub use crate::src::headers::sqlite3_h::sqlite3_uint64;pub use crate::src::headers::vdbeInt_h::sqlite3_value;pub use crate::src::headers::sqlite3_h::sqlite3_vtab;pub use crate::src::headers::sqlite3_h::sqlite3_vtab_cursor;pub use crate::src::headers::sqlite3_h::sqlite_int64;pub use crate::src::headers::sqlite3_h::sqlite_uint64;pub use crate::src::headers::sqlite3_h::SQLITE_NOMEM;pub use crate::src::headers::sqlite3_h::SQLITE_OK;pub use crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_AUTOINDEX;pub use crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_FULLSCAN_STEP;pub use crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_MEMUSED;pub use crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_REPREPARE;pub use crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_RUN;pub use crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_SORT;pub use crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_VM_STEP;
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn stmtConnect(
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        pNew = crate::src::src::malloc::sqlite3_malloc64(::core::mem::size_of::<stmt_vtab>() as crate::src::headers::sqlite3_h::sqlite3_uint64)
            as *mut stmt_vtab;
...
unsafe extern "C" fn stmtDisconnect(mut pVtab: *mut crate::src::headers::sqlite3_h::sqlite3_vtab) -> ::core::ffi::c_int {
...
unsafe extern "C" fn stmtOpen(
    ...
    pCur = crate::src::src::malloc::sqlite3_malloc64(::core::mem::size_of::<stmt_cursor>() as crate::src::headers::sqlite3_h::sqlite3_uint64)
        as *mut stmt_cursor;
    if pCur.is_null() {
        return crate::src::headers::sqlite3_h::SQLITE_NOMEM;
    }
...
unsafe extern "C" fn stmtClose(mut cur: *mut crate::src::headers::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int {
...
unsafe extern "C" fn stmtEof(mut cur: *mut crate::src::headers::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int {
    let pCur = &*(cur as *mut stmt_cursor);
...
unsafe extern "C" fn stmtFilter(
    ...
    let mut iRowid: crate::src::headers::sqlite3_h::sqlite3_int64 = 1 as crate::src::headers::sqlite3_h::sqlite3_int64;
    let mut ppRow: *mut *mut StmtRow = ::core::ptr::null_mut::<*mut StmtRow>();
    stmtCsrReset(pCur);
    ppRow = &raw mut (*pCur).pRow;
    p = crate::src::src::vdbeapi::sqlite3_next_stmt((*pCur).db, ::core::ptr::null_mut::<crate::src::headers::sqlite3_h::sqlite3_stmt>());
    while !p.is_null() {
        ...
        __pNew_ref.aCol[STMT_COLUMN_NSCAN as usize] =
            crate::src::src::vdbeapi::sqlite3_stmt_status(p, crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_FULLSCAN_STEP, 0 as ::core::ffi::c_int);
        __pNew_ref.aCol[STMT_COLUMN_NSORT as usize] =
            crate::src::src::vdbeapi::sqlite3_stmt_status(p, crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_SORT, 0 as ::core::ffi::c_int);
        __pNew_ref.aCol[STMT_COLUMN_NAIDX as usize] =
            crate::src::src::vdbeapi::sqlite3_stmt_status(p, crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_AUTOINDEX, 0 as ::core::ffi::c_int);
        __pNew_ref.aCol[STMT_COLUMN_NSTEP as usize] =
            crate::src::src::vdbeapi::sqlite3_stmt_status(p, crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_VM_STEP, 0 as ::core::ffi::c_int);
        __pNew_ref.aCol[STMT_COLUMN_REPREP as usize] =
            crate::src::src::vdbeapi::sqlite3_stmt_status(p, crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_REPREPARE, 0 as ::core::ffi::c_int);
        __pNew_ref.aCol[STMT_COLUMN_RUN as usize] =
            crate::src::src::vdbeapi::sqlite3_stmt_status(p, crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_RUN, 0 as ::core::ffi::c_int);
        __pNew_ref.aCol[STMT_COLUMN_MEM as usize] =
            crate::src::src::vdbeapi::sqlite3_stmt_status(p, crate::src::headers::sqlite3_h::SQLITE_STMTSTATUS_MEMUSED, 0 as ::core::ffi::c_int);
        let fresh0 = iRowid;
        iRowid += 1;
...
static mut stmtModule: crate::src::headers::sqlite3_h::sqlite3_module = unsafe {
    ...
    xDisconnect:  Some(
            stmtDisconnect as unsafe extern "C" fn(*mut crate::src::headers::sqlite3_h::sqlite3_vtab) -> ::core::ffi::c_int,
        ),
    xDestroy:  None,
    xOpen:  Some(
            stmtOpen
    ...
    xClose:  Some(
            stmtClose as unsafe extern "C" fn(*mut crate::src::headers::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int,
        ),
    xFilter:  Some(
            stmtFilter
                as unsafe extern "C" fn(
    ...
    xNext:  Some(
            stmtNext as unsafe extern "C" fn(*mut crate::src::headers::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int,
        ),
    xEof:  Some(stmtEof as unsafe extern "C" fn(*mut crate::src::headers::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int),
    xColumn:  Some(
            stmtColumn
                as unsafe extern "C" fn(
                    *mut crate::src::headers::sqlite3_h::sqlite3_vtab_cursor,
