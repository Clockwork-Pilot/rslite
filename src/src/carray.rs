...
unsafe extern "C" fn carrayConnect(
    ...
    if rc == SQLITE_OK {
        *ppVtab = sqlite3_malloc(::core::mem::size_of::<sqlite3_vtab>() as ::core::ffi::c_int)
            as *mut sqlite3_vtab;
        pNew = *ppVtab;
        if pNew.is_null() {
            return SQLITE_NOMEM;
...
unsafe extern "C" fn carrayDisconnect(mut pVtab: *mut sqlite3_vtab) -> ::core::ffi::c_int {
...
unsafe extern "C" fn carrayOpen(
    ...
    pCur = sqlite3_malloc(::core::mem::size_of::<carray_cursor>() as ::core::ffi::c_int)
    ...
    memset(
        ...
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<carray_cursor>() as size_t,
    );
    *ppCursor = &raw mut (*pCur).base;
    return SQLITE_OK;
}
unsafe extern "C" fn carrayClose(mut cur: *mut sqlite3_vtab_cursor) -> ::core::ffi::c_int {
    sqlite3_free(cur as *mut ::core::ffi::c_void);
    return SQLITE_OK;
}
unsafe extern "C" fn carrayNext(mut cur: *mut sqlite3_vtab_cursor) -> ::core::ffi::c_int {
    ...
    match i {
        ...
        _ => match (*pCur).eType as ::core::ffi::c_int {
            CARRAY_INT32 => {
                ...
                sqlite3_result_int(
                    ctx,
                    *p.offset(((*pCur).iRowid - 1 as sqlite3_int64) as isize),
                );
                return SQLITE_OK;
            }
            CARRAY_INT64 => {
                let mut p_0: *mut sqlite3_int64 = (*pCur).pPtr as *mut sqlite3_int64;
                sqlite3_result_int64(
                    ctx,
                    *p_0.offset(((*pCur).iRowid - 1 as sqlite3_int64) as isize),
                );
                return SQLITE_OK;
            }
            CARRAY_DOUBLE => {
                ...
                sqlite3_result_double(
                    ctx,
                    *p_1.offset(((*pCur).iRowid - 1 as sqlite3_int64) as isize),
                );
                return SQLITE_OK;
            }
            CARRAY_TEXT => {
                ...
                sqlite3_result_text(
                    ctx,
                    *p_2.offset(((*pCur).iRowid - 1 as sqlite3_int64) as isize),
                    -(1 as ::core::ffi::c_int),
                    ::core::mem::transmute::<
                        ::libc::intptr_t,
            ...
            _ => {
                let mut p_3: *const iovec = (*pCur).pPtr as *mut iovec;
                sqlite3_result_blob(
                    ctx,
                    (*p_3.offset(((*pCur).iRowid - 1 as sqlite3_int64) as isize)).iov_base,
                    (*p_3.offset(((*pCur).iRowid - 1 as sqlite3_int64) as isize)).iov_len
                        as ::core::ffi::c_int,
                    ::core::mem::transmute::<
                        ::libc::intptr_t,
                        Option<unsafe extern "C" fn(*mut ::core::ffi::c_void) -> ()>,
...
unsafe extern "C" fn carrayEof(mut cur: *mut sqlite3_vtab_cursor) -> ::core::ffi::c_int {
    let mut pCur: *mut carray_cursor = cur as *mut carray_cursor;
...
unsafe extern "C" fn carrayFilter(
    ...
    (*pCur).iCnt = 0 as sqlite3_int64;
    match idxNum {
        1 => {
            let mut pBind: *mut carray_bind = sqlite3_value_pointer(
                *argv.offset(0 as ::core::ffi::c_int as isize),
                b"carray-bind\0" as *const u8 as *const ::core::ffi::c_char,
            ) as *mut carray_bind;
            if !pBind.is_null() {
                (*pCur).pPtr = (*pBind).aData;
                (*pCur).iCnt = (*pBind).nData as sqlite3_int64;
                (*pCur).eType =
                    ((*pBind).mFlags & 0x7 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
            }
        }
        2 | 3 => {
            (*pCur).pPtr = sqlite3_value_pointer(
                *argv.offset(0 as ::core::ffi::c_int as isize),
            ...
            if idxNum < 3 as ::core::ffi::c_int {
                (*pCur).eType = CARRAY_INT32 as ::core::ffi::c_uchar;
            } else {
                ...
                {
                    if sqlite3_stricmp(zType, azCarrayType[i as usize]) == 0 as ::core::ffi::c_int {
                        break;
                    }
                    i = i.wrapping_add(1);
                }
...
unsafe extern "C" fn carrayBestIndex(
    ...
    if ptrIdx >= 0 as ::core::ffi::c_int {
        ...
        (*pIdxInfo).estimatedRows = 100 as sqlite3_int64;
...
static mut carrayModule: sqlite3_module = unsafe {
    sqlite3_module {
        ...
        xDisconnect: Some(
            carrayDisconnect as unsafe extern "C" fn(*mut sqlite3_vtab) -> ::core::ffi::c_int,
        ),
        xDestroy: None,
        xOpen: Some(
            carrayOpen
        ...
        xClose: Some(
            carrayClose as unsafe extern "C" fn(*mut sqlite3_vtab_cursor) -> ::core::ffi::c_int,
        ),
        xFilter: Some(
            carrayFilter
                as unsafe extern "C" fn(
        ...
        xNext: Some(
            carrayNext as unsafe extern "C" fn(*mut sqlite3_vtab_cursor) -> ::core::ffi::c_int,
        ),
        xEof: Some(
            carrayEof as unsafe extern "C" fn(*mut sqlite3_vtab_cursor) -> ::core::ffi::c_int,
        ),
        xColumn: Some(
            carrayColumn
                as unsafe extern "C" fn(
...
pub unsafe extern "C" fn sqlite3_carray_bind(
    ...
    if mFlags < CARRAY_INT32 || mFlags > CARRAY_BLOB {
        ...
        pNew = sqlite3_malloc64(::core::mem::size_of::<carray_bind>() as sqlite3_uint64)
            as *mut carray_bind;
        if pNew.is_null() {
            rc = SQLITE_NOMEM;
        } else {
            ...
            {
                let mut sz: sqlite3_int64 = nData as sqlite3_int64;
                match mFlags {
                    CARRAY_INT32 => {
                        sz *= 4 as sqlite3_int64;
                    }
                    CARRAY_INT64 => {
                        sz *= 8 as sqlite3_int64;
                    }
                    CARRAY_DOUBLE => {
                        sz *= 8 as sqlite3_int64;
                    }
                ...
                if mFlags == CARRAY_TEXT {
                        ...
                        if !z.is_null() {
                            sz =
                                (sz as ::core::ffi::c_ulonglong)
                                    .wrapping_add(strlen(z).wrapping_add(1 as size_t)
                                        as ::core::ffi::c_ulonglong)
                                    as sqlite3_int64
                                    as sqlite3_int64;
                        }
                    ...
                    while i < nData {
                        sz = (sz as ::core::ffi::c_ulonglong).wrapping_add(
                            (*(aData as *mut iovec).offset(i as isize)).iov_len
                                as ::core::ffi::c_ulonglong,
                        ) as sqlite3_int64 as sqlite3_int64;
                        i += 1;
                    }
                }
                (*pNew).aData = sqlite3_malloc64(sz as sqlite3_uint64);
                    ...
                    if mFlags == CARRAY_TEXT {
                        ...
                        while i < nData {
                            ...
                            if zData.is_null() {
                                ...
                                *fresh1 = z_0;
                                n = strlen(zData) as sqlite3_int64;
                                memcpy(
                                    z_0 as *mut ::core::ffi::c_void,
                                    zData as *const ::core::ffi::c_void,
                                    (n + 1 as sqlite3_int64) as size_t,
                                );
                                z_0 = z_0.offset((n + 1 as sqlite3_int64) as isize);
                            }
                            i += 1;
                        }
                    } else if mFlags == CARRAY_BLOB {
                        let mut p: *mut iovec = (*pNew).aData as *mut iovec;
                        let mut z_1: *mut ::core::ffi::c_uchar =
                            p.offset(nData as isize) as *mut iovec as *mut ::core::ffi::c_uchar;
                        i = 0 as ::core::ffi::c_int;
                        while i < nData {
                            let mut n_0: size_t =
                                (*(aData as *mut iovec).offset(i as isize)).iov_len;
                        ...
                        memcpy((*pNew).aData, aData, sz as size_t);
                    }
                    (*pNew).xDel =
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3CarrayRegister(mut db: *mut sqlite3) -> *mut Module {
    return sqlite3VtabCreateModule(
        db,
        b"carray\0" as *const u8 as *const ::core::ffi::c_char,
        &raw mut carrayModule,
