...
unsafe extern "C" fn dbpageConnect(
    ...
    crate::src::src::vtab::sqlite3_vtab_config(db as *mut crate::src::headers::sqliteInt_h::sqlite3, crate::src::headers::sqlite3_h::SQLITE_VTAB_USES_ALL_SCHEMAS);
