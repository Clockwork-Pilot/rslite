...
unsafe extern "C" fn statConnect(
    ...
    if argc >= 4 as ::core::ffi::c_int {
        let mut nm: crate::sqliteInt_h::Token = crate::sqliteInt_h::Token {
    ...
    crate::src::src::vtab::sqlite3_vtab_config(db as *mut crate::sqliteInt_h::sqlite3, crate::sqlite3_h::SQLITE_VTAB_DIRECTONLY);
    rc = crate::src::src::vtab::sqlite3_declare_vtab(db as *mut crate::sqliteInt_h::sqlite3, &raw const zDbstatSchema as *const ::core::ffi::c_char);
    if rc == crate::sqlite3_h::SQLITE_OK {
        pTab = crate::src::src::malloc::sqlite3_malloc64(::core::mem::size_of::<StatTable>() as crate::sqlite3_h::sqlite3_uint64)
            as *mut StatTable;
        if pTab.is_null() {
...
unsafe extern "C" fn statOpen(
    ...
    pCsr =
        crate::src::src::malloc::sqlite3_malloc64(::core::mem::size_of::<StatCursor>() as crate::sqlite3_h::sqlite3_uint64) as *mut StatCursor;
    if pCsr.is_null() {
...
unsafe extern "C" fn statClose(mut pCursor: *mut crate::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int {
...
unsafe extern "C" fn statDecodePage(
    mut pBt: *mut crate::btreeInt_h::Btree,
    mut p: *mut StatPage,
) -> ::core::ffi::c_int {
...
unsafe extern "C" fn statSizeAndOffset(mut pCsr: *mut StatCursor) {
    let mut pTab: *mut StatTable = (*(pCsr as *mut crate::sqlite3_h::sqlite3_vtab_cursor)).pVtab as *mut StatTable;
    let mut pBt: *mut crate::btreeInt_h::Btree = (*(*(*pTab).db).aDb.offset((*pTab).iDb as isize)).pBt;
    ...
    let mut x: [crate::sqlite3_h::sqlite3_int64; 2] = [0; 2];
    fd =  crate::src::src::pager::sqlite3PagerFile(pPager) as
    *mut crate::sqlite3_h::sqlite3_file;
    x[0 as ::core::ffi::c_int as usize] = (*pCsr).iPageno as crate::sqlite3_h::sqlite3_int64;
    ...
    ) == crate::sqlite3_h::SQLITE_OK
    {
        ...
        (*pCsr).szPage += x[1 as ::core::ffi::c_int as usize] as crate::sqlite3_h::sqlite_int64;
    } else {
        let __pCsr_ref = unsafe { &mut *pCsr };
...
unsafe extern "C" fn statNext(mut pCursor: *mut crate::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int {
    ...
    let __pCsr_ref = unsafe { &mut *pCsr };
    let mut pBt: *mut crate::btreeInt_h::Btree = (*(*(*pTab).db).aDb.offset(__pCsr_ref.iDb as isize)).pBt;
    let mut pPager: *mut crate::src::src::pager::Pager = crate::src::src::btree::sqlite3BtreePager(pBt) as *mut crate::src::src::pager::Pager;
    crate::src::src::malloc::sqlite3_free(__pCsr_ref.zPath as *mut ::core::ffi::c_void);
    __pCsr_ref.zPath = ::core::ptr::null_mut::<::core::ffi::c_char>();
    loop {
...
unsafe extern "C" fn statFilter(
    ...
    pSql =  crate::src::src::printf::sqlite3_str_new((*pTab).db as *mut crate::sqliteInt_h::sqlite3) as
    *mut crate::sqliteInt_h::sqlite3_str;
    crate::src::src::printf::sqlite3_str_appendf(
        
        pSql as *mut crate::sqliteInt_h::sqlite3_str,
    ...
    zSql = crate::src::src::printf::sqlite3_str_finish(pSql as *mut crate::sqliteInt_h::sqlite3_str);
    if zSql.is_null() {
        return crate::sqliteInt_h::SQLITE_NOMEM_BKPT;
    } else {
        rc = crate::src::src::prepare::sqlite3_prepare_v2(
            
            (*pTab).db as *mut crate::sqliteInt_h::sqlite3,
            zSql,
            -(1 as ::core::ffi::c_int),
...
unsafe extern "C" fn statColumn(
    ...
    match i {
        ...
        2 => {
            if (*pCsr).isAgg != 0 {
                crate::src::src::vdbeapi::sqlite3_result_int64(ctx, (*pCsr).nPage as crate::sqlite3_h::sqlite3_int64);
            } else {
                crate::src::src::vdbeapi::sqlite3_result_int64(ctx, (*pCsr).iPageno as crate::sqlite3_h::sqlite3_int64);
            }
        }
        3 => {
            if (*pCsr).isAgg == 0 {
        ...
        4 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(ctx, (*pCsr).nCell as crate::sqlite3_h::sqlite3_int64);
        }
        5 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(ctx, (*pCsr).nPayload as crate::sqlite3_h::sqlite3_int64);
        }
        6 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(ctx, (*pCsr).nUnused as crate::sqlite3_h::sqlite3_int64);
        }
        7 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(ctx, (*pCsr).nMxPayload as crate::sqlite3_h::sqlite3_int64);
        }
        8 => {
            if (*pCsr).isAgg == 0 {
                crate::src::src::vdbeapi::sqlite3_result_int64(ctx, (*pCsr).iOffset as crate::sqlite3_h::sqlite3_int64);
            }
        }
        9 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(ctx, (*pCsr).szPage as crate::sqlite3_h::sqlite3_int64);
        }
        10 => {
...
pub unsafe extern "C" fn sqlite3DbstatRegister(mut db: *mut crate::sqliteInt_h::sqlite3) -> ::core::ffi::c_int {
    static mut dbstat_module: crate::sqlite3_h::sqlite3_module = unsafe {
    ...
    xDisconnect:  Some(
                statDisconnect as unsafe extern "C" fn(*mut crate::sqlite3_h::sqlite3_vtab) -> ::core::ffi::c_int,
            ),
    xDestroy:  Some(
                statDisconnect as unsafe extern "C" fn(*mut crate::sqlite3_h::sqlite3_vtab) -> ::core::ffi::c_int,
            ),
    ...
    xClose:  Some(
                statClose as unsafe extern "C" fn(*mut crate::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int,
            ),
    xFilter:  Some(
                statFilter
                    as unsafe extern "C" fn(
    ...
    xNext:  Some(
                statNext as unsafe extern "C" fn(*mut crate::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int,
            ),
    xEof:  Some(
                statEof as unsafe extern "C" fn(*mut crate::sqlite3_h::sqlite3_vtab_cursor) -> ::core::ffi::c_int,
            ),
    xColumn:  Some(
                statColumn
                    as unsafe extern "C" fn(
