...
pub unsafe extern "C" fn sqlite3_status64(
    mut op: ::core::ffi::c_int,
    mut pCurrent: *mut crate::sqlite3_h::sqlite3_int64,
    mut pHighwater: *mut crate::sqlite3_h::sqlite3_int64,
    ...
    *pCurrent = sqlite3Stat.nowValue[op as usize] as crate::sqlite3_h::sqlite3_int64;
    *pHighwater = sqlite3Stat.mxValue[op as usize] as crate::sqlite3_h::sqlite3_int64;
    if resetFlag != 0 {
        sqlite3Stat.mxValue[op as usize] = sqlite3Stat.nowValue[op as usize];
    }
...
pub unsafe extern "C" fn sqlite3_status(
    ...
    let mut iCur: crate::sqlite3_h::sqlite3_int64 = 0 as crate::sqlite3_h::sqlite3_int64;
    let mut iHwtr: crate::sqlite3_h::sqlite3_int64 = 0 as crate::sqlite3_h::sqlite3_int64;
...
pub unsafe extern "C" fn sqlite3_db_status64(
    ...
    mut op: ::core::ffi::c_int,
    mut pCurrent: *mut crate::sqlite3_h::sqlite3_int64,
    mut pHighwtr: *mut crate::sqlite3_h::sqlite3_int64,
    mut resetFlag: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    ...
    match  op {
    crate::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_USED =>  {
            let mut H: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
            *pCurrent = sqlite3LookasideUsed(db, &raw mut H) as crate::sqlite3_h::sqlite3_int64;
            *pHighwtr = H as crate::sqlite3_h::sqlite3_int64;
            if resetFlag != 0 {
                let mut p: *mut crate::sqliteInt_h::LookasideSlot = (*db).lookaside.pFree;
                if !p.is_null() {
    ...
    crate::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_HIT |
        crate::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_MISS_SIZE |
        crate::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_MISS_FULL =>  {
            *pCurrent = 0 as crate::sqlite3_h::sqlite3_int64;
            *pHighwtr = (*db).lookaside.anStat[(op - crate::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_HIT) as usize]
                as crate::sqlite3_h::sqlite3_int64;
            if resetFlag != 0 {
                (*db).lookaside.anStat[(op - crate::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_HIT) as usize] = 0 as crate::src::ext::rtree::rtree::u32_0;
            }
            current_block_105 = 6406431739208918833;
        }
    crate::sqlite3_h::SQLITE_DBSTATUS_CACHE_USED_SHARED |
        crate::sqlite3_h::SQLITE_DBSTATUS_CACHE_USED =>  {
            let mut totalUsed: crate::sqlite3_h::sqlite3_int64 = 0 as crate::sqlite3_h::sqlite3_int64;
    ...
    crate::sqlite3_h::SQLITE_DBSTATUS_SCHEMA_USED =>  {
    ...
    crate::sqlite3_h::SQLITE_DBSTATUS_CACHE_SPILL =>  {
            op = crate::sqlite3_h::SQLITE_DBSTATUS_CACHE_WRITE + 1 as ::core::ffi::c_int;
            current_block_105 = 2723324002591448311;
        }
    crate::sqlite3_h::SQLITE_DBSTATUS_CACHE_HIT_1 |
        crate::sqlite3_h::SQLITE_DBSTATUS_CACHE_MISS |
        crate::sqlite3_h::SQLITE_DBSTATUS_CACHE_WRITE =>  {
            current_block_105 = 2723324002591448311;
        }
    crate::sqlite3_h::SQLITE_DBSTATUS_TEMPBUF_SPILL =>  {
            ...
            *pHighwtr = 0 as crate::sqlite3_h::sqlite3_int64;
            *pCurrent = nRet_0 as crate::sqlite3_h::sqlite3_int64;
            current_block_105 = 6406431739208918833;
        }
    crate::sqlite3_h::SQLITE_DBSTATUS_DEFERRED_FKS_1 =>  {
            *pHighwtr = 0 as crate::sqlite3_h::sqlite3_int64;
            *pCurrent = ((*db).nDeferredImmCons > 0 as crate::src::ext::rtree::rtree::i64_0 || (*db).nDeferredCons > 0 as crate::src::ext::rtree::rtree::i64_0)
                as ::core::ffi::c_int as crate::sqlite3_h::sqlite3_int64;
            current_block_105 = 6406431739208918833;
        }
    _ =>  {
    ...
    match current_block_105 {
        2723324002591448311 => {
            ...
            *pHighwtr = 0 as crate::sqlite3_h::sqlite3_int64;
            *pCurrent = nRet as crate::sqlite3_h::sqlite3_int64;
        }
        _ => {}
    }
...
pub unsafe extern "C" fn sqlite3_db_status(
    ...
    let mut C: crate::sqlite3_h::sqlite3_int64 = 0 as crate::sqlite3_h::sqlite3_int64;
    let mut H: crate::sqlite3_h::sqlite3_int64 = 0 as crate::sqlite3_h::sqlite3_int64;
    let mut rc: ::core::ffi::c_int = 0;
