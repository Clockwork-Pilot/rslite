...
pub unsafe extern "C" fn sqlite3VdbeExpandSql(
    ...
    let mut out: crate::src::headers::sqliteInt_h::StrAccum = crate::src::headers::sqliteInt_h::sqlite3_str {
    ...
    *mut crate::src::headers::sqliteInt_h::sqlite3,
    ...
    if (*db).nVdbeExec > 1 as ::core::ffi::c_int {
        while *zRawSql != 0 {
            ...
            crate::src::src::printf::sqlite3_str_append(
                ...
                &raw mut out as *mut _ as *mut crate::src::headers::sqliteInt_h::sqlite3_str,
                zStart,
                zRawSql.offset_from(zStart) as ::core::ffi::c_long as ::core::ffi::c_int,
            );
        }
    } else if (*p).nVar as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
        crate::src::src::printf::sqlite3_str_append(&raw mut out as *mut _ as *mut crate::src::headers::sqliteInt_h::sqlite3_str, zRawSql, crate::src::src::util::sqlite3Strlen30(zRawSql));
    } else {
        while *zRawSql.offset(0 as isize) != 0 {
            n = findNextHostParameter(zRawSql, &raw mut nToken);
            crate::src::src::printf::sqlite3_str_append(&raw mut out as *mut _ as *mut crate::src::headers::sqliteInt_h::sqlite3_str, zRawSql, n as ::core::ffi::c_int);
            ...
            if *zRawSql.offset(0 as isize) as ::core::ffi::c_int == '?' as i32
            {
                ...
                idx = crate::src::src::vdbeapi::sqlite3VdbeParameterIndex(p as *mut crate::src::headers::vdbeInt_h::Vdbe, zRawSql, nToken as ::core::ffi::c_int);
            }
            zRawSql = zRawSql.offset(nToken as isize);
            nextIndex = if idx + 1 as ::core::ffi::c_int > nextIndex {
                idx + 1 as ::core::ffi::c_int
            } else {
                nextIndex
            };
            pVar = (*p).aVar.offset((idx - 1 as ::core::ffi::c_int) as isize) as *mut crate::src::src::vdbe::Mem;
            if (*pVar).flags as ::core::ffi::c_int & crate::src::headers::vdbeInt_h::MEM_Null != 0 {
                crate::src::src::printf::sqlite3_str_append(
                ...
                if enc as ::core::ffi::c_int != crate::src::headers::sqlite3_h::SQLITE_UTF8 {
                    ...
                    crate::src::src::vdbemem::sqlite3VdbeMemSetStr(
                        ...
                        &raw mut utf8 as *mut _ as *mut crate::src::headers::vdbeInt_h::sqlite3_value,
                        (*pVar).z,
                        (*pVar).n as crate::src::ext::rtree::rtree::i64_0,
                        enc,
                        crate::src::headers::sqlite3_h::SQLITE_STATIC,
                    );
                    if crate::src::headers::sqlite3_h::SQLITE_NOMEM == crate::src::src::vdbemem::sqlite3VdbeChangeEncoding(&raw mut utf8 as *mut _ as *mut crate::src::headers::vdbeInt_h::sqlite3_value, crate::src::headers::sqlite3_h::SQLITE_UTF8) {
                        out.accError = crate::src::headers::sqlite3_h::SQLITE_NOMEM as crate::src::ext::rtree::rtree::u8_0;
                        out.nAlloc = 0 as crate::src::ext::rtree::rtree::u32_0;
                    }
                    pVar = &raw mut utf8;
                }
                nOut = (*pVar).n;
    ...
    if out.accError != 0 {
        crate::src::src::printf::sqlite3_str_reset(&raw mut out as *mut _ as *mut crate::src::headers::sqliteInt_h::sqlite3_str);
    }
    crate::src::src::printf::sqlite3StrAccumFinish(&raw mut out as *mut _ as *mut crate::src::headers::sqliteInt_h::sqlite3_str)
}
