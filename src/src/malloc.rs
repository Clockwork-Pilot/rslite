...
pub struct Mem0Global {
    ...
    pub alarmThreshold: crate::sqlite3_h::sqlite3_int64,
    pub hardLimit: crate::sqlite3_h::sqlite3_int64,
...
static mut mem0: Mem0Global = Mem0Global {
    ...
    alarmThreshold: SQLITE_MAX_MEMORY as crate::sqlite3_h::sqlite3_int64,
    hardLimit: SQLITE_MAX_MEMORY as crate::sqlite3_h::sqlite3_int64,
...
pub unsafe extern "C" fn sqlite3_memory_alarm(
    mut _xCallback: Option<
        unsafe extern "C" fn(*mut ::core::ffi::c_void, crate::sqlite3_h::sqlite3_int64, ::core::ffi::c_int) -> (),
    >,
    mut _pArg: *mut ::core::ffi::c_void,
    mut _iThreshold: crate::sqlite3_h::sqlite3_int64,
) -> ::core::ffi::c_int {
    return crate::sqlite3_h::SQLITE_OK;
}
#[no_mangle]

pub unsafe extern "C" fn sqlite3_soft_heap_limit64(mut n: crate::sqlite3_h::sqlite3_int64) -> crate::sqlite3_h::sqlite3_int64 {
    let mut priorLimit: crate::sqlite3_h::sqlite3_int64 = 0;
    let mut excess: crate::sqlite3_h::sqlite3_int64 = 0;
    let mut nUsed: crate::sqlite3_h::sqlite3_int64 = 0;
    let mut rc: ::core::ffi::c_int = crate::src::src::main::sqlite3_initialize();
    if rc != 0 {
        return -(1 as ::core::ffi::c_int) as crate::sqlite3_h::sqlite3_int64;
    }
    crate::src::src::mutex::sqlite3_mutex_enter(mem0.mutex);
    priorLimit = mem0.alarmThreshold;
    if n < 0 as crate::sqlite3_h::sqlite3_int64 {
        crate::src::src::mutex::sqlite3_mutex_leave(mem0.mutex);
        return priorLimit;
    }
    if mem0.hardLimit > 0 as crate::sqlite3_h::sqlite3_int64 && (n > mem0.hardLimit || n == 0 as crate::sqlite3_h::sqlite3_int64) {
        n = mem0.hardLimit;
    }
    mem0.alarmThreshold = n;
    nUsed = crate::src::src::status::sqlite3StatusValue(crate::sqlite3_h::SQLITE_STATUS_MEMORY_USED);
    ::core::intrinsics::atomic_store_relaxed(
        &raw mut mem0.nearlyFull,
        (n > 0 as crate::sqlite3_h::sqlite3_int64 && n <= nUsed) as ::core::ffi::c_int,
    );
    crate::src::src::mutex::sqlite3_mutex_leave(mem0.mutex);
    excess = sqlite3_memory_used() - n;
    if excess > 0 as crate::sqlite3_h::sqlite3_int64 {
        sqlite3_release_memory((excess & 0x7fffffff as crate::sqlite3_h::sqlite3_int64) as ::core::ffi::c_int);
    }
    return priorLimit;
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3_soft_heap_limit(mut n: ::core::ffi::c_int) {
    ...
    sqlite3_soft_heap_limit64(n as crate::sqlite3_h::sqlite3_int64);
}
#[no_mangle]

pub unsafe extern "C" fn sqlite3_hard_heap_limit64(mut n: crate::sqlite3_h::sqlite3_int64) -> crate::sqlite3_h::sqlite3_int64 {
    let mut priorLimit: crate::sqlite3_h::sqlite3_int64 = 0;
    let mut rc: ::core::ffi::c_int = crate::src::src::main::sqlite3_initialize();
    if rc != 0 {
        return -(1 as ::core::ffi::c_int) as crate::sqlite3_h::sqlite3_int64;
    ...
    if n >= 0 as crate::sqlite3_h::sqlite3_int64 {
        mem0.hardLimit = n;
        if n < mem0.alarmThreshold || mem0.alarmThreshold == 0 as crate::sqlite3_h::sqlite3_int64 {
            mem0.alarmThreshold = n;
        }
    }
    crate::src::src::mutex::sqlite3_mutex_leave(mem0.mutex);
...
pub unsafe extern "C" fn sqlite3MallocInit() -> ::core::ffi::c_int {
    ...
    mem0.mutex = crate::src::src::mutex::sqlite3MutexAlloc(crate::sqlite3_h::SQLITE_MUTEX_STATIC_MEM);
...
pub unsafe extern "C" fn sqlite3HeapNearlyFull() -> ::core::ffi::c_int {
    return ::core::intrinsics::atomic_load_relaxed(&raw mut mem0.nearlyFull);
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3_memory_used() -> crate::sqlite3_h::sqlite3_int64 {
    let mut res: crate::sqlite3_h::sqlite3_int64 = 0;
    let mut mx: crate::sqlite3_h::sqlite3_int64 = 0;
    crate::src::src::status::sqlite3_status64(
        crate::sqlite3_h::SQLITE_STATUS_MEMORY_USED,
        &raw mut res,
        &raw mut mx,
        0 as ::core::ffi::c_int,
    );
...
unsafe extern "C" fn sqlite3MallocAlarm(mut nByte: ::core::ffi::c_int) {
    if mem0.alarmThreshold <= 0 as crate::sqlite3_h::sqlite3_int64 {
        return;
    }
    crate::src::src::mutex::sqlite3_mutex_leave(mem0.mutex);
...
unsafe extern "C" fn mallocWithAlarm(
    ...
    crate::src::src::status::sqlite3StatusHighwater(crate::sqlite3_h::SQLITE_STATUS_MALLOC_SIZE, n);
    if mem0.alarmThreshold > 0 as crate::sqlite3_h::sqlite3_int64 {
        let mut nUsed: crate::sqlite3_h::sqlite3_int64 = crate::src::src::status::sqlite3StatusValue(crate::sqlite3_h::SQLITE_STATUS_MEMORY_USED);
        if nUsed >= mem0.alarmThreshold - nFull as crate::sqlite3_h::sqlite3_int64 {
            ::core::intrinsics::atomic_store_relaxed(
                &raw mut mem0.nearlyFull,
                1 as ::core::ffi::c_int,
            );
            ...
            if mem0.hardLimit != 0 {
                nUsed = crate::src::src::status::sqlite3StatusValue(crate::sqlite3_h::SQLITE_STATUS_MEMORY_USED);
                if nUsed >= mem0.hardLimit - nFull as crate::sqlite3_h::sqlite3_int64 {
    ...
    if !p.is_null() {
        ...
        crate::src::src::status::sqlite3StatusUp(crate::sqlite3_h::SQLITE_STATUS_MEMORY_USED, nFull);
        crate::src::src::status::sqlite3StatusUp(crate::sqlite3_h::SQLITE_STATUS_MALLOC_COUNT, 1 as ::core::ffi::c_int);
    }
    *pp = p;
}
...
pub unsafe extern "C" fn sqlite3_malloc64(mut n: crate::sqlite3_h::sqlite3_uint64) -> *mut ::core::ffi::c_void {
    if crate::src::src::main::sqlite3_initialize() != 0 {
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
    }
    return sqlite3Malloc(n as crate::src::ext::rtree::rtree::u64_0);
}
...
unsafe extern "C" fn isLookaside(
    ...
    return (p as crate::sqliteInt_h::uptr >= (*db).lookaside.pStart as crate::sqliteInt_h::uptr
        && (p as crate::sqliteInt_h::uptr) < (*db).lookaside.pTrueEnd as crate::sqliteInt_h::uptr) as ::core::ffi::c_int;
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3MallocSize(
    ...
    return crate::src::src::global::sqlite3Config.m.xSize.expect("non-null function pointer")(
...
unsafe extern "C" fn lookasideMallocSize(
    ...
    return if p < (*db).lookaside.pMiddle as *const ::core::ffi::c_void {
        (*db).lookaside.szTrue as ::core::ffi::c_int
    } else {
        crate::sqliteInt_h::LOOKASIDE_SMALL
    };
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3DbMallocSize(
    ...
    if !db.is_null() {
        if (p as crate::sqliteInt_h::uptr) < (*db).lookaside.pTrueEnd as crate::sqliteInt_h::uptr {
            if p as crate::sqliteInt_h::uptr >= (*db).lookaside.pMiddle as crate::sqliteInt_h::uptr {
                return crate::sqliteInt_h::LOOKASIDE_SMALL;
            }
...
pub unsafe extern "C" fn sqlite3_msize(mut p: *mut ::core::ffi::c_void) -> crate::sqlite3_h::sqlite3_uint64 {
    return (if !p.is_null() {
...
pub unsafe extern "C" fn sqlite3_free(mut p: *mut ::core::ffi::c_void) {
    ...
    if crate::src::src::global::sqlite3Config.bMemstat != 0 {
        crate::src::src::mutex::sqlite3_mutex_enter(mem0.mutex);
        crate::src::src::status::sqlite3StatusDown(crate::sqlite3_h::SQLITE_STATUS_MEMORY_USED, sqlite3MallocSize(p));
        crate::src::src::status::sqlite3StatusDown(crate::sqlite3_h::SQLITE_STATUS_MALLOC_COUNT, 1 as ::core::ffi::c_int);
...
unsafe extern "C" fn measureAllocationSize(mut db: *mut crate::sqliteInt_h::sqlite3, mut p: *mut ::core::ffi::c_void) {
    *(*db).pnBytesFreed += sqlite3DbMallocSize(db, p);
}
#[no_mangle]

pub unsafe extern "C" fn sqlite3DbFreeNN(mut db: *mut crate::sqliteInt_h::sqlite3, mut p: *mut ::core::ffi::c_void) {
    if !db.is_null() {
...
pub unsafe extern "C" fn sqlite3DbFree(mut db: *mut crate::sqliteInt_h::sqlite3, mut p: *mut ::core::ffi::c_void) {
    if !p.is_null() {
...
pub unsafe extern "C" fn sqlite3Realloc(
    ...
    if nOld == nNew {
        ...
        let mut nUsed: crate::sqlite3_h::sqlite3_int64 = 0;
        crate::src::src::mutex::sqlite3_mutex_enter(mem0.mutex);
        crate::src::src::status::sqlite3StatusHighwater(crate::sqlite3_h::SQLITE_STATUS_MALLOC_SIZE, nBytes as ::core::ffi::c_int);
        nDiff = nNew - nOld;
        if nDiff > 0 as ::core::ffi::c_int && {
            nUsed = crate::src::src::status::sqlite3StatusValue(crate::sqlite3_h::SQLITE_STATUS_MEMORY_USED);
            nUsed >= mem0.alarmThreshold - nDiff as crate::sqlite3_h::sqlite3_int64
        } {
            sqlite3MallocAlarm(nDiff);
            if mem0.hardLimit > 0 as crate::sqlite3_h::sqlite3_int64
                && nUsed >= mem0.hardLimit - nDiff as crate::sqlite3_h::sqlite3_int64
            {
                crate::src::src::mutex::sqlite3_mutex_leave(mem0.mutex);
                return ::core::ptr::null_mut::<::core::ffi::c_void>();
            }
        ...
        if !pNew.is_null() {
            ...
            crate::src::src::status::sqlite3StatusUp(crate::sqlite3_h::SQLITE_STATUS_MEMORY_USED, nNew - nOld);
        }
        crate::src::src::mutex::sqlite3_mutex_leave(mem0.mutex);
    } else {
        pNew = crate::src::src::global::sqlite3Config.m.xRealloc.expect("non-null function pointer")(pOld, nNew);
...
pub unsafe extern "C" fn sqlite3_realloc(
    ...
    return sqlite3Realloc(pOld, n as crate::src::ext::rtree::rtree::u64_0);
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3DbMallocRawNN(
    ...
    let mut pBuf: *mut crate::sqliteInt_h::LookasideSlot = ::core::ptr::null_mut::<crate::sqliteInt_h::LookasideSlot>();
...
pub unsafe extern "C" fn sqlite3DbRealloc(
    ...
    if (p as crate::sqliteInt_h::uptr) < (*db).lookaside.pEnd as crate::sqliteInt_h::uptr {
        ...
        } else if p as crate::sqliteInt_h::uptr >= (*db).lookaside.pStart as crate::sqliteInt_h::uptr {
...
pub unsafe extern "C" fn sqlite3DbSpanDup(
    ...
    return sqlite3DbStrNDup(db, zStart, n as crate::src::ext::rtree::rtree::u64_0);
}
#[no_mangle]
...
pub unsafe extern "C" fn sqlite3OomFault(mut db: *mut crate::sqliteInt_h::sqlite3) -> *mut ::core::ffi::c_void {
    if (*db).mallocFailed as ::core::ffi::c_int == 0 as ::core::ffi::c_int
...
unsafe extern "C" fn apiHandleError(
    ...
    if (*db).mallocFailed as ::core::ffi::c_int != 0 || rc == crate::sqlite3_h::SQLITE_IOERR_NOMEM {
        sqlite3OomClear(db);
        crate::src::src::util::sqlite3Error(db as *mut crate::sqliteInt_h::sqlite3, crate::sqlite3_h::SQLITE_NOMEM);
