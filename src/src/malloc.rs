...
extern "C" {
    ...
    fn sqlite3StatusValue(_: ::core::ffi::c_int) -> sqlite3_int64;
...
static mut mem0: Mem0Global = Mem0Global {
    ...
    alarmThreshold: SQLITE_MAX_MEMORY as sqlite3_int64,
    hardLimit: SQLITE_MAX_MEMORY as sqlite3_int64,
    nearlyFull: 0 as ::core::ffi::c_int,
};
#[no_mangle]
pub unsafe extern "C" fn sqlite3MallocMutex() -> *mut sqlite3_mutex {
    return mem0.mutex;
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3_soft_heap_limit64(mut n: sqlite3_int64) -> sqlite3_int64 {
    ...
    if n < 0 as sqlite3_int64 {
        sqlite3_mutex_leave(mem0.mutex);
        return priorLimit;
    }
    if mem0.hardLimit > 0 as sqlite3_int64 && (n > mem0.hardLimit || n == 0 as sqlite3_int64) {
        n = mem0.hardLimit;
    }
    ...
    ::core::intrinsics::atomic_store_relaxed(
        ...
        (n > 0 as sqlite3_int64 && n <= nUsed) as ::core::ffi::c_int,
    );
    sqlite3_mutex_leave(mem0.mutex);
    excess = sqlite3_memory_used() - n;
    if excess > 0 as sqlite3_int64 {
        sqlite3_release_memory((excess & 0x7fffffff as sqlite3_int64) as ::core::ffi::c_int);
    }
    return priorLimit;
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3_hard_heap_limit64(mut n: sqlite3_int64) -> sqlite3_int64 {
    let mut priorLimit: sqlite3_int64 = 0;
    let mut rc: ::core::ffi::c_int = sqlite3_initialize();
    if rc != 0 {
        return -(1 as ::core::ffi::c_int) as sqlite3_int64;
    ...
    if n >= 0 as sqlite3_int64 {
        mem0.hardLimit = n;
        if n < mem0.alarmThreshold || mem0.alarmThreshold == 0 as sqlite3_int64 {
            mem0.alarmThreshold = n;
        }
    }
    sqlite3_mutex_leave(mem0.mutex);
...
pub unsafe extern "C" fn sqlite3MallocInit() -> ::core::ffi::c_int {
    ...
    if sqlite3Config.pPage.is_null()
        || sqlite3Config.szPage < 512 as ::core::ffi::c_int
        || sqlite3Config.nPage <= 0 as ::core::ffi::c_int
    {
        sqlite3Config.pPage = ::core::ptr::null_mut::<::core::ffi::c_void>();
        sqlite3Config.szPage = 0 as ::core::ffi::c_int;
    }
    rc = sqlite3Config.m.xInit.expect("non-null function pointer")(sqlite3Config.m.pAppData);
    if rc != SQLITE_OK {
        memset(
            &raw mut mem0 as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<Mem0Global>() as size_t,
        );
    }
    return rc;
}
...
pub unsafe extern "C" fn sqlite3MallocEnd() {
    if sqlite3Config.m.xShutdown.is_some() {
        sqlite3Config
            .m
            .xShutdown
            .expect("non-null function pointer")(sqlite3Config.m.pAppData);
    }
    memset(
        &raw mut mem0 as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
...
unsafe extern "C" fn sqlite3MallocAlarm(mut nByte: ::core::ffi::c_int) {
    if mem0.alarmThreshold <= 0 as sqlite3_int64 {
        return;
    }
    sqlite3_mutex_leave(mem0.mutex);
...
unsafe extern "C" fn mallocWithAlarm(
    ...
    if mem0.alarmThreshold > 0 as sqlite3_int64 {
        let mut nUsed: sqlite3_int64 = sqlite3StatusValue(SQLITE_STATUS_MEMORY_USED);
        if nUsed >= mem0.alarmThreshold - nFull as sqlite3_int64 {
            ::core::intrinsics::atomic_store_relaxed(
                &raw mut mem0.nearlyFull,
                1 as ::core::ffi::c_int,
            );
            ...
            if mem0.hardLimit != 0 {
                nUsed = sqlite3StatusValue(SQLITE_STATUS_MEMORY_USED);
                if nUsed >= mem0.hardLimit - nFull as sqlite3_int64 {
    ...
    if !p.is_null() {
        ...
        sqlite3StatusUp(SQLITE_STATUS_MALLOC_COUNT, 1 as ::core::ffi::c_int);
    }
    *pp = p;
}
pub const SQLITE_MAX_ALLOCATION_SIZE: ::core::ffi::c_int = 2147483391 as ::core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn sqlite3Malloc(mut n: u64_0) -> *mut ::core::ffi::c_void {
    let mut p: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<::core::ffi::c_void>();
    if n == 0 as u64_0 || n > SQLITE_MAX_ALLOCATION_SIZE as u64_0 {
        ...
        p = sqlite3Config.m.xMalloc.expect("non-null function pointer")(n as ::core::ffi::c_int);
    }
    return p;
}
#[no_mangle]
pub unsafe extern "C" fn sqlite3_malloc(mut n: ::core::ffi::c_int) -> *mut ::core::ffi::c_void {
    ...
    return if n <= 0 as ::core::ffi::c_int {
        ...
        sqlite3Malloc(n as u64_0)
    };
}
#[no_mangle]
pub unsafe extern "C" fn sqlite3_malloc64(mut n: sqlite3_uint64) -> *mut ::core::ffi::c_void {
    if sqlite3_initialize() != 0 {
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
    }
    return sqlite3Malloc(n as u64_0);
}
unsafe extern "C" fn isLookaside(
    ...
    return (p as uptr >= (*db).lookaside.pStart as uptr
        && (p as uptr) < (*db).lookaside.pTrueEnd as uptr) as ::core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn sqlite3MallocSize(
    mut p: *const ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    return sqlite3Config.m.xSize.expect("non-null function pointer")(
...
pub unsafe extern "C" fn sqlite3DbMallocSize(
    ...
    if !db.is_null() {
        if (p as uptr) < (*db).lookaside.pTrueEnd as uptr {
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3_msize(mut p: *mut ::core::ffi::c_void) -> sqlite3_uint64 {
    return (if !p.is_null() {
...
pub unsafe extern "C" fn sqlite3_free(mut p: *mut ::core::ffi::c_void) {
    ...
    if sqlite3Config.bMemstat != 0 {
        ...
        sqlite3StatusDown(SQLITE_STATUS_MALLOC_COUNT, 1 as ::core::ffi::c_int);
...
#[inline(never)]
unsafe extern "C" fn measureAllocationSize(mut db: *mut sqlite3, mut p: *mut ::core::ffi::c_void) {
    *(*db).pnBytesFreed += sqlite3DbMallocSize(db, p);
}
#[no_mangle]
pub unsafe extern "C" fn sqlite3DbFreeNN(mut db: *mut sqlite3, mut p: *mut ::core::ffi::c_void) {
    if !db.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3DbNNFreeNN(mut db: *mut sqlite3, mut p: *mut ::core::ffi::c_void) {
    if (p as uptr) < (*db).lookaside.pEnd as uptr {
        if p as uptr >= (*db).lookaside.pMiddle as uptr {
            let mut pBuf: *mut LookasideSlot = p as *mut LookasideSlot;
            (*pBuf).pNext = (*db).lookaside.pSmallFree;
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3DbFree(mut db: *mut sqlite3, mut p: *mut ::core::ffi::c_void) {
    if !p.is_null() {
...
pub unsafe extern "C" fn sqlite3Realloc(
    ...
    if nBytes == 0 as u64_0 {
        sqlite3_free(pOld);
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
    }
    if nBytes >= 0x7fffff00 as u64_0 {
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
    }
    nOld = sqlite3MallocSize(pOld);
    nNew =
        sqlite3Config.m.xRoundup.expect("non-null function pointer")(nBytes as ::core::ffi::c_int);
    if nOld == nNew {
        pNew = pOld;
    } else if sqlite3Config.bMemstat != 0 {
        let mut nUsed: sqlite3_int64 = 0;
        sqlite3_mutex_enter(mem0.mutex);
        sqlite3StatusHighwater(SQLITE_STATUS_MALLOC_SIZE, nBytes as ::core::ffi::c_int);
        nDiff = nNew - nOld;
        if nDiff > 0 as ::core::ffi::c_int && {
            nUsed = sqlite3StatusValue(SQLITE_STATUS_MEMORY_USED);
            nUsed >= mem0.alarmThreshold - nDiff as sqlite3_int64
        } {
            sqlite3MallocAlarm(nDiff);
            if mem0.hardLimit > 0 as sqlite3_int64
                && nUsed >= mem0.hardLimit - nDiff as sqlite3_int64
            {
                sqlite3_mutex_leave(mem0.mutex);
                return ::core::ptr::null_mut::<::core::ffi::c_void>();
            }
        }
        pNew = sqlite3Config.m.xRealloc.expect("non-null function pointer")(pOld, nNew);
        if !pNew.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3MallocZero(mut n: u64_0) -> *mut ::core::ffi::c_void {
...
pub unsafe extern "C" fn sqlite3DbMallocRawNN(
    ...
    let mut pBuf: *mut LookasideSlot = ::core::ptr::null_mut::<LookasideSlot>();
    if n > (*db).lookaside.sz as u64_0 {
...
pub unsafe extern "C" fn sqlite3DbRealloc(
    ...
    if (p as uptr) < (*db).lookaside.pEnd as uptr {
        if p as uptr >= (*db).lookaside.pMiddle as uptr {
            ...
            if n <= (*db).lookaside.szTrue as u64_0 {
                return p;
            }
        }
    }
...
unsafe extern "C" fn dbReallocFinish(
    ...
    if (*db).mallocFailed as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
        if isLookaside(db, p) != 0 {
            ...
            if !pNew.is_null() {
                memcpy(pNew, p, lookasideMallocSize(db, p) as size_t);
                sqlite3DbFree(db, p);
            }
        } else {
...
pub unsafe extern "C" fn sqlite3DbStrDup(
    ...
    n = strlen(z).wrapping_add(1 as size_t);
    zNew = sqlite3DbMallocRaw(db, n as u64_0) as *mut ::core::ffi::c_char;
    if !zNew.is_null() {
        memcpy(
...
pub unsafe extern "C" fn sqlite3DbStrNDup(
    ...
    let mut zNew: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    zNew = (if !z.is_null() {
        sqlite3DbMallocRawNN(db, n.wrapping_add(1 as u64_0))
    } else {
        ::core::ptr::null_mut::<::core::ffi::c_void>()
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3OomFault(mut db: *mut sqlite3) -> *mut ::core::ffi::c_void {
    if (*db).mallocFailed as ::core::ffi::c_int == 0 as ::core::ffi::c_int
        && (*db).bBenignMalloc as ::core::ffi::c_int == 0 as ::core::ffi::c_int
    {
        (*db).mallocFailed = 1 as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn sqlite3OomClear(mut db: *mut sqlite3) {
    if (*db).mallocFailed as ::core::ffi::c_int != 0 && (*db).nVdbeExec == 0 as ::core::ffi::c_int {
        (*db).mallocFailed = 0 as u8_0;
        ::core::intrinsics::atomic_store_relaxed(
            &raw mut (*db).u1.isInterrupted,
            0 as ::core::ffi::c_int,
        );
...
unsafe extern "C" fn apiHandleError(
    ...
    if (*db).mallocFailed as ::core::ffi::c_int != 0 || rc == SQLITE_IOERR_NOMEM {
        sqlite3OomClear(db);
