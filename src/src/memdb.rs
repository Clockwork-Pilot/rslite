...
pub struct MemStore {
    pub sz: crate::sqlite3_h::sqlite3_int64,
    pub szAlloc: crate::sqlite3_h::sqlite3_int64,
    pub szMax: crate::sqlite3_h::sqlite3_int64,
...
pub struct MemFile {
    pub base: crate::sqlite3_h::sqlite3_file,
...
static mut memdb_vfs: crate::sqlite3_h::sqlite3_vfs = unsafe {
    ...
    xDlClose:  Some(
            memdbDlClose as unsafe extern "C" fn(*mut crate::sqlite3_h::sqlite3_vfs, *mut ::core::ffi::c_void) -> (),
        ),
    xRandomness:  Some(
            memdbRandomness
                as unsafe extern "C" fn(
    ...
    xCurrentTimeInt64:  Some(
            memdbCurrentTimeInt64
                as unsafe extern "C" fn(*mut crate::sqlite3_h::sqlite3_vfs, *mut crate::sqlite3_h::sqlite3_int64) -> ::core::ffi::c_int,
        ),
    xSetSystemCall:  None,
    xGetSystemCall:  None,
...
static mut memdb_io_methods: crate::sqlite3_h::sqlite3_io_methods = unsafe {
    crate::sqlite3_h::sqlite3_io_methods {
    iVersion:  3 as ::core::ffi::c_int,
    xClose:  Some(memdbClose as unsafe extern "C" fn(*mut crate::sqlite3_h::sqlite3_file) -> ::core::ffi::c_int),
    xRead:  Some(
            memdbRead
                as unsafe extern "C" fn(
                    *mut crate::sqlite3_h::sqlite3_file,
    ...
    if iOfst + iAmt as crate::sqlite3_h::sqlite_int64 > (*p).sz {
        ...
        if iOfst < (*p).sz {
            ::libc::memcpy(
                ...
                ((*p).sz as crate::sqlite3_h::sqlite_int64 - iOfst) as crate::__stddef_size_t_h::size_t,
            );
        }
        memdbLeave(p);
...
unsafe extern "C" fn memdbLock(
    ...
    if eLock > crate::sqlite3_h::SQLITE_LOCK_SHARED
        && (*p).mFlags & crate::sqlite3_h::SQLITE_DESERIALIZE_READONLY as ::core::ffi::c_uint != 0
    {
        rc = crate::sqlite3_h::SQLITE_READONLY;
    } else {
        match  eLock {
    crate::sqlite3_h::SQLITE_LOCK_SHARED =>  {
...
unsafe extern "C" fn memdbFileControl(
    ...
    memdbEnter(p);
    if op == crate::sqlite3_h::SQLITE_FCNTL_VFSNAME {
    ...
    if op == crate::sqlite3_h::SQLITE_FCNTL_SIZE_LIMIT {
        let mut iLimit: crate::sqlite3_h::sqlite3_int64 = *(pArg as *mut crate::sqlite3_h::sqlite3_int64);
        if iLimit < (*p).sz {
            if iLimit < 0 as crate::sqlite3_h::sqlite3_int64 {
                iLimit = (*p).szMax;
            } else {
                iLimit = (*p).sz;
            }
        ...
        (*p).szMax = iLimit;
        *(pArg as *mut crate::sqlite3_h::sqlite3_int64) = iLimit;
        rc = crate::sqlite3_h::SQLITE_OK;
    }
    memdbLeave(p);
    return rc;
...
unsafe extern "C" fn memdbFetch(
    mut pFile: *mut crate::sqlite3_h::sqlite3_file,
    mut iOfst: crate::sqlite3_h::sqlite3_int64,
    mut iAmt: ::core::ffi::c_int,
    mut pp: *mut *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    let mut p: *mut MemStore = (*(pFile as *mut MemFile)).pStore;
    memdbEnter(p);
    if iOfst + iAmt as crate::sqlite3_h::sqlite3_int64 > (*p).sz
        || (*p).mFlags & crate::sqlite3_h::SQLITE_DESERIALIZE_RESIZEABLE as ::core::ffi::c_uint
            != 0 as ::core::ffi::c_uint
    {
...
unsafe extern "C" fn memdbUnfetch(
    mut pFile: *mut crate::sqlite3_h::sqlite3_file,
    mut _iOfst: crate::sqlite3_h::sqlite3_int64,
...
unsafe extern "C" fn memdbOpen(
            ...
            || *zName.offset(0 as isize) as ::core::ffi::c_int == '\\' as i32)
    {
        ...
        (*p).mFlags =
            (crate::sqlite3_h::SQLITE_DESERIALIZE_RESIZEABLE | crate::sqlite3_h::SQLITE_DESERIALIZE_FREEONCLOSE) as ::core::ffi::c_uint;
        (*p).szMax = crate::src::src::global::sqlite3Config.mxMemdbSize;
    }
    (*pFile).pStore = p;
    if !pOutFlags.is_null() {
        *pOutFlags = flags | crate::sqlite3_h::SQLITE_OPEN_MEMORY;
    }
...
unsafe extern "C" fn memdbDlError(
    ...
    (*((*pVfs).pAppData as *mut crate::sqlite3_h::sqlite3_vfs))
        .xDlError
        .expect("non-null function pointer")(
        (*pVfs).pAppData as *mut crate::sqlite3_h::sqlite3_vfs, nByte, zErrMsg
    );
}
...
unsafe extern "C" fn memdbDlClose(
    ...
    (*((*pVfs).pAppData as *mut crate::sqlite3_h::sqlite3_vfs))
        .xDlClose
        .expect("non-null function pointer")((*pVfs).pAppData as *mut crate::sqlite3_h::sqlite3_vfs, pHandle);
}
...
unsafe extern "C" fn memdbFromDbSchema(
    ...
    let mut rc: ::core::ffi::c_int = crate::src::src::main::sqlite3_file_control(
        ...
        zSchema,
        crate::sqlite3_h::SQLITE_FCNTL_FILE_POINTER,
...
pub unsafe extern "C" fn sqlite3_serialize(
    mut db: *mut crate::sqliteInt_h::sqlite3,
    mut zSchema: *const ::core::ffi::c_char,
    mut piSize: *mut crate::sqlite3_h::sqlite3_int64,
    ...
    if !piSize.is_null() {
        *piSize = -(1 as ::core::ffi::c_int) as crate::sqlite3_h::sqlite3_int64;
    }
    ...
    if !p.is_null() {
        ...
        if mFlags & crate::sqlite3_h::SQLITE_SERIALIZE_NOCOPY as ::core::ffi::c_uint != 0 {
            pOut = (*pStore).aData;
        } else {
    ...
    if rc != crate::sqlite3_h::SQLITE_ROW {
        ...
        sz = crate::src::src::vdbeapi::sqlite3_column_int64(pStmt, 0 as ::core::ffi::c_int) * szPage as crate::sqlite3_h::sqlite3_int64;
        ...
        if mFlags & crate::sqlite3_h::SQLITE_SERIALIZE_NOCOPY as ::core::ffi::c_uint != 0 {
            ...
            pOut = crate::src::src::malloc::sqlite3_malloc64(sz as crate::sqlite3_h::sqlite3_uint64) as *mut ::core::ffi::c_uchar;
            if !pOut.is_null() {
                ...
                while pgno <= nPage {
                    ...
                    let mut pTo: *mut ::core::ffi::c_uchar = pOut.offset(
                        (szPage as crate::sqlite3_h::sqlite3_int64
                            * (pgno - 1 as ::core::ffi::c_int) as crate::sqlite3_h::sqlite3_int64)
                            as isize,
                    );
...
pub unsafe extern "C" fn sqlite3_deserialize(
    ...
    mut szDb: crate::sqlite3_h::sqlite3_int64,
    mut szBuf: crate::sqlite3_h::sqlite3_int64,
    mut mFlags: ::core::ffi::c_uint,
) -> ::core::ffi::c_int {
    let mut p: *mut MemFile = ::core::ptr::null_mut::<MemFile>();
    let mut zSql: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    ...
    crate::src::src::vdbeapi::sqlite3_finalize(pStmt);
    if !pData.is_null()
        && mFlags & crate::sqlite3_h::SQLITE_DESERIALIZE_FREEONCLOSE as ::core::ffi::c_uint
            != 0 as ::core::ffi::c_uint
    {
...
pub unsafe extern "C" fn sqlite3MemdbInit() -> ::core::ffi::c_int {
    let mut pLower: *mut crate::sqlite3_h::sqlite3_vfs =  crate::src::src::os::sqlite3_vfs_find(::core::ptr::null::<::core::ffi::c_char>())
