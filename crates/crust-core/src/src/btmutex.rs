...
unsafe extern "C" fn btreeLockCarefully(mut p: *mut crate::src::headers::btreeInt_h::Btree) {
    let mut pLater: *mut crate::src::headers::btreeInt_h::Btree = ::core::ptr::null_mut::<crate::src::headers::btreeInt_h::Btree>();
    let __p_ref = unsafe { &mut *p };
    if crate::src::src::mutex::sqlite3_mutex_try((*__p_ref.pBt).mutex) == crate::src::headers::sqlite3_h::SQLITE_OK {
        (*__p_ref.pBt).db = __p_ref.db;
        __p_ref.locked = 1 as crate::src::ext::rtree::rtree::u8_0;
        return;
    }
