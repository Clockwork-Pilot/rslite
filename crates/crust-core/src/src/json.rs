...
unsafe extern "C" fn jsonEachConnect(
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        ...
        *ppVtab = pNew as *mut crate::src::headers::sqlite3_h::sqlite3_vtab;
        ...
        { let _vtab_args: [u64; 1] = [0]; crate::src::src::vtab::sqlite3_vtab_config_args(db as *mut crate::src::headers::sqliteInt_h::sqlite3, crate::src::headers::sqlite3_h::SQLITE_VTAB_INNOCUOUS, _vtab_args.as_ptr()); }
        (*pNew).db = db;
