...
unsafe extern "C" fn sqlite3VdbeLogAbort(
    ...
    crate::src::src::printf::sqlite3_log_args(
        ...
        &[crate::src::src::printf::PrintfArg::Int(pc as crate::src::ext::rtree::rtree::i64_0), crate::src::src::printf::PrintfArg::Str(__p_ref.zErrMsg as *mut ::core::ffi::c_char), crate::src::src::printf::PrintfArg::Str(zPrefix as *mut ::core::ffi::c_char), crate::src::src::printf::PrintfArg::Str(zSql as *mut ::core::ffi::c_char)],
    );
}
                        ...
                        match current_block {
                            ...
                            _ => {
                                crate::src::src::vdbeaux::sqlite3VdbeError_args(
                                    ...
                                    &[
                                        crate::src::src::printf::PrintfArg::Str(vdbeMemTypeName(pIn1) as *mut ::core::ffi::c_char),
                                        crate::src::src::printf::PrintfArg::Str(*(&raw mut crate::src::src::global::sqlite3StdType as *mut *const ::core::ffi::c_char)
                                            .offset(
                                        ...
                                        crate::src::src::printf::PrintfArg::Str((*aCol.offset(i_1 as isize)).zCnName as *mut ::core::ffi::c_char),
                                    ],
                                );
    ...
    crate::src::headers::opcodes_h::OP_SqlExec_1 =>  {
                        ...
                        if !zErr_0.is_null() || rc != 0 {
                            crate::src::src::vdbeaux::sqlite3VdbeError_args(
                                ...
                                &[crate::src::src::printf::PrintfArg::Str(zErr_0 as *mut ::core::ffi::c_char)],
                            );
                        ...
                        if (*pOp).p4.z.is_null() {
                            ...
                            zSql = crate::src::src::printf::sqlite3MPrintf_args(
                                ...
                                b"SELECT*FROM\"%w\".%s WHERE %s ORDER BY rowid\0" as *const u8
                                    as *const ::core::ffi::c_char,
                                &[
                                    crate::src::src::printf::PrintfArg::Str((*(*db).aDb.offset(iDb_2 as isize)).zDbSName as *mut ::core::ffi::c_char),
                                    crate::src::src::printf::PrintfArg::Str(zSchema as *mut ::core::ffi::c_char),
                                    crate::src::src::printf::PrintfArg::Str((*pOp).p4.z as *mut ::core::ffi::c_char),
                                ],
                            );
                            if zSql.is_null() {
    ...
    crate::src::headers::opcodes_h::OP_AggValue | crate::src::headers::opcodes_h::OP_AggFinal_1 =>  {
                        ...
                        if rc != 0 {
                            crate::src::src::vdbeaux::sqlite3VdbeError_args(
                                p as *mut crate::src::headers::vdbeInt_h::Vdbe,
                                b"%s\0" as *const u8 as *const ::core::ffi::c_char,
                                &[crate::src::src::printf::PrintfArg::Str(crate::src::src::vdbeapi::sqlite3_value_text(pMem_2 as *mut crate::src::headers::vdbeInt_h::sqlite3_value as *mut crate::src::headers::vdbeInt_h::sqlite3_value) as *mut ::core::ffi::c_char)],
                            );
                            current_block = 9863799879598557851;
                            break;
                        } else {
                            ...
                            if (*db).autoCommit == 0 || (*db).nVdbeRead > 1 as ::core::ffi::c_int {
                                ...
                                crate::src::src::vdbeaux::sqlite3VdbeError_args(
                                    ...
                                    b"cannot change %s wal mode from within a transaction\0"
                                        as *const u8
                                        as *const ::core::ffi::c_char,
                                    &[crate::src::src::printf::PrintfArg::Str(if eNew == crate::src::src::pager::PAGER_JOURNALMODE_WAL {
                                ...
                                if rc & 0xff as ::core::ffi::c_int == crate::src::headers::sqlite3_h::SQLITE_LOCKED {
                                    ...
                                    crate::src::src::vdbeaux::sqlite3VdbeError_args(
                                        ...
                                        b"database table is locked: %s\0" as *const u8
                                            as *const ::core::ffi::c_char,
                                        &[crate::src::src::printf::PrintfArg::Str(z_0 as *mut ::core::ffi::c_char)],
                                    );
                                }
                                current_block = 9863799879598557851;
                                break;
    ...
    crate::src::headers::opcodes_h::OP_Trace | crate::src::headers::opcodes_h::OP_Init =>  {
                            ...
                            }
                        {
                            if (*db).mTrace as ::core::ffi::c_int & crate::src::headers::sqliteInt_h::SQLITE_TRACE_LEGACY != 0 {
                                ...
                                let mut z_2: *mut ::core::ffi::c_char = crate::src::src::printf::sqlite3MPrintf_args(
                                    db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                                    b"-- %s\0" as *const u8 as *const ::core::ffi::c_char,
                                    &[crate::src::src::printf::PrintfArg::Str(zTrace as *mut ::core::ffi::c_char)],
                                );
                                (*db).trace.xV2.expect("non-null function pointer")(
                                    ...
                                    && __pOp_ref.p4type as ::core::ffi::c_int == crate::src::src::vdbe::P4_NOTUSED
                                {
                                    ...
                                    crate::src::src::vdbeaux::sqlite3VdbeError_args(
                                        ...
                                        b"%s constraint failed\0" as *const u8
                                            as *const ::core::ffi::c_char,
                                        &[crate::src::src::printf::PrintfArg::Str(azType[(__pOp_ref.p5 as ::core::ffi::c_int
                                            - 1 as ::core::ffi::c_int)
