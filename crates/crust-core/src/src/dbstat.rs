...
unsafe extern "C" fn statConnect(
    ...
    { let _vtab_args: [u64; 1] = [0]; crate::src::src::vtab::sqlite3_vtab_config_args(db as *mut crate::src::headers::sqliteInt_h::sqlite3, crate::src::headers::sqlite3_h::SQLITE_VTAB_DIRECTONLY, _vtab_args.as_ptr()); }
