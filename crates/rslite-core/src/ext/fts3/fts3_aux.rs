...
pub struct Fts3auxColstats {
    ...
    pub nOcc: crate::src::headers::sqlite3_h::Sqlite3Int64,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn fts3auxConnectMethod(
    ...
    if !(argc != 4 as ::core::ffi::c_int && argc != 5 as ::core::ffi::c_int) {
        ...
        if argc == 5 as ::core::ffi::c_int {
            ...
            {
                zDb = *argv.offset(3_isize);
                nDb = ::libc::strlen(zDb) as ::core::ffi::c_int;
                zFts3 = *argv.offset(4_isize);
                current_block = 1856101646708284338;
            } else {
                current_block = 10728627893248296414;
            }
        } else {
            zFts3 = *argv.offset(3_isize);
            current_block = 1856101646708284338;
        }
        match current_block {
            ...
            _ => {
                ...
                (*p).pFts3Tab =
                    p.offset(1_isize) as *mut Fts3auxTable as *mut crate::fts3Int_h::Fts3Table;
                (*(*p).pFts3Tab).zDb = (*p).pFts3Tab.offset(1_isize)
...
unsafe extern "C" fn fts3auxDisconnectMethod(
    ...
    let p: *mut Fts3auxTable = pVtab as *mut Fts3auxTable;
    let pFts3: *mut crate::fts3Int_h::Fts3Table = (*p).pFts3Tab;
...
unsafe extern "C" fn fts3auxBestIndexMethod(
    ...
    if __pInfo_ref.nOrderBy == 1 as ::core::ffi::c_int
        && (*__pInfo_ref.aOrderBy.offset(0_isize)).iColumn == 0 as ::core::ffi::c_int
        && (*__pInfo_ref.aOrderBy.offset(0_isize)).desc as ::core::ffi::c_int
            == 0 as ::core::ffi::c_int
    {
...
unsafe extern "C" fn fts3auxOpenMethod(
    ...
    let pCsr: *mut Fts3auxCursor = crate::src::src::malloc::sqlite3_malloc(
    ...
    ::libc::memset(
        ...
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<Fts3auxCursor>() as crate::__stddef_size_t_h::SizeT,
    );
...
unsafe extern "C" fn fts3auxCloseMethod(
    ...
    let pFts3: *mut crate::fts3Int_h::Fts3Table =
...
unsafe extern "C" fn fts3auxGrowStatArray(
    pCsr: *mut Fts3auxCursor,
    nSize: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    if nSize > (*pCsr).nStat {
        
        let __pCsr_ref = unsafe { &mut *pCsr };
        let aNew: *mut Fts3auxColstats = crate::src::src::malloc::sqlite3_realloc64(
        ...
        ::libc::memset(
            ...
            0 as ::core::ffi::c_int,
            (::core::mem::size_of::<Fts3auxColstats>() as crate::__stddef_size_t_h::SizeT)
                .wrapping_mul((nSize - __pCsr_ref.nStat) as crate::__stddef_size_t_h::SizeT),
        );
...
unsafe extern "C" fn fts3auxNextMethod(
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_ROW {
        ...
        let nDoclist: ::core::ffi::c_int = __pCsr_ref.csr.nDoclist;
        let aDoclist: *mut ::core::ffi::c_char = __pCsr_ref.csr.aDoclist;
        let mut iCol: ::core::ffi::c_int;
        let mut eState: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        if !__pCsr_ref.zStop.is_null() {
            let n: ::core::ffi::c_int = if __pCsr_ref.nStop < __pCsr_ref.csr.nTerm {
                __pCsr_ref.nStop
            } else {
                __pCsr_ref.csr.nTerm
            };
            let mc: ::core::ffi::c_int = ::libc::memcmp(
        ...
        ::libc::memset(
            ...
            0 as ::core::ffi::c_int,
            (::core::mem::size_of::<Fts3auxColstats>() as crate::__stddef_size_t_h::SizeT)
                .wrapping_mul(__pCsr_ref.nStat as crate::__stddef_size_t_h::SizeT),
        );
        ...
        while i < nDoclist {
            ...
            match eState {
                0 => {
                    let fresh0 = &mut (*__pCsr_ref.aStat.offset(0_isize)).nDoc;
                    *fresh0 += 1;
                ...
                1 => {
                    if v > 1 as crate::src::headers::sqlite3_h::Sqlite3Int64 {
                        let fresh1 = &mut (*__pCsr_ref.aStat.offset(1_isize)).nDoc;
                        *fresh1 += 1;
                    }
...
unsafe extern "C" fn fts3auxFilterMethod(
    ...
    ::libc::memset(
        ...
        0 as ::core::ffi::c_int,
        (pCsr.offset(1_isize) as *mut Fts3auxCursor as *mut crate::src::ext::rtree::rtree::U8_0)
    ...
    if iEq >= 0 as ::core::ffi::c_int || iGe >= 0 as ::core::ffi::c_int {
        let zStr: *const ::core::ffi::c_uchar =
            crate::src::src::vdbeapi::sqlite3_value_text(*apVal.offset(0_isize));
        if !zStr.is_null() {
...
unsafe extern "C" fn fts3auxColumnMethod(
    ...
    let p: *mut Fts3auxCursor = pCursor as *mut Fts3auxCursor;
    match iCol {
        0 => {
...
unsafe extern "C" fn fts3auxRowidMethod(
    ...
    let pCsr = &*(pCursor as *mut Fts3auxCursor);
    *pRowid = pCsr.iRowid as crate::src::headers::sqlite3_h::SqliteInt64;
    crate::src::headers::sqlite3_h::SQLITE_OK
}
