...
unsafe extern "C" fn blobSeekToRow(
    p: *mut Incrblob,
    iRow: crate::src::headers::sqlite3_h::Sqlite3Int64,
    ...
    crate::src::src::vdbemem::sqlite3VdbeMemSetInt64(
        (*v).aMem.offset(1_isize) as *mut crate::src::src::vdbe::Mem
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_ROW {
        let pC: *mut crate::src::headers::vdbeInt_h::VdbeCursor =
            *(*v).apCsr.offset(0_isize);
        
        let type_0: crate::src::ext::rtree::rtree::U32_0 = if (*pC).nHdrParsed as ::core::ffi::c_int > (*p).iCol as ::core::ffi::c_int {
            *(&raw mut (*pC).aType as *mut crate::src::ext::rtree::rtree::U32_0)
                .offset((*p).iCol as isize)
        } else {
        ...
        if type_0 < 12 as crate::src::ext::rtree::rtree::U32_0 {
            ...
            zErr = crate::src::printf_c_variadic::sqlite3MPrintf_args(
                ...
                &[crate::src::src::printf::PrintfArg::Str(if type_0
                    == 0 as crate::src::ext::rtree::rtree::U32_0
                {
            ...
            __p_ref.pStmt = ::core::ptr::null_mut::<crate::src::headers::sqlite3_h::Sqlite3Stmt>();
        } else {
            let __pC_ref = unsafe { &mut *pC };
            let __p_ref = unsafe { &mut *p };
            __p_ref.iOffset =
                *(&raw mut __pC_ref.aType as *mut crate::src::ext::rtree::rtree::U32_0).offset(
                    (__p_ref.iCol as ::core::ffi::c_int + __pC_ref.nField as ::core::ffi::c_int)
                        as isize,
                ) as ::core::ffi::c_int;
            __p_ref.nByte =
                crate::src::src::vdbeaux::sqlite3VdbeSerialTypeLen(type_0) as ::core::ffi::c_int;
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_ROW {
        ...
        (*p).pStmt = ::core::ptr::null_mut::<crate::src::headers::sqlite3_h::Sqlite3Stmt>();
...
pub unsafe extern "C" fn sqlite3_blob_open(
    ...
    iRow: crate::src::headers::sqlite3_h::SqliteInt64,
    mut wrFlag: ::core::ffi::c_int,
    ppBlob: *mut *mut crate::src::headers::sqlite3_h::Sqlite3Blob,
) -> ::core::ffi::c_int {
    ...
    *ppBlob = ::core::ptr::null_mut::<crate::src::headers::sqlite3_h::Sqlite3Blob>();
    wrFlag = (wrFlag != 0) as ::core::ffi::c_int;
    let __db_ref = unsafe { &mut *db };
    crate::src::src::mutex::sqlite3_mutex_enter(__db_ref.mutex);
    let pBlob: *mut Incrblob = crate::src::src::malloc::sqlite3DbMallocZero(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        ::core::mem::size_of::<Incrblob>() as crate::src::ext::rtree::rtree::U64_0,
    ) as *mut Incrblob;
    loop {
        ...
        if pTab.is_null() || {
            ...
            if iCol < 0 as ::core::ffi::c_int {
                ...
                zErr = crate::src::printf_c_variadic::sqlite3MPrintf_args(
                    ...
                    &[crate::src::src::printf::PrintfArg::Str(
                        zColumn as *mut ::core::ffi::c_char,
                    )],
                );
                rc = crate::src::headers::sqlite3_h::SQLITE_ERROR;
                crate::src::src::btmutex::sqlite3BtreeLeaveAll(
                ...
                __pBlob_ref.pStmt = crate::src::src::vdbeaux::sqlite3VdbeCreate(
                    &raw mut sParse as *mut _ as *mut crate::src::headers::sqliteInt_h::Parse,
                ...
                if !__pBlob_ref.pStmt.is_null() {
                    ...
                    static mut openBlob: [crate::src::src::vdbe::VdbeOpList; 6] = [
                        crate::src::src::vdbe::VdbeOpList {
                            opcode: crate::src::headers::opcodes_h::OP_TableLock
                        ...
                        crate::src::src::vdbe::VdbeOpList {
                            opcode: crate::src::headers::opcodes_h::OP_OpenRead
                                as crate::src::ext::rtree::rtree::U8_0,
                            p1: 0 as ::core::ffi::c_schar,
                            p2: 0 as ::core::ffi::c_schar,
                            p3: 0 as ::core::ffi::c_schar,
                        ...
                        crate::src::src::vdbe::VdbeOpList {
                            opcode: crate::src::headers::opcodes_h::OP_NotExists
                                as crate::src::ext::rtree::rtree::U8_0,
                            p1: 0 as ::core::ffi::c_schar,
                    ...
                    let v: *mut crate::src::headers::vdbeInt_h::Vdbe =
                        __pBlob_ref.pStmt as *mut crate::src::headers::vdbeInt_h::Vdbe;
                    ...
                    let aOp: *mut crate::src::src::vdbe::VdbeOp = crate::src::src::vdbeaux::sqlite3VdbeAddOpList(
                        ...
                        (::core::mem::size_of::<[crate::src::src::vdbe::VdbeOpList; 6]>() as usize)
                            .wrapping_div(
                                ::core::mem::size_of::<crate::src::src::vdbe::VdbeOpList>()
                                    as usize,
                            ) as ::core::ffi::c_int,
                        &raw const openBlob as *const crate::src::src::vdbe::VdbeOpList
                    ...
                    if __db_ref.mallocFailed as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                        ...
                        (*aOp.offset(0_isize)).p2 = (*pTab).tnum as ::core::ffi::c_int;
                        (*aOp.offset(0_isize)).p3 = wrFlag;
                    ...
                    if __db_ref.mallocFailed as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                        if wrFlag != 0 {
                            (*aOp.offset(1_isize)).opcode =
                                crate::src::headers::opcodes_h::OP_OpenWrite
                                    as crate::src::ext::rtree::rtree::U8_0;
                        }
                        let __pTab_ref = unsafe { &*pTab };
                        (*aOp.offset(1_isize)).p2 = __pTab_ref.tnum as ::core::ffi::c_int;
                        (*aOp.offset(1_isize)).p3 = iDb;
                        (*aOp.offset(1_isize)).p4type =
                            crate::src::src::vdbe::P4_INT32 as ::core::ffi::c_schar;
                        (*aOp.offset(1_isize)).p4.i =
                            __pTab_ref.nCol as ::core::ffi::c_int + 1 as ::core::ffi::c_int;
                        (*aOp.offset(3_isize)).p2 = __pTab_ref.nCol as ::core::ffi::c_int;
                ...
                nAttempt += 1;
                if nAttempt >= crate::src::headers::vdbeInt_h::SQLITE_MAX_SCHEMA_RETRY
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK
        && __db_ref.mallocFailed as ::core::ffi::c_int == 0 as ::core::ffi::c_int
    {
        *ppBlob = pBlob as *mut crate::src::headers::sqlite3_h::Sqlite3Blob;
    } else {
        if !pBlob.is_null() && !(*pBlob).pStmt.is_null() {
            crate::src::src::vdbeaux::sqlite3VdbeFinalize(
                (*pBlob).pStmt as *mut crate::src::headers::vdbeInt_h::Vdbe
                    as *mut crate::src::headers::vdbeInt_h::Vdbe,
            );
        }
        crate::src::src::malloc::sqlite3DbFree(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3_blob_close(
    pBlob: *mut crate::src::headers::sqlite3_h::Sqlite3Blob,
) -> ::core::ffi::c_int {
    let p: *mut Incrblob = pBlob as *mut Incrblob;
    let rc: ::core::ffi::c_int;
    let db: *mut crate::src::headers::sqliteInt_h::sqlite3;
    if !p.is_null() {
        let pStmt: *mut crate::src::headers::sqlite3_h::Sqlite3Stmt = (*p).pStmt;
        db = (*p).db;
...
unsafe extern "C" fn blobReadWrite(
    ...
    crate::src::src::mutex::sqlite3_mutex_enter((*db).mutex);
    let v: *mut crate::src::headers::vdbeInt_h::Vdbe = __p_ref.pStmt as *mut crate::src::headers::vdbeInt_h::Vdbe;
    if n < 0 as ::core::ffi::c_int
        ...
        || iOffset as crate::src::headers::sqlite3_h::Sqlite3Int64
            ...
            > __p_ref.nByte as crate::src::headers::sqlite3_h::Sqlite3Int64
    {
        rc = crate::src::headers::sqlite3_h::SQLITE_ERROR;
    } else if v.is_null() {
            ...
            && (*db).xPreUpdateCallback.is_some()
        {
                ...
                == 0 as ::core::ffi::c_int
            {
                ...
                rc =
                    crate::src::src::btree::sqlite3BtreeCursorRestore(__p_ref.pCsr, &raw mut bDiff);
            }
            if crate::src::src::btree::sqlite3BtreeCursorIsValidNN(__p_ref.pCsr) != 0 {
                
                let iKey: crate::src::headers::sqlite3_h::Sqlite3Int64 = crate::src::src::btree::sqlite3BtreeIntegerKey(__p_ref.pCsr)
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sqlite3_blob_bytes(
    pBlob: *mut crate::src::headers::sqlite3_h::Sqlite3Blob,
) -> ::core::ffi::c_int {
    let p: *mut Incrblob = pBlob as *mut Incrblob;
...
pub unsafe extern "C" fn sqlite3_blob_reopen(
    ...
    if (*p).pStmt.is_null() {
        ...
        let mut zErr: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        (*((*p).pStmt as *mut crate::src::headers::vdbeInt_h::Vdbe)).rc =
