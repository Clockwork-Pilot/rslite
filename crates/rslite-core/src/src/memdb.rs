...
pub use crate::src::headers::sqlite3_h::SQLITE_DESERIALIZE_FREEONCLOSE;
pub use crate::src::headers::sqlite3_h::SQLITE_DESERIALIZE_READONLY;
pub use crate::src::headers::sqlite3_h::SQLITE_DESERIALIZE_RESIZEABLE;
...
pub use crate::src::headers::sqlite3_h::SQLITE_FCNTL_SIZE_LIMIT;
pub use crate::src::headers::sqlite3_h::SQLITE_FCNTL_VFSNAME;
pub use crate::src::headers::sqlite3_h::SQLITE_FULL;
pub use crate::src::headers::sqlite3_h::SQLITE_IOCAP_ATOMIC;
...
pub use crate::src::headers::sqlite3_h::SQLITE_LOCK_PENDING;
pub use crate::src::headers::sqlite3_h::SQLITE_LOCK_RESERVED;
pub use crate::src::headers::sqlite3_h::SQLITE_LOCK_SHARED;
...
pub use crate::src::headers::sqlite3_h::SQLITE_SERIALIZE_NOCOPY;
...
#[repr(C)]
pub struct MemStore {
    pub sz: crate::src::headers::sqlite3_h::Sqlite3Int64,
    pub szAlloc: crate::src::headers::sqlite3_h::Sqlite3Int64,
    pub szMax: crate::src::headers::sqlite3_h::Sqlite3Int64,
...
static mut memdb_vfs: crate::src::headers::sqlite3_h::sqlite3_vfs = {
    crate::src::headers::sqlite3_h::sqlite3_vfs {
        ...
        pNext: ::core::ptr::null::<crate::src::headers::sqlite3_h::sqlite3_vfs>()
...
unsafe extern "C" fn memdbEnter(p: *mut MemStore) {
    crate::src::src::mutex::sqlite3_mutex_enter((*p).pMutex);
}

unsafe extern "C" fn memdbLeave(p: *mut MemStore) {
    crate::src::src::mutex::sqlite3_mutex_leave((*p).pMutex);
}

unsafe extern "C" fn memdbClose(
    pFile: *mut crate::src::headers::sqlite3_h::sqlite3_file,
) -> ::core::ffi::c_int {
    let p: *mut MemStore = (*(pFile as *mut MemFile)).pStore;
    let __p_ref = { &mut *p };
    if !__p_ref.zFName.is_null() {
        let mut i: ::core::ffi::c_int;
        let pVfsMutex: *mut crate::src::src::mutex_unix::sqlite3_mutex =
        ...
        while i < memdb_g.nMemStore {
            if *memdb_g.apMemStore.offset(i as isize) == p {
                ...
                if __p_ref.nRef == 1 as ::core::ffi::c_int {
                    memdb_g.nMemStore -= 1;
                    let fresh1 = &mut *memdb_g.apMemStore.offset(i as isize);
    ...
    if __p_ref.nRef <= 0 as ::core::ffi::c_int {
        if __p_ref.mFlags
            & crate::src::headers::sqlite3_h::SQLITE_DESERIALIZE_FREEONCLOSE as ::core::ffi::c_uint
            != 0
        {
...
unsafe extern "C" fn memdbRead(
    ...
    let p: *mut MemStore = (*(pFile as *mut MemFile)).pStore;
    memdbEnter(p);
    if iOfst + iAmt as crate::src::headers::sqlite3_h::SqliteInt64 > (*p).sz {
        ::libc::memset(
            zBuf,
            0 as ::core::ffi::c_int,
        ...
        if iOfst < (*p).sz {
            ::libc::memcpy(
                ...
                ((*p).sz as crate::src::headers::sqlite3_h::SqliteInt64 - iOfst)
...
unsafe extern "C" fn memdbEnlarge(
    p: *mut MemStore,
    mut newSz: crate::src::headers::sqlite3_h::Sqlite3Int64,
) -> ::core::ffi::c_int {
    
    let __p_ref = { &mut *p };
    if __p_ref.mFlags
        & crate::src::headers::sqlite3_h::SQLITE_DESERIALIZE_RESIZEABLE as ::core::ffi::c_uint
    ...
    newSz *= 2 as crate::src::headers::sqlite3_h::Sqlite3Int64;
    if newSz > __p_ref.szMax {
        newSz = __p_ref.szMax;
    }
    let pNew: *mut ::core::ffi::c_uchar = crate::src::src::malloc::sqlite3Realloc(
        __p_ref.aData as *mut ::core::ffi::c_void,
        newSz as crate::src::ext::rtree::rtree::U64_0,
...
unsafe extern "C" fn memdbWrite(
    ...
    if iOfst + iAmt as crate::src::headers::sqlite3_h::SqliteInt64 > __p_ref.sz {
        let rc: ::core::ffi::c_int;
        if iOfst + iAmt as crate::src::headers::sqlite3_h::SqliteInt64 > __p_ref.szAlloc && {
            rc = memdbEnlarge(
                p,
                iOfst as crate::src::headers::sqlite3_h::Sqlite3Int64
                    + iAmt as crate::src::headers::sqlite3_h::Sqlite3Int64,
            );
        ...
        if iOfst > __p_ref.sz {
            ::libc::memset(
                ...
                0 as ::core::ffi::c_int,
                (iOfst as crate::src::headers::sqlite3_h::Sqlite3Int64 - __p_ref.sz)
                    as crate::__stddef_size_t_h::SizeT,
            );
        }
        __p_ref.sz = (iOfst + iAmt as crate::src::headers::sqlite3_h::SqliteInt64)
...
unsafe extern "C" fn memdbTruncate(
    ...
    if size > (*p).sz {
        ...
        (*p).sz = size as crate::src::headers::sqlite3_h::Sqlite3Int64;
    }
    memdbLeave(p);
    rc
}
...
unsafe extern "C" fn memdbFileSize(
    ...
    let p: *mut MemStore = (*(pFile as *mut MemFile)).pStore;
    memdbEnter(p);
    *pSize = (*p).sz as crate::src::headers::sqlite3_h::SqliteInt64;
    memdbLeave(p);
    crate::src::headers::sqlite3_h::SQLITE_OK
}
...
unsafe extern "C" fn memdbLock(
    ...
    let pThis = &mut *(pFile as *mut MemFile);
    let p: *mut MemStore = pThis.pStore;
    let mut rc: ::core::ffi::c_int = crate::src::headers::sqlite3_h::SQLITE_OK;
    ...
    if eLock > crate::src::headers::sqlite3_h::SQLITE_LOCK_SHARED
        && (*p).mFlags
            & crate::src::headers::sqlite3_h::SQLITE_DESERIALIZE_READONLY as ::core::ffi::c_uint
            != 0
    {
...
unsafe extern "C" fn memdbUnlock(
    ...
    let pThis: *mut MemFile = pFile as *mut MemFile;
    let __pThis_ref = { &mut *pThis };
    let p: *mut MemStore = __pThis_ref.pStore;
...
unsafe extern "C" fn memdbFileControl(
    ...
    if op == crate::src::headers::sqlite3_h::SQLITE_FCNTL_VFSNAME {
        let fresh0 = &mut *(pArg as *mut *mut ::core::ffi::c_char);
        *fresh0 = crate::sqlite_printf!("memdb(%p,%lld)", (*p).aData, (*p).sz);
        rc = crate::src::headers::sqlite3_h::SQLITE_OK;
    }
    if op == crate::src::headers::sqlite3_h::SQLITE_FCNTL_SIZE_LIMIT {
        let mut iLimit: crate::src::headers::sqlite3_h::Sqlite3Int64 =
            *(pArg as *mut crate::src::headers::sqlite3_h::Sqlite3Int64);
        if iLimit < (*p).sz {
            if iLimit < 0 as crate::src::headers::sqlite3_h::Sqlite3Int64 {
                iLimit = (*p).szMax;
            } else {
                iLimit = (*p).sz;
            }
        ...
        (*p).szMax = iLimit;
        *(pArg as *mut crate::src::headers::sqlite3_h::Sqlite3Int64) = iLimit;
        rc = crate::src::headers::sqlite3_h::SQLITE_OK;
    }
    memdbLeave(p);
    rc
...
unsafe extern "C" fn memdbFetch(
    pFile: *mut crate::src::headers::sqlite3_h::sqlite3_file,
    iOfst: crate::src::headers::sqlite3_h::Sqlite3Int64,
    iAmt: ::core::ffi::c_int,
    pp: *mut *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    let p: *mut MemStore = (*(pFile as *mut MemFile)).pStore;
    memdbEnter(p);
    if iOfst + iAmt as crate::src::headers::sqlite3_h::Sqlite3Int64 > (*p).sz
        || (*p).mFlags
            & crate::src::headers::sqlite3_h::SQLITE_DESERIALIZE_RESIZEABLE as ::core::ffi::c_uint
            != 0 as ::core::ffi::c_uint
    {
...
unsafe extern "C" fn memdbUnfetch(
    pFile: *mut crate::src::headers::sqlite3_h::sqlite3_file,
    mut _iOfst: crate::src::headers::sqlite3_h::Sqlite3Int64,
...
unsafe extern "C" fn memdbOpen(
    ...
    let pFile: *mut MemFile = pFd as *mut MemFile;
    let mut p: *mut MemStore = ::core::ptr::null_mut::<MemStore>();
    
    ::libc::memset(
        pFile as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<MemFile>() as crate::__stddef_size_t_h::SizeT,
    );
    let szName: ::core::ffi::c_int = crate::src::src::util::sqlite3Strlen30(zName);
    if szName > 1 as ::core::ffi::c_int
        && (*zName.offset(0_isize) as ::core::ffi::c_int == '/' as i32
            || *zName.offset(0_isize) as ::core::ffi::c_int == '\\' as i32)
    {
        let mut i: ::core::ffi::c_int;
        let pVfsMutex: *mut crate::src::src::mutex_unix::sqlite3_mutex =
        ...
        if p.is_null() {
            ...
            p = crate::src::src::malloc::sqlite3Malloc(
                (::core::mem::size_of::<MemStore>() as crate::src::ext::rtree::rtree::U64_0)
                    .wrapping_add(
                        szName as crate::src::ext::rtree::rtree::I64_0
            ...
            let apNew: *mut *mut MemStore = crate::src::src::malloc::sqlite3Realloc(
                memdb_g.apMemStore as *mut ::core::ffi::c_void,
                (::core::mem::size_of::<*mut MemStore>() as crate::src::ext::rtree::rtree::U64_0)
                    .wrapping_mul(
                        (1 as crate::src::ext::rtree::rtree::I64_0
                            + memdb_g.nMemStore as crate::src::ext::rtree::rtree::I64_0)
                            as crate::src::ext::rtree::rtree::U64_0,
                    ),
            ) as *mut *mut MemStore;
            if apNew.is_null() {
            ...
            memdb_g.nMemStore += 1;
            let fresh3 = &mut *apNew.offset(fresh2 as isize);
            *fresh3 = p;
            memdb_g.apMemStore = apNew;
            ::libc::memset(
                p as *mut ::core::ffi::c_void,
                0 as ::core::ffi::c_int,
                ::core::mem::size_of::<MemStore>() as crate::__stddef_size_t_h::SizeT,
            );
            (*p).mFlags = (crate::src::headers::sqlite3_h::SQLITE_DESERIALIZE_RESIZEABLE
                | crate::src::headers::sqlite3_h::SQLITE_DESERIALIZE_FREEONCLOSE)
                as ::core::ffi::c_uint;
            (*p).szMax = crate::src::src::global::sqlite3Config.mxMemdbSize;
            (*p).zFName = p.offset(1_isize) as *mut MemStore as *mut ::core::ffi::c_char;
            ::core::ptr::copy_nonoverlapping(
                zName as *const u8,
                (*p).zFName as *mut u8,
                (szName + 1 as ::core::ffi::c_int) as usize,
            );
            (*p).pMutex = crate::src::src::mutex::sqlite3_mutex_alloc(
    ...
    (*pFd).pMethods =
        &raw const memdb_io_methods as *const crate::src::headers::sqlite3_h::sqlite3_io_methods;
    memdbLeave(p);
    crate::src::headers::sqlite3_h::SQLITE_OK
}
...
unsafe extern "C" fn memdbFullPathname(
    ...
    crate::sqlite_snprintf!(zOut, nOut, "%s", zPath,);
    crate::src::headers::sqlite3_h::SQLITE_OK
}
...
unsafe extern "C" fn memdbCurrentTimeInt64(
    pVfs: *mut crate::src::headers::sqlite3_h::sqlite3_vfs,
    p: *mut crate::src::headers::sqlite3_h::Sqlite3Int64,
) -> ::core::ffi::c_int {
    (*((*pVfs).pAppData as *mut crate::src::headers::sqlite3_h::sqlite3_vfs))
        .xCurrentTimeInt64
        .expect("non-null function pointer")(
...
unsafe extern "C" fn memdbFromDbSchema(
    ...
    let rc: ::core::ffi::c_int = crate::src::src::main::sqlite3_file_control(
    ...
    let pStore: *mut MemStore = (*p).pStore;
    memdbEnter(pStore);
...
pub unsafe extern "C" fn sqlite3_serialize(
    ...
    piSize: *mut crate::src::headers::sqlite3_h::Sqlite3Int64,
    ...
    let pOut: *mut ::core::ffi::c_uchar;
    
    let mut rc: ::core::ffi::c_int;
    if zSchema.is_null() {
        zSchema = (*(*db).aDb.offset(0_isize)).zDbSName;
    }
    let p: *mut MemFile = memdbFromDbSchema(db, zSchema);
    let iDb: ::core::ffi::c_int = crate::src::src::build::sqlite3FindDbName(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        zSchema,
    );
    if !piSize.is_null() {
        *piSize = -(1 as ::core::ffi::c_int) as crate::src::headers::sqlite3_h::Sqlite3Int64;
    }
    ...
    if !p.is_null() {
        ...
        if mFlags & crate::src::headers::sqlite3_h::SQLITE_SERIALIZE_NOCOPY as ::core::ffi::c_uint
            != 0
        {
            pOut = (*pStore).aData;
        } else {
            pOut = crate::src::src::malloc::sqlite3_malloc64(
                (*pStore).sz as crate::src::headers::sqlite3_h::Sqlite3Uint64,
            ) as *mut ::core::ffi::c_uchar;
            if !pOut.is_null() {
                ::core::ptr::copy_nonoverlapping(
    ...
    let pBt: *mut crate::src::headers::btreeInt_h::Btree = (*(*db).aDb.offset(iDb as isize)).pBt;
    if pBt.is_null() {
        return ::core::ptr::null_mut::<::core::ffi::c_uchar>();
    }
    let szPage: ::core::ffi::c_int = crate::src::src::btree::sqlite3BtreeGetPageSize(pBt);
    let zSql: *mut ::core::ffi::c_char = crate::sqlite_printf!("PRAGMA %w.page_count", zSchema);
    rc = if !zSql.is_null() {
    ...
    if rc != crate::src::headers::sqlite3_h::SQLITE_ROW {
        ...
        sz = crate::src::src::vdbeapi::sqlite3_column_int64(pStmt, 0 as ::core::ffi::c_int)
            * szPage as crate::src::headers::sqlite3_h::Sqlite3Int64;
            ...
            != 0
        {
            ...
            pOut = crate::src::src::malloc::sqlite3_malloc64(
                sz as crate::src::headers::sqlite3_h::Sqlite3Uint64,
            ) as *mut ::core::ffi::c_uchar;
            if !pOut.is_null() {
                ...
                while pgno <= nPage {
                    let mut pPage: *mut crate::src::src::pager::DbPage =
                        ::core::ptr::null_mut::<crate::src::src::pager::DbPage>();
                    let pTo: *mut ::core::ffi::c_uchar = pOut.offset(
                        (szPage as crate::src::headers::sqlite3_h::Sqlite3Int64
                            * (pgno - 1 as ::core::ffi::c_int)
                                as crate::src::headers::sqlite3_h::Sqlite3Int64)
                            as isize,
                    ...
                    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
                        ::libc::memcpy(
                            ...
                            crate::src::src::pager::sqlite3PagerGetData(
                                pPage as *mut crate::src::src::pcache::PgHdr,
                            ),
...
pub unsafe extern "C" fn sqlite3_deserialize(
    ...
    szDb: crate::src::headers::sqlite3_h::Sqlite3Int64,
    szBuf: crate::src::headers::sqlite3_h::Sqlite3Int64,
    mFlags: ::core::ffi::c_uint,
) -> ::core::ffi::c_int {
    let p: *mut MemFile;
...
pub unsafe extern "C" fn sqlite3MemdbInit() -> ::core::ffi::c_int {
    let pLower: *mut crate::src::headers::sqlite3_h::sqlite3_vfs =
        crate::src::src::os::sqlite3_vfs_find(::core::ptr::null::<::core::ffi::c_char>())
            as *mut crate::src::headers::sqlite3_h::sqlite3_vfs;
    let mut sz: ::core::ffi::c_uint;
    if pLower.is_null() {
    ...
    crate::src::src::os::sqlite3_vfs_register(
        &raw mut memdb_vfs as *mut _ as *mut crate::src::headers::sqlite3_h::sqlite3_vfs,
        0 as ::core::ffi::c_int,
    )
}
