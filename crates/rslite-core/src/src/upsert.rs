...
#[inline(never)]
unsafe extern "C" fn upsertDelete(
    db: *mut crate::src::headers::sqliteInt_h::sqlite3,
    mut p: *mut crate::src::headers::sqliteInt_h::Upsert,
) {
    loop {
        let pNext: *mut crate::src::headers::sqliteInt_h::Upsert = (*p).pNextUpsert;
        crate::src::src::expr::sqlite3ExprListDelete(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            (*p).pUpsertTarget as *mut crate::src::headers::sqliteInt_h::ExprList,
        );
        crate::src::src::expr::sqlite3ExprDelete(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            (*p).pUpsertTargetWhere as *mut crate::src::headers::sqliteInt_h::Expr,
        );
        crate::src::src::expr::sqlite3ExprListDelete(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            (*p).pUpsertSet as *mut crate::src::headers::sqliteInt_h::ExprList,
        );
        crate::src::src::expr::sqlite3ExprDelete(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            (*p).pUpsertWhere as *mut crate::src::headers::sqliteInt_h::Expr,
        );
...
pub unsafe extern "C" fn sqlite3UpsertDelete(
    db: *mut crate::src::headers::sqliteInt_h::sqlite3,
    p: *mut crate::src::headers::sqliteInt_h::Upsert,
) {
    if !p.is_null() {
        upsertDelete(db, p);
    }
...
pub unsafe extern "C" fn sqlite3UpsertDup(
    db: *mut crate::src::headers::sqliteInt_h::sqlite3,
    p: *mut crate::src::headers::sqliteInt_h::Upsert,
    ...
    sqlite3UpsertNew(
        ...
        crate::src::src::expr::sqlite3ExprListDup(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            __p_ref.pUpsertTarget as *const crate::src::headers::sqliteInt_h::ExprList,
            0 as ::core::ffi::c_int,
        ) as *mut crate::src::headers::sqliteInt_h::ExprList,
        crate::src::src::expr::sqlite3ExprDup(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            __p_ref.pUpsertTargetWhere as *const crate::src::headers::sqliteInt_h::Expr,
            0 as ::core::ffi::c_int,
        ) as *mut crate::src::headers::sqliteInt_h::Expr,
        crate::src::src::expr::sqlite3ExprListDup(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            __p_ref.pUpsertSet as *const crate::src::headers::sqliteInt_h::ExprList,
            0 as ::core::ffi::c_int,
        ) as *mut crate::src::headers::sqliteInt_h::ExprList,
        crate::src::src::expr::sqlite3ExprDup(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            __p_ref.pUpsertWhere as *const crate::src::headers::sqliteInt_h::Expr,
            0 as ::core::ffi::c_int,
        ) as *mut crate::src::headers::sqliteInt_h::Expr,
...
pub unsafe extern "C" fn sqlite3UpsertNew(
    db: *mut crate::src::headers::sqliteInt_h::sqlite3,
    pTarget: *mut crate::src::headers::sqliteInt_h::ExprList,
    pTargetWhere: *mut crate::src::headers::sqliteInt_h::Expr,
    pSet: *mut crate::src::headers::sqliteInt_h::ExprList,
    ...
    if pNew.is_null() {
        crate::src::src::expr::sqlite3ExprListDelete(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            pTarget as *mut crate::src::headers::sqliteInt_h::ExprList,
        );
        crate::src::src::expr::sqlite3ExprDelete(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            pTargetWhere as *mut crate::src::headers::sqliteInt_h::Expr,
        );
        crate::src::src::expr::sqlite3ExprListDelete(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            pSet as *mut crate::src::headers::sqliteInt_h::ExprList,
        );
        crate::src::src::expr::sqlite3ExprDelete(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
...
pub unsafe extern "C" fn sqlite3UpsertAnalyzeTarget(
    ...
    pAll: *mut crate::src::headers::sqliteInt_h::Upsert,
) -> ::core::ffi::c_int {
    let mut pTab: *mut crate::src::headers::sqliteInt_h::Table;
    let mut rc: ::core::ffi::c_int;
    let mut iCursor: ::core::ffi::c_int;
    let mut pIdx: *mut crate::src::headers::sqliteInt_h::Index;
    let mut pTarget: *mut crate::src::headers::sqliteInt_h::ExprList;
    ...
    while !pUpsert.is_null() && !(*pUpsert).pUpsertTarget.is_null() {
        ...
        rc = crate::src::src::resolve::sqlite3ResolveExprNames(
            &raw mut sNC as *mut _ as *mut crate::src::headers::sqliteInt_h::NameContext,
            (*pUpsert).pUpsertTargetWhere as *mut crate::src::headers::sqliteInt_h::Expr,
        );
        if rc != 0 {
            return rc;
        }
...
pub unsafe extern "C" fn sqlite3UpsertNextIsIPK(
    pUpsert: *mut crate::src::headers::sqliteInt_h::Upsert,
) -> ::core::ffi::c_int {
    let mut pNext: *mut crate::src::headers::sqliteInt_h::Upsert;
    if pUpsert.is_null() {
...
pub unsafe extern "C" fn sqlite3UpsertDoUpdate(
    ...
    if !pIdx.is_null() && iCur != iDataCur {
            ...
            == 0 as crate::src::ext::rtree::rtree::U32_0
        {
            ...
            let nPk: ::core::ffi::c_int = (*pPk).nKeyCol as ::core::ffi::c_int;
            let iPk: ::core::ffi::c_int = (*pParse).nMem + 1 as ::core::ffi::c_int;
            (*pParse).nMem += nPk;
            ...
            i = crate::src::src::vdbeaux::sqlite3VdbeAddOp4Int(
                v,
    ...
    while i < (*pTab).nCol as ::core::ffi::c_int {
        if (*(*pTab).aCol.offset(i as isize)).affinity as ::core::ffi::c_int
    ...
    crate::src::src::update::sqlite3Update(
        ...
        crate::src::src::expr::sqlite3ExprListDup(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            (*pUpsert).pUpsertSet as *const crate::src::headers::sqliteInt_h::ExprList,
            0 as ::core::ffi::c_int,
        ) as *mut crate::src::headers::sqliteInt_h::ExprList
            as *mut crate::src::headers::sqliteInt_h::ExprList,
        crate::src::src::expr::sqlite3ExprDup(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            (*pUpsert).pUpsertWhere as *const crate::src::headers::sqliteInt_h::Expr,
            0 as ::core::ffi::c_int,
        ) as *mut crate::src::headers::sqliteInt_h::Expr
            as *mut crate::src::headers::sqliteInt_h::Expr,
        crate::src::headers::sqliteInt_h::OE_Abort,
