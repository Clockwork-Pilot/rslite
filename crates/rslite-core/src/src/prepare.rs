...
pub use crate::src::src::btree::sqlite3BtreeSchemaLocked;
...
pub use crate::src::headers::sqliteInt_h::INITFLAG_AlterMask;
...
pub use crate::src::headers::sqliteInt_h::PARSE_HDR_SZ;
...
pub use crate::src::src::utf::sqlite3Utf16ByteLen;
...
pub use crate::src::src::util::sqlite3ErrorClear;
pub use crate::src::src::util::sqlite3FaultSim;
pub use crate::src::src::util::sqlite3GetUInt32;
...
pub use crate::src::src::vdbeaux::sqlite3VdbePrepareFlags;
pub use crate::src::src::vdbeaux::sqlite3VdbeResetStepResult;
pub use crate::src::src::vdbeaux::sqlite3VdbeSetSql;
pub use crate::src::src::vdbeaux::sqlite3VdbeSwap;

unsafe extern "C" fn corruptSchema(
    pData: *mut crate::src::headers::sqliteInt_h::InitData,
    azObj: *mut *mut ::core::ffi::c_char,
    zExtra: *const ::core::ffi::c_char,
) {
    let db: *mut crate::src::headers::sqliteInt_h::sqlite3 = (*pData).db;
    if (*db).mallocFailed != 0 {
        (*pData).rc = crate::src::headers::sqliteInt_h::SQLITE_NOMEM_BKPT;
    } else if (*(*pData).pzErrMsg.offset(0_isize)).is_null() {
            ...
            *__pData_ref.pzErrMsg = crate::src::src::printf::sqlite3MPrintf_args(
                ...
                &[
                    crate::src::src::printf::PrintfArg::Str(
                        *azObj.offset(0_isize) as *mut ::core::ffi::c_char
                    ),
                    crate::src::src::printf::PrintfArg::Str(
                        *azObj.offset(1_isize) as *mut ::core::ffi::c_char
                    ),
                    crate::src::src::printf::PrintfArg::Str(
                        azAlterType[(__pData_ref.mInitFlags
                            & crate::src::headers::sqliteInt_h::INITFLAG_AlterMask
            ...
            != 0
        {
            ...
            let zObj: *const ::core::ffi::c_char = if !(*azObj.offset(1_isize)).is_null() {
                *azObj.offset(1_isize) as *const ::core::ffi::c_char
            } else {
            ...
            z = crate::src::src::printf::sqlite3MPrintf_args(
                ...
                &[crate::src::src::printf::PrintfArg::Str(
                    zObj as *mut ::core::ffi::c_char,
                )],
            );
            if !zExtra.is_null() && *zExtra.offset(0_isize) as ::core::ffi::c_int != 0 {
                z = crate::src::src::printf::sqlite3MPrintf_args(
                    db as *mut crate::src::headers::sqliteInt_h::sqlite3,
...
pub unsafe extern "C" fn sqlite3InitCallback(
    pInit: *mut ::core::ffi::c_void,
    mut _argc: ::core::ffi::c_int,
    argv: *mut *mut ::core::ffi::c_char,
    mut _NotUsed: *mut *mut ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let pData: *mut crate::src::headers::sqliteInt_h::InitData =
        pInit as *mut crate::src::headers::sqliteInt_h::InitData;
    let __pData_ref = unsafe { &mut *pData };
    let db: *mut crate::src::headers::sqliteInt_h::sqlite3 = __pData_ref.db;
    let iDb: ::core::ffi::c_int = __pData_ref.iDb;
    (*db).mDbFlags |= crate::src::headers::sqliteInt_h::DBFLAG_EncodingFixed
        as crate::src::ext::rtree::rtree::U32_0;
    if argv.is_null() {
    ...
    if (*argv.offset(3_isize)).is_null() {
        corruptSchema(pData, argv, ::core::ptr::null::<::core::ffi::c_char>());
    } else if !(*argv.offset(4_isize)).is_null()
        && 'c' as i32
            == *(&raw const crate::src::src::global::sqlite3UpperToLower
                as *const ::core::ffi::c_uchar)
                .offset(
                    *(*argv.offset(4_isize)).offset(0_isize) as ::core::ffi::c_uchar as isize,
                ) as ::core::ffi::c_int
        && 'r' as i32
            == *(&raw const crate::src::src::global::sqlite3UpperToLower
                as *const ::core::ffi::c_uchar)
                .offset(
                    *(*argv.offset(4_isize)).offset(1_isize) as ::core::ffi::c_uchar as isize,
                ) as ::core::ffi::c_int
    {
        ...
        if crate::src::headers::sqlite3_h::SQLITE_OK != rc
            && (__db_ref.init.orphanTrigger() == 0) {
                ...
                } else if rc != crate::src::headers::sqlite3_h::SQLITE_INTERRUPT
    ...
    } else if (*argv.offset(1_isize)).is_null()
        || !(*argv.offset(4_isize)).is_null()
            && *(*argv.offset(4_isize)).offset(0_isize) as ::core::ffi::c_int
                != 0 as ::core::ffi::c_int
    {
        corruptSchema(pData, argv, ::core::ptr::null::<::core::ffi::c_char>());
    } else {
        
        let pIndex: *mut crate::src::headers::sqliteInt_h::Index = crate::src::src::build::sqlite3FindIndex(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            *argv.offset(1_isize),
...
pub unsafe extern "C" fn sqlite3InitOne(
    ...
    mFlags: crate::src::ext::rtree::rtree::U32_0,
) -> ::core::ffi::c_int {
    ...
    let mut initData: crate::src::headers::sqliteInt_h::InitData =
        crate::src::headers::sqliteInt_h::__anon_struct_9 {
    ...
    let __db_ref = unsafe { &mut *db };
    let mask: ::core::ffi::c_int = (__db_ref.mDbFlags
    ...
    let zSchemaTabName: *const ::core::ffi::c_char = if crate::src::headers::sqliteInt_h::OMIT_TEMPDB == 0 && iDb == 1 as ::core::ffi::c_int {
    ...
    if initData.rc != 0 {
        ...
        if (*pDb).pBt.is_null() {
            let fresh0 = &mut (*(*__db_ref.aDb.offset(1_isize)).pSchema).schemaFlags;
            *fresh0 = (*fresh0 as ::core::ffi::c_int | 0x1 as ::core::ffi::c_int)
                as crate::src::fts5::U16_0;
            rc = crate::src::headers::sqlite3_h::SQLITE_OK;
        } else {
            crate::src::src::btmutex::sqlite3BtreeEnter((*pDb).pBt);
            if crate::src::src::btree::sqlite3BtreeTxnState((*pDb).pBt)
...
pub unsafe extern "C" fn sqlite3Init(
    ...
    let __db_ref = unsafe { &mut *db };
    let commit_internal: ::core::ffi::c_int = (__db_ref.mDbFlags
        & crate::src::headers::sqliteInt_h::DBFLAG_SchemaChange
            as crate::src::ext::rtree::rtree::U32_0
        == 0) as ::core::ffi::c_int;
    __db_ref.enc = (*(*__db_ref.aDb.offset(0_isize)).pSchema).enc;
    if ((*(*__db_ref.aDb.offset(0_isize)).pSchema).schemaFlags as ::core::ffi::c_int
...
pub unsafe extern "C" fn sqlite3ReadSchema(
    ...
    if (*db).init.busy == 0 {
        ...
        if rc != crate::src::headers::sqlite3_h::SQLITE_OK {
            ...
            (*db).mDbFlags |= crate::src::headers::sqliteInt_h::DBFLAG_SchemaKnownOk
                as crate::src::ext::rtree::rtree::U32_0;
        }
    }
    rc
...
unsafe extern "C" fn schemaIsValid(pParse: *mut crate::src::headers::sqliteInt_h::Parse) {
    let db: *mut crate::src::headers::sqliteInt_h::sqlite3 = (*pParse).db;
    ...
    while iDb < (*db).nDb {
        ...
        if !pBt.is_null() {
            ...
            crate::src::src::btree::sqlite3BtreeGetMeta(
                ...
                &raw mut cookie as *mut crate::src::ext::rtree::rtree::U32_0,
            );
...
pub unsafe extern "C" fn sqlite3ParseObjectReset(
    pParse: *mut crate::src::headers::sqliteInt_h::Parse,
) {
    ...
    if !__pParse_ref.aTableLock.is_null() {
        crate::src::src::malloc::sqlite3DbNNFreeNN(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            __pParse_ref.aTableLock as *mut ::core::ffi::c_void,
        );
    }
    while !__pParse_ref.pCleanup.is_null() {
        let pCleanup: *mut crate::src::headers::sqliteInt_h::ParseCleanup =
            __pParse_ref.pCleanup;
        ...
        crate::src::src::malloc::sqlite3DbNNFreeNN(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            pCleanup as *mut ::core::ffi::c_void,
        );
    }
    if !__pParse_ref.aLabel.is_null() {
        crate::src::src::malloc::sqlite3DbNNFreeNN(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            __pParse_ref.aLabel as *mut ::core::ffi::c_void,
        );
    }
    if !__pParse_ref.pConstExpr.is_null() {
        crate::src::src::expr::sqlite3ExprListDelete(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            __pParse_ref.pConstExpr as *mut crate::src::headers::sqliteInt_h::ExprList,
        );
    }
    let __db_ref = unsafe { &mut *db };
...
pub unsafe extern "C" fn sqlite3ParserAddCleanup(
    ...
    if crate::src::src::util::sqlite3FaultSim(300 as ::core::ffi::c_int) != 0 {
        ...
        pCleanup = crate::src::src::malloc::sqlite3DbMallocRaw(
            (*pParse).db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            ::core::mem::size_of::<crate::src::headers::sqliteInt_h::ParseCleanup>()
                as crate::src::ext::rtree::rtree::U64_0,
...
pub unsafe extern "C" fn sqlite3ParseObjectInit(
    pParse: *mut crate::src::headers::sqliteInt_h::Parse,
    db: *mut crate::src::headers::sqliteInt_h::sqlite3,
) {
    ::libc::memset(
        (pParse as *mut ::core::ffi::c_char).offset(8_isize) as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        crate::src::headers::sqliteInt_h::PARSE_HDR_SZ as crate::__stddef_size_t_h::SizeT,
    );
    ::libc::memset(
...
unsafe extern "C" fn sqlite3Prepare(
    ...
    prepFlags: crate::src::ext::rtree::rtree::U32_0,
    pReprepare: *mut crate::src::headers::vdbeInt_h::Vdbe,
    ...
    let mut rc: ::core::ffi::c_int = crate::src::headers::sqlite3_h::SQLITE_OK;
    let mut i: ::core::ffi::c_int;
    let mut sParse: crate::src::headers::sqliteInt_h::Parse =
    ...
    ::libc::memset(
        (&raw mut sParse as *mut ::core::ffi::c_char).offset(8_isize)
            as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        crate::src::headers::sqliteInt_h::PARSE_HDR_SZ as crate::__stddef_size_t_h::SizeT,
    );
    ::libc::memset(
        (&raw mut sParse as *mut ::core::ffi::c_char)
            .offset(crate::src::headers::sqliteInt_h::PARSE_RECURSE_SZ as isize)
            as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        crate::src::headers::sqliteInt_h::PARSE_TAIL_SZ,
    ...
    if !pReprepare.is_null() {
        ...
        sParse.explain = crate::src::src::vdbeapi::sqlite3_stmt_isexplain(
            pReprepare as *mut crate::src::headers::sqlite3_h::Sqlite3Stmt,
        ) as crate::src::ext::rtree::rtree::U8_0;
    }
    if __db_ref.mallocFailed != 0 {
        crate::src::src::util::sqlite3ErrorMsg_args(
        ...
        sParse.prepFlags = (prepFlags & 0xff as crate::src::ext::rtree::rtree::U32_0)
            as crate::src::ext::rtree::rtree::U8_0;
                ...
                if nBytes >= 0 as ::core::ffi::c_int
                    && (nBytes == 0 as ::core::ffi::c_int
                        || *zSql.offset((nBytes - 1 as ::core::ffi::c_int) as isize)
                            ...
                            != 0 as ::core::ffi::c_int)
                {
                    let zSqlCopy: *mut ::core::ffi::c_char;
                    let mxLen: ::core::ffi::c_int = __db_ref.aLimit
                        [crate::src::headers::sqlite3_h::SQLITE_LIMIT_SQL_LENGTH as usize];
                    if nBytes > mxLen {
                        crate::src::src::util::sqlite3ErrorWithMsg_args(
                            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                        ...
                        zSqlCopy = crate::src::src::malloc::sqlite3DbStrNDup(
                            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                            zSql,
                        ...
                        if !zSqlCopy.is_null() {
                            ...
                            crate::src::src::malloc::sqlite3DbFree(
                                db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                                zSqlCopy as *mut ::core::ffi::c_void,
                            );
                        } else {
                            sParse.zTail =
                ...
                match current_block {
                    ...
                    _ => {
                        ...
                        if __db_ref.mallocFailed != 0 {
                            ...
                            sParse.set_checkSchema(
                                0 as crate::src::headers::sqliteInt_h::Bft
                                    as crate::src::headers::sqliteInt_h::Bft,
                            );
                        }
                        if sParse.rc != crate::src::headers::sqlite3_h::SQLITE_OK
                            && sParse.rc != crate::src::headers::sqlite3_h::SQLITE_DONE
                        {
                            if sParse.checkSchema() as ::core::ffi::c_int != 0
                                && __db_ref.init.busy as ::core::ffi::c_int
                                    == 0 as ::core::ffi::c_int
                            {
                            ...
                            *ppStmt =
                                sParse.pVdbe as *mut crate::src::headers::sqlite3_h::Sqlite3Stmt;
                            rc = crate::src::headers::sqlite3_h::SQLITE_OK;
                            crate::src::src::util::sqlite3ErrorClear(
                                db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                            );
                        }
                        while !sParse.pTriggerPrg.is_null() {
                            let pT: *mut crate::src::headers::sqliteInt_h::TriggerPrg =
                                sParse.pTriggerPrg;
                            sParse.pTriggerPrg = (*pT).pNext;
                            crate::src::src::malloc::sqlite3DbFree(
                                db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                                pT as *mut ::core::ffi::c_void,
                            );
                        }
                    }
                }
...
unsafe extern "C" fn sqlite3LockAndPrepare(
    ...
    nBytes: ::core::ffi::c_int,
    prepFlags: crate::src::ext::rtree::rtree::U32_0,
    pOld: *mut crate::src::headers::vdbeInt_h::Vdbe,
    ppStmt: *mut *mut crate::src::headers::sqlite3_h::Sqlite3Stmt,
    pzTail: *mut *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let mut rc: ::core::ffi::c_int;
    ...
    *ppStmt = ::core::ptr::null_mut::<crate::src::headers::sqlite3_h::Sqlite3Stmt>();
    ...
    loop {
        ...
        cnt += 1;
        if !(rc == crate::src::headers::sqlite3_h::SQLITE_ERROR_RETRY
            && cnt <= 25 as ::core::ffi::c_int
...
pub unsafe extern "C" fn sqlite3Reprepare(
    p: *mut crate::src::headers::vdbeInt_h::Vdbe,
) -> ::core::ffi::c_int {
    
    let mut pNew: *mut crate::src::headers::sqlite3_h::Sqlite3Stmt =
        ::core::ptr::null_mut::<crate::src::headers::sqlite3_h::Sqlite3Stmt>();
    
    
    
    let zSql: *const ::core::ffi::c_char = crate::src::src::vdbeapi::sqlite3_sql(
        p as *mut crate::src::headers::sqlite3_h::Sqlite3Stmt,
    );
    let db: *mut crate::src::headers::sqliteInt_h::sqlite3 = crate::src::src::vdbeaux::sqlite3VdbeDb(p)
        as *mut crate::src::headers::sqliteInt_h::sqlite3;
    let prepFlags: crate::src::ext::rtree::rtree::U8_0 = crate::src::src::vdbeaux::sqlite3VdbePrepareFlags(p);
    let rc: ::core::ffi::c_int = sqlite3LockAndPrepare(
        db,
        zSql,
        -(1 as ::core::ffi::c_int),
    ...
    crate::src::src::vdbeapi::sqlite3TransferBindings(
        pNew,
        p as *mut crate::src::headers::sqlite3_h::Sqlite3Stmt,
    );
    crate::src::src::vdbeaux::sqlite3VdbeResetStepResult(
        pNew as *mut crate::src::headers::vdbeInt_h::Vdbe,
    );
    crate::src::src::vdbeaux::sqlite3VdbeFinalize(
        pNew as *mut crate::src::headers::vdbeInt_h::Vdbe,
    );
    crate::src::headers::sqlite3_h::SQLITE_OK
}
...
pub unsafe extern "C" fn sqlite3_prepare_v3(
    ...
    let rc: ::core::ffi::c_int = sqlite3LockAndPrepare(
        ...
        crate::src::src::vdbe::SQLITE_PREPARE_SAVESQL as crate::src::ext::rtree::rtree::U32_0
            | prepFlags as crate::src::ext::rtree::rtree::U32_0
                & crate::src::src::vdbe::SQLITE_PREPARE_MASK
                    as crate::src::ext::rtree::rtree::U32_0,
        ::core::ptr::null_mut::<crate::src::headers::vdbeInt_h::Vdbe>(),
        ppStmt,
        pzTail,
...
unsafe extern "C" fn sqlite3Prepare16(
    ...
    *ppStmt = ::core::ptr::null_mut::<crate::src::headers::sqlite3_h::Sqlite3Stmt>();
    ...
    if nBytes >= 0 as ::core::ffi::c_int {
        ...
        let z: *const ::core::ffi::c_char = zSql as *const ::core::ffi::c_char;
        ...
        let z_0: *const ::core::ffi::c_char = zSql as *const ::core::ffi::c_char;
    ...
    let zSql8: *mut ::core::ffi::c_char = crate::src::src::utf::sqlite3Utf16to8(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        zSql,
        nBytes,
    ...
    if !zTail8.is_null() && !pzTail.is_null() {
        let chars_parsed: ::core::ffi::c_int = crate::src::src::utf::sqlite3Utf8CharLen(
            zSql8,
...
pub unsafe extern "C" fn sqlite3_prepare16(
    ...
    let rc: ::core::ffi::c_int = sqlite3Prepare16(
        db,
        zSql,
        nBytes,
        0 as crate::src::ext::rtree::rtree::U32_0,
