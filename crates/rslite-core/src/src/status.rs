...
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_CACHE_USED;
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_CACHE_USED_SHARED;
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_CACHE_WRITE;
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_DEFERRED_FKS_1;
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_HIT;
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_MISS_FULL;
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_MISS_SIZE;
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_LOOKASIDE_USED;
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_SCHEMA_USED;
pub use crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_STMT_USED;
...
pub use crate::src::src::malloc::sqlite3MallocMutex;
...
pub use crate::src::src::pager::sqlite3PagerCacheStat;
pub use crate::src::src::pager::sqlite3PagerMemUsed;
pub use crate::src::src::pcache1::sqlite3Pcache1Mutex;
...
pub extern "C" fn sqlite3StatusHighwater(op: ::core::ffi::c_int, X: ::core::ffi::c_int) {
    ...
    let newValue: Sqlite3StatValueType = X as Sqlite3StatValueType;
    unsafe {
...
pub unsafe extern "C" fn sqlite3_status64(
    ...
    let pMutex: *mut crate::src::src::mutex_unix::sqlite3_mutex = if statMutex[op as usize] as ::core::ffi::c_int != 0 {
...
pub unsafe extern "C" fn sqlite3_status(
    ...
    let rc: ::core::ffi::c_int = sqlite3_status64(op, &raw mut iCur, &raw mut iHwtr, resetFlag);
...
pub unsafe extern "C" fn sqlite3_db_status64(
    ...
    match op {
            ...
            while i < (*db).nDb {
                ...
                if !pBt.is_null() {
                    ...
                    let mut nByte: ::core::ffi::c_int =
                        crate::src::src::pager::sqlite3PagerMemUsed(pPager);
                ...
                if !pSchema.is_null() {
                    ...
                    nByte_0 = (nByte_0 as ::core::ffi::c_uint).wrapping_add(
                        (crate::src::src::global::sqlite3Config
                            ...
                            ::core::mem::size_of::<crate::src::src::hash::HashElem>()
                                as ::core::ffi::c_int,
                        ) as ::core::ffi::c_uint)
                            .wrapping_mul(
                                (*pSchema)
                    ...
                    while !p_0.is_null() {
                        crate::src::src::trigger::sqlite3DeleteTrigger(
                            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                            (*p_0).data as *mut crate::src::headers::sqliteInt_h::Trigger
                    ...
                    while !p_0.is_null() {
                        crate::src::src::build::sqlite3DeleteTable(
                            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                            (*p_0).data as *mut crate::src::headers::sqliteInt_h::Table
        ...
        crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_CACHE_SPILL => {
            op = crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_CACHE_WRITE
                + 1 as ::core::ffi::c_int;
        ...
        crate::src::headers::sqlite3_h::SQLITE_DBSTATUS_TEMPBUF_SPILL => {
            ...
            if !(*(*db).aDb.offset(1_isize)).pBt.is_null() {
                let pPager_1: *mut crate::src::src::pager::Pager =
                    crate::src::src::btree::sqlite3BtreePager((*(*db).aDb.offset(1_isize)).pBt)
                        as *mut crate::src::src::pager::Pager;
...
pub unsafe extern "C" fn sqlite3_db_status(
    ...
    let rc: ::core::ffi::c_int = sqlite3_db_status64(db, op, &raw mut C, &raw mut H, resetFlag);
    if rc == 0 as ::core::ffi::c_int {
        *pCurrent =
