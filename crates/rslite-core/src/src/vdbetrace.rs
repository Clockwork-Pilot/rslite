...
pub use crate::src::src::vdbeapi::sqlite3VdbeParameterIndex;
...
pub unsafe extern "C" fn sqlite3VdbeExpandSql(
    ...
    if (*db).nVdbeExec > 1 as ::core::ffi::c_int {
        ...
        crate::src::src::printf::sqlite3_str_append(
            &raw mut out as *mut _ as *mut crate::src::headers::sqliteInt_h::sqlite3_str,
            zRawSql,
            crate::src::src::util::sqlite3Strlen30(zRawSql),
        );
    } else {
        while *zRawSql.offset(0 as isize) != 0 {
            ...
            if *zRawSql.offset(0 as isize) as ::core::ffi::c_int == '?' as i32 {
                if nToken > 1 as crate::src::ext::rtree::rtree::I64_0 {
                    crate::src::src::util::sqlite3GetInt32(
                        zRawSql.offset(1 as isize) as *const ::core::ffi::c_char,
                        &raw mut idx,
                    );
                } else {
                    idx = nextIndex;
                ...
                idx = crate::src::src::vdbeapi::sqlite3VdbeParameterIndex(
                    p as *mut crate::src::headers::vdbeInt_h::Vdbe,
                    zRawSql,
                    nToken as ::core::ffi::c_int,
                );
            }
            ...
            pVar = (*p).aVar.offset((idx - 1 as ::core::ffi::c_int) as isize)
            ...
            } else if (*pVar).flags as ::core::ffi::c_int
            ...
            } else if (*pVar).flags as ::core::ffi::c_int & crate::src::headers::vdbeInt_h::MEM_Real
                != 0
            {
                sqlite3_str_vappendf2(
                    &raw mut out as *mut _ as *mut crate::src::headers::sqliteInt_h::sqlite3_str,
                ...
                != 0
            {
                ...
                if enc as ::core::ffi::c_int != crate::src::headers::sqlite3_h::SQLITE_UTF8 {
                    ...
                    {
                        out.accError = crate::src::headers::sqlite3_h::SQLITE_NOMEM
            ...
            } else if (*pVar).flags as ::core::ffi::c_int & crate::src::headers::vdbeInt_h::MEM_Zero
                != 0
            {
                sqlite3_str_vappendf2(
                    &raw mut out as *mut _ as *mut crate::src::headers::sqliteInt_h::sqlite3_str,
