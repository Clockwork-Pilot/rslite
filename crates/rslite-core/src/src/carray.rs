...
pub use crate::src::headers::sqlite3_h::CARRAY_BLOB;
pub use crate::src::headers::sqlite3_h::CARRAY_DOUBLE;
pub use crate::src::headers::sqlite3_h::CARRAY_INT32;
pub use crate::src::headers::sqlite3_h::CARRAY_INT64;
pub use crate::src::headers::sqlite3_h::CARRAY_TEXT;
...
pub struct carray_cursor {
    ...
    pub iCnt: crate::src::headers::sqlite3_h::Sqlite3Int64,
...
unsafe extern "C" fn carrayConnect(
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        *ppVtab = crate::src::src::malloc::sqlite3_malloc(::core::mem::size_of::<
            crate::src::headers::sqlite3_h::sqlite3_vtab,
        >() as ::core::ffi::c_int)
...
unsafe extern "C" fn carrayDisconnect(
...
unsafe extern "C" fn carrayOpen(
    ...
    ::libc::memset(
        ...
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<carray_cursor>() as crate::__stddef_size_t_h::SizeT,
    );
    *ppCursor = &raw mut (*pCur).base;
    crate::src::headers::sqlite3_h::SQLITE_OK
}

unsafe extern "C" fn carrayClose(
...
unsafe extern "C" fn carrayNext(
    cur: *mut crate::src::headers::sqlite3_h::sqlite3_vtab_cursor,
) -> ::core::ffi::c_int {
    let pCur: *mut carray_cursor = cur as *mut carray_cursor;
    (*pCur).iRowid += 1;
    crate::src::headers::sqlite3_h::SQLITE_OK
}
...
unsafe extern "C" fn carrayColumn(
    ...
    let pCur: *mut carray_cursor = cur as *mut carray_cursor;
    let x: crate::src::headers::sqlite3_h::Sqlite3Int64;
    match i {
        ...
        _ => match (*pCur).eType as ::core::ffi::c_int {
            crate::src::headers::sqlite3_h::CARRAY_INT32 => {
                let p: *mut ::core::ffi::c_int = (*pCur).pPtr as *mut ::core::ffi::c_int;
                crate::src::src::vdbeapi::sqlite3_result_int(
                    ctx,
                    *p.offset(
                        ((*pCur).iRowid - 1 as crate::src::headers::sqlite3_h::Sqlite3Int64)
                            as isize,
                    ),
                );
                return crate::src::headers::sqlite3_h::SQLITE_OK;
            ...
            crate::src::headers::sqlite3_h::CARRAY_INT64 => {
                let p_0: *mut crate::src::headers::sqlite3_h::Sqlite3Int64 =
                    (*pCur).pPtr as *mut crate::src::headers::sqlite3_h::Sqlite3Int64;
            ...
            crate::src::headers::sqlite3_h::CARRAY_TEXT => {
                let p_2: *mut *const ::core::ffi::c_char =
            ...
            _ => {
                let __pCur_ref = { &*pCur };
                let p_3: *const ::libc::iovec = __pCur_ref.pPtr as *mut ::libc::iovec;
                crate::src::src::vdbeapi::sqlite3_result_blob(
                    ctx,
                    (*p_3.offset(
                        (__pCur_ref.iRowid - 1 as crate::src::headers::sqlite3_h::Sqlite3Int64)
                            as isize,
                    ))
                    .iov_base,
                    (*p_3.offset(
...
unsafe extern "C" fn carrayFilter(
    ...
    let pCur: *mut carray_cursor = pVtabCursor as *mut carray_cursor;
    let __pCur_ref = { &mut *pCur };
    __pCur_ref.pPtr = ::core::ptr::null_mut::<::core::ffi::c_void>();
    __pCur_ref.iCnt = 0 as crate::src::headers::sqlite3_h::Sqlite3Int64;
    match idxNum {
        1 => {
            ...
            if !pBind.is_null() {
                ...
                __pCur_ref.iCnt =
                    __pBind_ref.nData as crate::src::headers::sqlite3_h::Sqlite3Int64;
                __pCur_ref.eType =
        ...
        2 | 3 => {
            ...
            if idxNum < 3 as ::core::ffi::c_int {
                __pCur_ref.eType =
                    crate::src::headers::sqlite3_h::CARRAY_INT32 as ::core::ffi::c_uchar;
            } else {
                ...
                {
                    if crate::src::src::util::sqlite3_stricmp(zType, azCarrayType[i as usize])
                        == 0 as ::core::ffi::c_int
                    {
                        break;
                    }
                        ...
                        .wrapping_div(::core::mem::size_of::<*const ::core::ffi::c_char>() as usize)
                {
                    (*(*pVtabCursor).pVtab).zErrMsg =
                        crate::sqlite_printf!("unknown datatype: %Q", zType);
...
unsafe extern "C" fn carrayBestIndex(
    ...
    if ptrIdx >= 0 as ::core::ffi::c_int {
        ...
        (*__pIdxInfo_ref.aConstraintUsage.offset(ptrIdx as isize)).argvIndex =
            1 as ::core::ffi::c_int;
...
unsafe extern "C" fn carrayBindDel(pPtr: *mut ::core::ffi::c_void) {
    let p: *mut carray_bind = pPtr as *mut carray_bind;
    if (*p).xDel.is_some() {
...
pub unsafe extern "C" fn sqlite3_carray_bind(
    ...
    if !(crate::src::headers::sqlite3_h::CARRAY_INT32..=crate::src::headers::sqlite3_h::CARRAY_BLOB).contains(&mFlags) {
        ...
        pNew =
            crate::src::src::malloc::sqlite3_malloc64(::core::mem::size_of::<carray_bind>()
                as crate::src::headers::sqlite3_h::Sqlite3Uint64) as *mut carray_bind;
        if pNew.is_null() {
                ...
                >(-(1 as ::core::ffi::c_int) as crate::src::headers::stdlib::IntptrT)
            {
                ...
                match mFlags {
                    crate::src::headers::sqlite3_h::CARRAY_INT32 => {
                        sz *= 4 as crate::src::headers::sqlite3_h::Sqlite3Int64;
                    }
                    crate::src::headers::sqlite3_h::CARRAY_INT64 => {
                        sz *= 8 as crate::src::headers::sqlite3_h::Sqlite3Int64;
                    }
                    crate::src::headers::sqlite3_h::CARRAY_DOUBLE => {
                        sz *= 8 as crate::src::headers::sqlite3_h::Sqlite3Int64;
                    }
                ...
                (*pNew).aData = crate::src::src::malloc::sqlite3_malloc64(
                ...
                if (*pNew).aData.is_null() {
                    ...
                    if mFlags == crate::src::headers::sqlite3_h::CARRAY_TEXT {
                        let az: *mut *mut ::core::ffi::c_char =
                        ...
                        i = 0 as ::core::ffi::c_int;
                        while i < nData {
                            let zData: *const ::core::ffi::c_char =
                                *(aData as *mut *mut ::core::ffi::c_char).offset(i as isize);
                        ...
                        let p: *mut ::libc::iovec = (*pNew).aData as *mut ::libc::iovec;
                        let mut z_1: *mut ::core::ffi::c_uchar = p.offset(nData as isize)
                            as *mut ::libc::iovec
                        ...
                        ::libc::memcpy(
                            (*pNew).aData,
                            aData,
                            sz as crate::__stddef_size_t_h::SizeT,
                        );
                    }
                    (*pNew).xDel = Some(
...
pub unsafe extern "C" fn sqlite3CarrayRegister(
    db: *mut crate::src::headers::sqliteInt_h::sqlite3,
