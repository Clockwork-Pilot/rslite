...
unsafe extern "C" fn statConnect(
    ...
    if argc >= 4 as ::core::ffi::c_int {
        ...
        crate::src::src::util::sqlite3TokenInit(
            ...
            *argv.offset(3_isize) as *mut ::core::ffi::c_char,
        );
        ...
        if iDb < 0 as ::core::ffi::c_int {
            *pzErr = crate::sqlite_printf!("no such database: %s", *argv.offset(3_isize));
    ...
    }
    {
        ...
        crate::src::src::vtab::sqlite3_vtab_config_args(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            crate::src::headers::sqlite3_h::SQLITE_VTAB_DIRECTONLY,
            _vtab_args.as_ptr(),
        );
    }
    rc = crate::src::src::vtab::sqlite3_declare_vtab(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        &raw const zDbstatSchema as *const ::core::ffi::c_char,
    );
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        pTab =
            crate::src::src::malloc::sqlite3_malloc64(::core::mem::size_of::<StatTable>()
                as crate::src::headers::sqlite3_h::Sqlite3Uint64) as *mut StatTable;
        if pTab.is_null() {
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        ::libc::memset(
            ...
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<StatTable>() as crate::__stddef_size_t_h::SizeT,
        );
        (*pTab).db = db;
        (*pTab).iDb = iDb;
    }
...
unsafe extern "C" fn statBestIndex(
    ...
    while i < __pIdxInfo_ref.nConstraint {
        if ((*__pIdxInfo_ref.aConstraint.offset(i as isize)).op as ::core::ffi::c_int == crate::src::headers::sqlite3_h::SQLITE_INDEX_CONSTRAINT_EQ)
        {
    ...
    if iSchema >= 0 as ::core::ffi::c_int {
        ...
        (*__pIdxInfo_ref.aConstraintUsage.offset(iSchema as isize)).omit =
    ...
    if __pIdxInfo_ref.nOrderBy == 1 as ::core::ffi::c_int
        ...
        || __pIdxInfo_ref.nOrderBy == 2 as ::core::ffi::c_int
            ...
            && (*(*pIdxInfo).aOrderBy.offset(0_isize)).desc as ::core::ffi::c_int
                == 0 as ::core::ffi::c_int
            && (*(*pIdxInfo).aOrderBy.offset(1_isize)).iColumn == 1 as ::core::ffi::c_int
            && (*(*pIdxInfo).aOrderBy.offset(1_isize)).desc as ::core::ffi::c_int
                == 0 as ::core::ffi::c_int
    {
...
unsafe extern "C" fn statOpen(
    ...
    let pCsr: *mut StatCursor = crate::src::src::malloc::sqlite3_malloc64(
    ...
    if pCsr.is_null() {
        ...
        ::libc::memset(
            ...
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<StatCursor>() as crate::__stddef_size_t_h::SizeT,
        );
    ...
    if !__p_ref.aCell.is_null() {
        ...
        while i < __p_ref.nCell {
            crate::src::src::malloc::sqlite3_free(
                (*__p_ref.aCell.offset(i as isize)).aOvfl as *mut ::core::ffi::c_void,
            );
            i += 1;
        }
...
unsafe extern "C" fn statClearPage(p: *mut StatPage) {
    ...
    ::libc::memset(
        ...
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<StatPage>() as crate::__stddef_size_t_h::SizeT,
    );
    __p_ref.aPg = aPg;
}
...
unsafe extern "C" fn statResetCsr(pCsr: *mut StatCursor) {
    ...
    {
        statClearPage(
            (&raw mut __pCsr_ref.aPage as *mut StatPage).offset(i as isize) as *mut StatPage,
        );
        crate::src::src::malloc::sqlite3_free(
            __pCsr_ref.aPage[i as usize].aPg as *mut ::core::ffi::c_void,
        );
        __pCsr_ref.aPage[i as usize].aPg =
...
unsafe extern "C" fn statDecodePage(
    ...
    __p_ref.flags = *aHdr.offset(0_isize);
    ...
    if current_block == 3640593987805443782 {
        ...
        __p_ref.nCell = (*(aHdr.offset(3_isize) as *mut crate::src::ext::rtree::rtree::U8_0)
            .offset(0_isize) as ::core::ffi::c_int)
            << 8 as ::core::ffi::c_int
            | *(aHdr.offset(3_isize) as *mut crate::src::ext::rtree::rtree::U8_0)
        ...
        nUnused = ((*(aHdr.offset(5_isize) as *mut crate::src::ext::rtree::rtree::U8_0)
            .offset(0_isize) as ::core::ffi::c_int)
            << 8 as ::core::ffi::c_int
            | *(aHdr.offset(5_isize) as *mut crate::src::ext::rtree::rtree::U8_0)
                .offset(1_isize) as ::core::ffi::c_int)
            - nHdr
            - 2 as ::core::ffi::c_int * __p_ref.nCell;
        nUnused += *aHdr.offset(7_isize) as ::core::ffi::c_int;
        iOff = (*(aHdr.offset(1_isize) as *mut crate::src::ext::rtree::rtree::U8_0)
            .offset(0_isize) as ::core::ffi::c_int)
            << 8 as ::core::ffi::c_int
            | *(aHdr.offset(1_isize) as *mut crate::src::ext::rtree::rtree::U8_0)
                .offset(1_isize) as ::core::ffi::c_int;
        loop {
            if (iOff == 0) {
            ...
            nUnused += (*(aData.offset((iOff + 2 as ::core::ffi::c_int) as isize)
                as *mut crate::src::ext::rtree::rtree::U8_0)
                .offset(0_isize) as ::core::ffi::c_int)
                << 8 as ::core::ffi::c_int
                | *(aData.offset((iOff + 2 as ::core::ffi::c_int) as isize)
                    as *mut crate::src::ext::rtree::rtree::U8_0)
                    .offset(1_isize) as ::core::ffi::c_int;
            let iNext: ::core::ffi::c_int = (*(aData.offset(iOff as isize) as *mut crate::src::ext::rtree::rtree::U8_0)
                .offset(0_isize) as ::core::ffi::c_int)
                << 8 as ::core::ffi::c_int
            ...
            _ => {
                ...
                __p_ref.iRightChildPg = if isLeaf != 0 {
                    ...
                    crate::src::src::util::sqlite3Get4byte(
                        aHdr.offset(8_isize) as *mut crate::src::ext::rtree::rtree::U8_0
                    )
                };
                if __p_ref.nCell != 0 {
                    let mut i: ::core::ffi::c_int;
                    ...
                    let nUsable: ::core::ffi::c_int = szPage - crate::src::src::btree::sqlite3BtreeGetReserveNoMutex(pBt);
                    ...
                    ::libc::memset(
                        ...
                        0 as ::core::ffi::c_int,
                        ((__p_ref.nCell + 1 as ::core::ffi::c_int)
                            as crate::__stddef_size_t_h::SizeT)
                            .wrapping_mul(::core::mem::size_of::<StatCell>()
                                as crate::__stddef_size_t_h::SizeT),
                    );
                    i = 0 as ::core::ffi::c_int;
                    loop {
                        ...
                        if isLeaf == 0 {
                            (*pCell).iChildPg = crate::src::src::util::sqlite3Get4byte(
                                aData.offset(iOff as isize)
                                    as *mut crate::src::ext::rtree::rtree::U8_0,
                            );
                        ...
                        if (__p_ref.flags as ::core::ffi::c_int != 0x5 as ::core::ffi::c_int) {
                            ...
                            iOff += (if (*aData.offset(iOff as isize) as ::core::ffi::c_int)
                                < 0x80 as ::core::ffi::c_int
                                    ...
                                    as ::core::ffi::c_int
                            {
                                nPayload = *aData.offset(iOff as isize)
                            ...
                            if nPayload
                                > __p_ref.nMxPayload as crate::src::ext::rtree::rtree::U32_0
                            {
                                __p_ref.nMxPayload = nPayload as ::core::ffi::c_int;
                            }
                            let nLocal: ::core::ffi::c_int = getLocalPayload(
                                nUsable,
                                __p_ref.flags,
                            ...
                            if nPayload > nLocal as crate::src::ext::rtree::rtree::U32_0 {
                                ...
                                let nOvfl: ::core::ffi::c_int = nPayload
                                    ...
                                    .wrapping_add(
                                        nUsable as crate::src::ext::rtree::rtree::U32_0,
                                    )
                                ...
                                if iOff + nLocal + 4 as ::core::ffi::c_int > nUsable
                                    || nPayload
                                        > 0x7fffffff as crate::src::ext::rtree::rtree::U32_0
                                {
                                    current_block = 13503832839001051727;
                                    break;
                                }
                                let __pCell_ref = { &mut *pCell };
                                __pCell_ref.nLastOvfl = nPayload
                                    .wrapping_sub(
                                        nLocal as crate::src::ext::rtree::rtree::U32_0,
                                    )
                                    .wrapping_sub(
                                ...
                                *__pCell_ref.aOvfl.offset(0_isize) =
                                    crate::src::src::util::sqlite3Get4byte(
                                        aData.offset((iOff + nLocal) as isize)
                                            as *mut crate::src::ext::rtree::rtree::U8_0,
                                    );
                                ...
                                while j < nOvfl {
                                    ...
                                    let rc: ::core::ffi::c_int = crate::src::src::pager::sqlite3PagerGet(
                                        ...
                                        &raw mut pPg as *mut _
                                            as *mut *mut crate::src::src::pcache::PgHdr,
                                        0 as ::core::ffi::c_int,
                                    );
                                    if rc != crate::src::headers::sqlite3_h::SQLITE_OK {
                                        return rc;
                                    }
                                    *__pCell_ref.aOvfl.offset(j as isize) =
                                        crate::src::src::util::sqlite3Get4byte(
...
unsafe extern "C" fn statSizeAndOffset(pCsr: *mut StatCursor) {
    ...
    x[0 as ::core::ffi::c_int as usize] =
        (*pCsr).iPageno as crate::src::headers::sqlite3_h::Sqlite3Int64;
    ...
    {
        (*pCsr).iOffset =
            x[0 as ::core::ffi::c_int as usize] as crate::src::ext::rtree::rtree::I64_0;
        (*pCsr).szPage +=
            x[1 as ::core::ffi::c_int as usize] as crate::src::headers::sqlite3_h::SqliteInt64;
    } else {
        let __pCsr_ref = { &mut *pCsr };
        __pCsr_ref.szPage += crate::src::src::btree::sqlite3BtreeGetPageSize(pBt)
            as crate::src::ext::rtree::rtree::I64_0;
        __pCsr_ref.iOffset = __pCsr_ref.szPage
            * __pCsr_ref
                .iPageno
                .wrapping_sub(1 as crate::src::ext::rtree::rtree::U32_0)
                as crate::src::ext::rtree::rtree::I64_0;
...
unsafe extern "C" fn statGetPage(
    ...
    if (*pPg).aPg.is_null() {
        ...
        ::libc::memset(
            __pPg_ref.aPg.offset(pgsz as isize) as *mut crate::src::ext::rtree::rtree::U8_0
                as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            DBSTAT_PAGE_PADDING_BYTES as crate::__stddef_size_t_h::SizeT,
        );
    }
    let rc: ::core::ffi::c_int = crate::src::src::pager::sqlite3PagerGet(
        crate::src::src::btree::sqlite3BtreePager(pBt) as *mut crate::src::src::pager::Pager,
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        ...
        ::core::ptr::copy_nonoverlapping(a as *const u8, (*pPg).aPg as *mut u8, pgsz as usize);
        ...
        if __pCsr_ref.iPage < 0 as ::core::ffi::c_int {
            ...
            if rc == crate::src::headers::sqlite3_h::SQLITE_ROW {
                ...
                rc = statGetPage(
                    pBt,
                    iRoot,
                    (&raw mut __pCsr_ref.aPage as *mut StatPage).offset(0_isize)
                        as *mut StatPage,
                );
            ...
            while __p_ref.iCell < __p_ref.nCell {
                ...
                while (*pCell).iOvfl < (*pCell).nOvfl {
                    ...
                    crate::src::src::btmutex::sqlite3BtreeEnter(pBt);
                    let nUsable: ::core::ffi::c_int = crate::src::src::btree::sqlite3BtreeGetPageSize(pBt)
                    ...
                    if __pCell_ref.iOvfl < __pCell_ref.nOvfl - 1 as ::core::ffi::c_int {
                        __pCsr_ref.nPayload += (nUsable - 4 as ::core::ffi::c_int)
                            as crate::src::ext::rtree::rtree::I64_0;
                    } else {
                        __pCsr_ref.nPayload +=
                            __pCell_ref.nLastOvfl as crate::src::ext::rtree::rtree::I64_0;
                        __pCsr_ref.nUnused +=
                            (nUsable - 4 as ::core::ffi::c_int - __pCell_ref.nLastOvfl)
                                as crate::src::ext::rtree::rtree::I64_0;
                    }
                    let iOvfl: ::core::ffi::c_int = __pCell_ref.iOvfl;
                    __pCell_ref.iOvfl += 1;
                    if __pCsr_ref.isAgg == 0 {
                        ...
                        __pCsr_ref.zPagetype = b"overflow\0" as *const u8
            ...
            if __p_ref.iRightChildPg == 0 || __p_ref.iCell > __p_ref.nCell {
                ...
                if __p_ref.iCell == __p_ref.nCell {
                    (*p.offset(1_isize)).iPgno = __p_ref.iRightChildPg;
                } else {
                    (*p.offset(1_isize)).iPgno =
                        (*__p_ref.aCell.offset(__p_ref.iCell as isize)).iChildPg;
                }
                rc = statGetPage(
                    pBt,
                    (*p.offset(1_isize)).iPgno,
                    p.offset(1_isize) as *mut StatPage,
                );
                __pCsr_ref.nPage += 1;
                (*p.offset(1_isize)).iCell = 0 as ::core::ffi::c_int;
                if __pCsr_ref.isAgg == 0 {
                    z = crate::sqlite_printf!("%s%.3x/", __p_ref.zPath, __p_ref.iCell);
                    let fresh0 = &mut (*p.offset(1_isize)).zPath;
                    *fresh0 = z;
                    if z.is_null() {
                        rc = crate::src::headers::sqliteInt_h::SQLITE_NOMEM_BKPT;
                    }
...
unsafe extern "C" fn statFilter(
    ...
    __pCsr_ref.pStmt = ::core::ptr::null_mut::<crate::src::headers::sqlite3_h::Sqlite3Stmt>();
    ...
    if idxNum & 0x2 as ::core::ffi::c_int != 0 {
        let fresh2 = iArg;
        iArg += 1;
        zName = crate::src::src::vdbeapi::sqlite3_value_text(*argv.offset(fresh2 as isize))
            as *const ::core::ffi::c_char;
    }
    ...
    let pSql: *mut crate::src::headers::sqliteInt_h::sqlite3_str = crate::src::src::printf::sqlite3_str_new(
        (*pTab).db as *mut crate::src::headers::sqliteInt_h::sqlite3,
    ...
    if idxNum & 0x8 as ::core::ffi::c_int != 0 {
        sqlite3_str_vappendf2(pSql as *mut sqlite3_str, " ORDER BY name", printf_args!());
    }
    let zSql: *mut ::core::ffi::c_char = crate::src::src::printf::sqlite3_str_finish(
...
unsafe extern "C" fn statColumn(
    ...
    match i {
        ...
        2 => {
            if (*pCsr).isAgg != 0 {
                crate::src::src::vdbeapi::sqlite3_result_int64(
                    ctx,
                    (*pCsr).nPage as crate::src::headers::sqlite3_h::Sqlite3Int64,
                );
            } else {
                crate::src::src::vdbeapi::sqlite3_result_int64(
                    ctx,
        ...
        4 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(
                ctx,
                (*pCsr).nCell as crate::src::headers::sqlite3_h::Sqlite3Int64,
            );
        }
        5 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(
                ctx,
                (*pCsr).nPayload as crate::src::headers::sqlite3_h::Sqlite3Int64,
            );
        }
        6 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(
                ctx,
                (*pCsr).nUnused as crate::src::headers::sqlite3_h::Sqlite3Int64,
            );
        }
        7 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(
                ctx,
                (*pCsr).nMxPayload as crate::src::headers::sqlite3_h::Sqlite3Int64,
            );
        }
        8 => {
            if (*pCsr).isAgg == 0 {
                crate::src::src::vdbeapi::sqlite3_result_int64(
                    ctx,
                    (*pCsr).iOffset as crate::src::headers::sqlite3_h::Sqlite3Int64,
                );
            }
        }
        9 => {
            crate::src::src::vdbeapi::sqlite3_result_int64(
                ctx,
                (*pCsr).szPage as crate::src::headers::sqlite3_h::Sqlite3Int64,
            );
        }
        10 => {
