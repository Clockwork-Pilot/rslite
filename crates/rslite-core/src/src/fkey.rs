...
pub use crate::src::headers::opcodes_h::OP_FkCounter;
pub use crate::src::headers::opcodes_h::OP_FkIfZero;
...
pub use crate::src::src::auth::sqlite3AuthReadCol;
...
pub use crate::src::src::trigger::sqlite3CodeRowTriggerDirect;
...
pub use crate::src::src::vdbe::P5_ConstraintFK;
...
pub unsafe extern "C" fn sqlite3FkLocateIndex(
    ...
    pParent: *mut crate::src::headers::sqliteInt_h::Table,
    pFKey: *mut crate::src::headers::sqliteInt_h::FKey,
    ppIdx: *mut *mut crate::src::headers::sqliteInt_h::Index,
    paiCol: *mut *mut ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut pIdx: *mut crate::src::headers::sqliteInt_h::Index;
    let mut aiCol: *mut ::core::ffi::c_int = ::core::ptr::null_mut::<::core::ffi::c_int>();
    let nCol: ::core::ffi::c_int = (*pFKey).nCol;
    let zKey: *mut ::core::ffi::c_char = (*(&raw mut (*pFKey).aCol
            ...
            if zKey.is_null() {
                    ...
                    == crate::src::headers::sqliteInt_h::SQLITE_IDXTYPE_PRIMARYKEY
                {
                    if !aiCol.is_null() {
                        ...
                        while i < nCol {
                            *aiCol.offset(i as isize) = (*(&raw mut (*pFKey).aCol
                                as *mut crate::src::headers::sqliteInt_h::sColMap)
                                .offset(i as isize))
                            .iFrom;
                            i += 1;
                ...
                while i_0 < nCol {
                    let iCol: crate::src::fts5::I16_0 = *(*pIdx).aiColumn.offset(i_0 as isize);
                    let mut zDfltColl: *const ::core::ffi::c_char;
                    
                    if (iCol as ::core::ffi::c_int) < 0 as ::core::ffi::c_int {
                        break;
                    }
                    zDfltColl = crate::src::src::build::sqlite3ColumnColl(
                        (*pParent).aCol.offset(iCol as isize)
                            as *mut crate::src::headers::sqliteInt_h::Column
                            as *mut crate::src::headers::sqliteInt_h::Column,
                    );
                    if zDfltColl.is_null() {
                        zDfltColl = &raw const crate::src::src::global::sqlite3StrBINARY
                    ...
                    let zIdxCol: *mut ::core::ffi::c_char = (*(*pParent).aCol.offset(iCol as isize)).zCnName;
                    ...
                    while j < nCol {
                        ...
                        {
                            if !aiCol.is_null() {
                                *aiCol.offset(i_0 as isize) = (*(&raw mut (*pFKey).aCol
                                    as *mut crate::src::headers::sqliteInt_h::sColMap)
                                    .offset(j as isize))
                                .iFrom;
                            }
            ...
            crate::src::printf_c_variadic::sqlite3ErrorMsg_args(
                ...
                &[
                    crate::src::src::printf::PrintfArg::Str(
                        (*(*pFKey).pFrom).zName as *mut ::core::ffi::c_char,
                    ),
                    crate::src::src::printf::PrintfArg::Str(
                        (*pFKey).zTo as *mut ::core::ffi::c_char,
                    ),
                ],
            );
        }
...
unsafe extern "C" fn fkLookupParent(
    ...
    pFKey: *mut crate::src::headers::sqliteInt_h::FKey,
    aiCol: *mut ::core::ffi::c_int,
    regData: ::core::ffi::c_int,
    nIncr: ::core::ffi::c_int,
    isIgnore: ::core::ffi::c_int,
) {
    let mut i: ::core::ffi::c_int;
    ...
    let iCur: ::core::ffi::c_int = __pParse_ref.nTab - 1 as ::core::ffi::c_int;
    let iOk: ::core::ffi::c_int = crate::src::src::vdbeaux::sqlite3VdbeMakeLabel(
        pParse as *mut crate::src::headers::sqliteInt_h::Parse,
    );
    ...
    i = 0 as ::core::ffi::c_int;
    while i < (*pFKey).nCol {
        let iReg: ::core::ffi::c_int = crate::src::src::build::sqlite3TableColumnToStorage(
    ...
    if isIgnore == 0 as ::core::ffi::c_int {
        if pIdx.is_null() {
            ...
            let regTemp: ::core::ffi::c_int = crate::src::src::expr::sqlite3GetTempReg(
                pParse as *mut crate::src::headers::sqliteInt_h::Parse,
            );
            crate::src::src::vdbeaux::sqlite3VdbeAddOp2(
                v,
                ...
                crate::src::src::build::sqlite3TableColumnToStorage(
                    (*pFKey).pFrom as *mut crate::src::headers::sqliteInt_h::Table,
                    *aiCol.offset(0_isize) as crate::src::fts5::I16_0,
                ) as ::core::ffi::c_int
                    + 1 as ::core::ffi::c_int
                    + regData,
                regTemp,
            );
            let iMustBeInt: ::core::ffi::c_int = crate::src::src::vdbeaux::sqlite3VdbeAddOp2(
                v,
            ...
            let nCol: ::core::ffi::c_int = (*pFKey).nCol;
            let regTemp_0: ::core::ffi::c_int = crate::src::src::expr::sqlite3GetTempRange(
                pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                nCol,
            );
            crate::src::src::vdbeaux::sqlite3VdbeAddOp3(
...
unsafe extern "C" fn exprTableRegister(
    ...
    pExpr = crate::src::src::expr::sqlite3Expr(
    ...
    if !pExpr.is_null() {
            ...
            && iCol as ::core::ffi::c_int != (*pTab).iPKey as ::core::ffi::c_int
        {
            ...
            pExpr = crate::src::src::expr::sqlite3ExprAddCollateString(
...
unsafe extern "C" fn exprTableColumn(
    ...
    let pExpr: *mut crate::src::headers::sqliteInt_h::Expr = crate::src::src::expr::sqlite3Expr(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
...
unsafe extern "C" fn fkScanChildren(
    ...
    let mut sNameContext: crate::src::headers::sqliteInt_h::NameContext =
    ...
    while i < (*pFKey).nCol {
        ...
        let mut iCol: crate::src::fts5::I16_0;
        ...
        let pLeft: *mut crate::src::headers::sqliteInt_h::Expr = exprTableRegister(pParse, pTab, regData, iCol);
        ...
        let zCol: *const ::core::ffi::c_char = (*(*(*pFKey).pFrom).aCol.offset(iCol as isize)).zCnName;
        let pRight: *mut crate::src::headers::sqliteInt_h::Expr = crate::src::src::expr::sqlite3Expr(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        ...
        pWhere = crate::src::src::expr::sqlite3ExprAnd(
            pParse as *mut crate::src::headers::sqliteInt_h::Parse,
    ...
    if pTab == (*pFKey).pFrom && nIncr > 0 as ::core::ffi::c_int {
        let pNe: *mut crate::src::headers::sqliteInt_h::Expr;
            ...
            == 0 as crate::src::ext::rtree::rtree::U32_0
        {
            ...
            pNe = crate::src::src::expr::sqlite3PExpr(
                pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                crate::src::parse::TK_NE,
                pLeft_0 as *mut crate::src::headers::sqliteInt_h::Expr,
                pRight_0 as *mut crate::src::headers::sqliteInt_h::Expr,
            ) as *mut crate::src::headers::sqliteInt_h::Expr;
        } else {
            let mut pEq_0: *mut crate::src::headers::sqliteInt_h::Expr;
            let mut pAll: *mut crate::src::headers::sqliteInt_h::Expr =
                ::core::ptr::null_mut::<crate::src::headers::sqliteInt_h::Expr>();
            i = 0 as ::core::ffi::c_int;
            while i < (*pIdx).nKeyCol as ::core::ffi::c_int {
                let iCol_0: crate::src::fts5::I16_0 = *(*pIdx).aiColumn.offset(i as isize);
                pLeft_0 = exprTableRegister(pParse, pTab, regData, iCol_0);
                pRight_0 = crate::src::src::expr::sqlite3Expr(
                    db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                    crate::src::parse::TK_ID,
                    (*(*pTab).aCol.offset(iCol_0 as isize)).zCnName,
                ) as *mut crate::src::headers::sqliteInt_h::Expr;
                pEq_0 = crate::src::src::expr::sqlite3PExpr(
                    pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                    crate::src::parse::TK_IS,
                    pLeft_0 as *mut crate::src::headers::sqliteInt_h::Expr,
                    pRight_0 as *mut crate::src::headers::sqliteInt_h::Expr,
                ) as *mut crate::src::headers::sqliteInt_h::Expr;
                pAll = crate::src::src::expr::sqlite3ExprAnd(
                    pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                    pAll as *mut crate::src::headers::sqliteInt_h::Expr,
                    pEq_0 as *mut crate::src::headers::sqliteInt_h::Expr,
                ) as *mut crate::src::headers::sqliteInt_h::Expr;
                i += 1;
            }
            pNe = crate::src::src::expr::sqlite3PExpr(
        ...
        pWhere = crate::src::src::expr::sqlite3ExprAnd(
            pParse as *mut crate::src::headers::sqliteInt_h::Parse,
            pWhere as *mut crate::src::headers::sqliteInt_h::Expr,
            pNe as *mut crate::src::headers::sqliteInt_h::Expr,
        ) as *mut crate::src::headers::sqliteInt_h::Expr;
    }
    sNameContext.pSrcList = pSrc;
    sNameContext.pParse = pParse;
    crate::src::src::resolve::sqlite3ResolveExprNames(
        &raw mut sNameContext as *mut _ as *mut crate::src::headers::sqliteInt_h::NameContext,
        pWhere as *mut crate::src::headers::sqliteInt_h::Expr,
    );
...
pub unsafe extern "C" fn sqlite3FkReferences(
    pTab: *mut crate::src::headers::sqliteInt_h::Table,
) -> *mut crate::src::headers::sqliteInt_h::FKey {
    crate::src::src::hash::sqlite3HashFind(
        &raw mut (*(*pTab).pSchema).fkeyHash as *mut _ as *const crate::src::src::hash::Hash,
        (*pTab).zName,
    ) as *mut crate::src::headers::sqliteInt_h::FKey
}

unsafe extern "C" fn fkTriggerDelete(
    dbMem: *mut crate::src::headers::sqliteInt_h::sqlite3,
    p: *mut crate::src::headers::sqliteInt_h::Trigger,
) {
    if !p.is_null() {
        let pStep: *mut crate::src::headers::sqliteInt_h::TriggerStep = (*p).step_list;
        let __pStep_ref = unsafe { &*pStep };
        crate::src::src::expr::sqlite3ExprDelete(
            dbMem as *mut crate::src::headers::sqliteInt_h::sqlite3,
        ...
        crate::src::src::select::sqlite3SelectDelete(
            dbMem as *mut crate::src::headers::sqliteInt_h::sqlite3,
            __pStep_ref.pSelect as *mut crate::src::headers::sqliteInt_h::Select,
        );
        crate::src::src::expr::sqlite3ExprDelete(
            dbMem as *mut crate::src::headers::sqliteInt_h::sqlite3,
            (*p).pWhen as *mut crate::src::headers::sqliteInt_h::Expr,
        );
        crate::src::src::malloc::sqlite3DbFree(
            dbMem as *mut crate::src::headers::sqliteInt_h::sqlite3,
...
pub unsafe extern "C" fn sqlite3FkClearTriggerCache(
    ...
    let pHash: *mut crate::src::src::hash::Hash =
        &raw mut (*(*(*db).aDb.offset(iDb as isize)).pSchema).tblHash;
    k = (*pHash).first;
    while !k.is_null() {
...
pub unsafe extern "C" fn sqlite3FkDropTable(
        ...
        && (*pTab).eTabType as ::core::ffi::c_int == crate::src::headers::sqliteInt_h::TABTYP_NORM
    {
        ...
        if sqlite3FkReferences(pTab).is_null() {
            let mut p: *mut crate::src::headers::sqliteInt_h::FKey;
            p = (*pTab).u.tab.pFKey;
            while !p.is_null() {
            ...
            iSkip = crate::src::src::vdbeaux::sqlite3VdbeMakeLabel(
                pParse as *mut crate::src::headers::sqliteInt_h::Parse,
            );
            crate::src::src::vdbeaux::sqlite3VdbeAddOp2(
                v,
        ...
        crate::src::src::delete::sqlite3DeleteFrom(
            ...
            crate::src::src::expr::sqlite3SrcListDup(
                db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                pName as *const crate::src::headers::sqliteInt_h::SrcList,
                0 as ::core::ffi::c_int,
...
unsafe extern "C" fn fkChildIsModified(
    pTab: *mut crate::src::headers::sqliteInt_h::Table,
    p: *mut crate::src::headers::sqliteInt_h::FKey,
    aChange: *mut ::core::ffi::c_int,
    bChngRowid: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut i: ::core::ffi::c_int;
    i = 0 as ::core::ffi::c_int;
    while i < (*p).nCol {
        let iChildKey: ::core::ffi::c_int = (*(&raw mut (*p).aCol
            as *mut crate::src::headers::sqliteInt_h::sColMap)
            .offset(i as isize))
        .iFrom;
...
unsafe extern "C" fn fkParentIsModified(
    ...
    i = 0 as ::core::ffi::c_int;
    while i < (*p).nCol {
        let zKey: *mut ::core::ffi::c_char = (*(&raw mut (*p).aCol
            as *mut crate::src::headers::sqliteInt_h::sColMap)
            .offset(i as isize))
        .zCol;
        ...
        while iKey < (*pTab).nCol as ::core::ffi::c_int {
            ...
            {
                let pCol: *mut crate::src::headers::sqliteInt_h::Column =
                    (*pTab).aCol.offset(iKey as isize)
                        as *mut crate::src::headers::sqliteInt_h::Column;
                if !zKey.is_null() {
                    if 0 as ::core::ffi::c_int
                        == crate::src::src::util::sqlite3StrICmp((*pCol).zCnName, zKey)
                    {
                        return 1 as ::core::ffi::c_int;
                    }
...
unsafe extern "C" fn isSetNullAction(
    ...
    let pTop: *mut crate::src::headers::sqliteInt_h::Parse = if !(*pParse).pToplevel.is_null() {
        (*pParse).pToplevel
    } else {
        pParse
    };
    if !(*pTop).pTriggerPrg.is_null() {
        let p: *mut crate::src::headers::sqliteInt_h::Trigger = (*(*pTop).pTriggerPrg).pTrigger;
...
pub unsafe extern "C" fn sqlite3FkCheck(
    ...
    let isIgnoreErrors: ::core::ffi::c_int = (*pParse).disableTriggers as ::core::ffi::c_int;
    if (*db).flags
        & crate::src::headers::sqliteInt_h::SQLITE_ForeignKeys
            as crate::src::ext::rtree::rtree::U64_0
        == 0 as crate::src::ext::rtree::rtree::U64_0
                ...
                || sqlite3FkLocateIndex(pParse, pTo, pFKey, &raw mut pIdx, &raw mut aiFree) != 0
            {
                ...
                if pTo.is_null() {
                    ...
                    while i < __pFKey_ref.nCol {
                        ...
                        let iFromCol: ::core::ffi::c_int = (*(&raw mut __pFKey_ref.aCol
                            as *mut crate::src::headers::sqliteInt_h::sColMap)
                            .offset(i as isize))
                        .iFrom;
                        let iReg: ::core::ffi::c_int = crate::src::src::build::sqlite3TableColumnToStorage(
                            __pFKey_ref.pFrom as *mut crate::src::headers::sqliteInt_h::Table,
                            iFromCol as crate::src::fts5::I16_0,
                        ) as ::core::ffi::c_int
                            + regOld
                            + 1 as ::core::ffi::c_int;
                        crate::src::src::vdbeaux::sqlite3VdbeAddOp2(
                ...
                while i < (*pFKey).nCol {
                    ...
                    if (*db).xAuth.is_some() {
                        ...
                        let zCol: *mut ::core::ffi::c_char = (*(*pTo).aCol.offset(
                            (if !pIdx.is_null() {
                                *(*pIdx).aiColumn.offset(i as isize) as ::core::ffi::c_int
                            } else {
                        ...
                        .zCnName;
                        let rcauth: ::core::ffi::c_int = crate::src::src::auth::sqlite3AuthReadCol(
                            pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                            (*pTo).zName,
                            zCol,
                            iDb,
                        );
                        bIgnore = (rcauth == crate::src::headers::sqlite3_h::SQLITE_IGNORE)
                            as ::core::ffi::c_int;
                    }
                    i += 1;
                }
        ...
        if !(!aChange.is_null()
                ...
                && (*pParse).isMultiWrite == 0)
            {
                if sqlite3FkLocateIndex(pParse, pTab, pFKey, &raw mut pIdx_0, &raw mut aiCol_0) != 0
                {
                    ...
                    if !pSrc.is_null() {
                        ...
                        if regOld != 0 as ::core::ffi::c_int {
                            let mut eAction: ::core::ffi::c_int = (*pFKey).aAction[!aChange.is_null()
                                ...
                                as usize]
                                as ::core::ffi::c_int;
                            if (*db).flags & crate::src::headers::sqliteInt_h::SQLITE_FkNoAction
                                != 0
                            {
                    ...
                    crate::src::src::malloc::sqlite3DbFree(
                        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                        aiCol_0 as *mut ::core::ffi::c_void,
                    );
                }
            }
        pFKey = (*pFKey).pNextTo;
...
pub unsafe extern "C" fn sqlite3FkOldmask(
    pParse: *mut crate::src::headers::sqliteInt_h::Parse,
    pTab: *mut crate::src::headers::sqliteInt_h::Table,
        ...
        while !p.is_null() {
            ...
            while i < (*p).nCol {
                mask = (mask as ::core::ffi::c_uint
                    | (if (*(&raw mut (*p).aCol as *mut crate::src::headers::sqliteInt_h::sColMap)
                        .offset(i as isize))
                    .iFrom
        ...
        if aChange.is_null() {
            ...
            while !p.is_null() {
                if fkChildIsModified(pTab, p, aChange, chngRowid) != 0 {
                    if 0 as ::core::ffi::c_int
                        == crate::src::src::util::sqlite3_stricmp((*pTab).zName, (*p).zTo)
                    {
            ...
            while !p.is_null() {
                if fkParentIsModified(pTab, p, aChange, chngRowid) != 0 {
                    if (*(*pParse).db).flags & crate::src::headers::sqliteInt_h::SQLITE_FkNoAction
                        == 0 as crate::src::ext::rtree::rtree::U64_0
...
unsafe extern "C" fn fkActionTrigger(
    ...
    if action != crate::src::headers::sqliteInt_h::OE_None && pTrigger.is_null() {
        ...
        let mut pStep: *mut crate::src::headers::sqliteInt_h::TriggerStep =
            ::core::ptr::null_mut::<crate::src::headers::sqliteInt_h::TriggerStep>();
        let mut pWhere: *mut crate::src::headers::sqliteInt_h::Expr =
            ::core::ptr::null_mut::<crate::src::headers::sqliteInt_h::Expr>();
        ...
        let mut pSelect: *mut crate::src::headers::sqliteInt_h::Select =
            ::core::ptr::null_mut::<crate::src::headers::sqliteInt_h::Select>();
        let mut i: ::core::ffi::c_int;
        let mut pWhen: *mut crate::src::headers::sqliteInt_h::Expr =
            ::core::ptr::null_mut::<crate::src::headers::sqliteInt_h::Expr>();
        ...
        let __pFKey_ref = unsafe { &mut *pFKey };
        while i < __pFKey_ref.nCol {
            let mut tOld: crate::src::headers::sqliteInt_h::Token =
                crate::src::headers::sqliteInt_h::Token {
                    z: b"old\0" as *const u8 as *const ::core::ffi::c_char,
                    n: 3 as ::core::ffi::c_uint,
                };
            let mut tNew: crate::src::headers::sqliteInt_h::Token =
                crate::src::headers::sqliteInt_h::Token {
                    z: b"new\0" as *const u8 as *const ::core::ffi::c_char,
                    n: 3 as ::core::ffi::c_uint,
                };
            let mut tFromCol: crate::src::headers::sqliteInt_h::Token =
                unsafe { ::core::mem::zeroed() };
            let mut tToCol: crate::src::headers::sqliteInt_h::Token =
                unsafe { ::core::mem::zeroed() };
            
            let mut pEq: *mut crate::src::headers::sqliteInt_h::Expr;
            let iFromCol: ::core::ffi::c_int = if !aiCol.is_null() {
                *aiCol.offset(i as isize)
            } else {
            ...
            pEq = crate::src::src::expr::sqlite3PExpr(
                ...
                crate::src::src::expr::sqlite3PExpr(
                    ...
                    crate::src::src::expr::sqlite3ExprAlloc(
                        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                        crate::src::parse::TK_ID,
                        &raw mut tOld as *mut _ as *const crate::src::headers::sqliteInt_h::Token,
                        0 as ::core::ffi::c_int,
                    ) as *mut crate::src::headers::sqliteInt_h::Expr
                        as *mut crate::src::headers::sqliteInt_h::Expr,
                    crate::src::src::expr::sqlite3ExprAlloc(
                        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                        crate::src::parse::TK_ID,
                        &raw mut tToCol as *mut _ as *const crate::src::headers::sqliteInt_h::Token,
                        0 as ::core::ffi::c_int,
                    ) as *mut crate::src::headers::sqliteInt_h::Expr
                        as *mut crate::src::headers::sqliteInt_h::Expr,
                ) as *mut crate::src::headers::sqliteInt_h::Expr
                ...
                crate::src::src::expr::sqlite3ExprAlloc(
                    db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                    crate::src::parse::TK_ID,
                    &raw mut tFromCol as *mut _ as *const crate::src::headers::sqliteInt_h::Token,
                    0 as ::core::ffi::c_int,
                ) as *mut crate::src::headers::sqliteInt_h::Expr
                    as *mut crate::src::headers::sqliteInt_h::Expr,
            ) as *mut crate::src::headers::sqliteInt_h::Expr;
            ...
            if !pChanges.is_null() {
                ...
                pWhen = crate::src::src::expr::sqlite3ExprAnd(
                    pParse as *mut crate::src::headers::sqliteInt_h::Parse,
            ...
            if action != crate::src::headers::sqliteInt_h::OE_Restrict_1
                && (action != crate::src::headers::sqliteInt_h::OE_Cascade || !pChanges.is_null())
            {
                ...
                if action == crate::src::headers::sqliteInt_h::OE_Cascade {
                    ...
                    let pCol: *mut crate::src::headers::sqliteInt_h::Column =
                        (*__pFKey_ref.pFrom).aCol.offset(iFromCol as isize);
        ...
        let zFrom: *const ::core::ffi::c_char = (*__pFKey_ref.pFrom).zName;
        let nFrom: ::core::ffi::c_int = crate::src::src::util::sqlite3Strlen30(zFrom);
        ...
        if action == crate::src::headers::sqliteInt_h::OE_Restrict_1 {
            ...
            let mut pRaise: *mut crate::src::headers::sqliteInt_h::Expr;
            ...
            pRaise = crate::src::src::expr::sqlite3PExpr(
                pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                crate::src::parse::TK_RAISE,
                pRaise as *mut crate::src::headers::sqliteInt_h::Expr,
                ::core::ptr::null_mut::<crate::src::headers::sqliteInt_h::Expr>()
                    as *mut crate::src::headers::sqliteInt_h::Expr,
            ) as *mut crate::src::headers::sqliteInt_h::Expr;
            if !pRaise.is_null() {
                (*pRaise).affExpr =
                    crate::src::headers::sqliteInt_h::OE_Abort as ::core::ffi::c_char;
            }
            let pSrc: *mut crate::src::headers::sqliteInt_h::SrcList = crate::src::src::build::sqlite3SrcListAppend(
                pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                ::core::ptr::null_mut::<crate::src::headers::sqliteInt_h::SrcList>()
                    as *mut crate::src::headers::sqliteInt_h::SrcList,
                ::core::ptr::null_mut::<crate::src::headers::sqliteInt_h::Token>()
            ...
            if !pSrc.is_null() {
                let fresh1 = &mut (*(&raw mut (*pSrc).a
                    as *mut crate::src::headers::sqliteInt_h::SrcItem)
                    .offset(0_isize))
                .zName;
                *fresh1 = crate::src::src::malloc::sqlite3DbStrDup(
                    db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                    zFrom,
                );
                let fresh2 = &mut (*(&raw mut (*pSrc).a
                    as *mut crate::src::headers::sqliteInt_h::SrcItem)
                    .offset(0_isize))
                .u4
                .zDatabase;
                *fresh2 = crate::src::src::malloc::sqlite3DbStrDup(
                    db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        ...
        if !pTrigger.is_null() {
            (*pTrigger).step_list = pTrigger.offset(1_isize)
                as *mut crate::src::headers::sqliteInt_h::Trigger
                as *mut crate::src::headers::sqliteInt_h::TriggerStep;
            pStep = (*pTrigger).step_list;
            (*pStep).zTarget = pStep.offset(1_isize)
                as *mut crate::src::headers::sqliteInt_h::TriggerStep
            ...
            (*pStep).pWhere = crate::src::src::expr::sqlite3ExprDup(
                db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                pWhere as *const crate::src::headers::sqliteInt_h::Expr,
                crate::src::headers::sqliteInt_h::EXPRDUP_REDUCE,
            ) as *mut crate::src::headers::sqliteInt_h::Expr;
            (*pStep).pExprList = crate::src::src::expr::sqlite3ExprListDup(
                db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                pList as *const crate::src::headers::sqliteInt_h::ExprList,
                crate::src::headers::sqliteInt_h::EXPRDUP_REDUCE,
            ) as *mut crate::src::headers::sqliteInt_h::ExprList;
            (*pStep).pSelect = crate::src::src::expr::sqlite3SelectDup(
                db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                pSelect as *const crate::src::headers::sqliteInt_h::Select,
                crate::src::headers::sqliteInt_h::EXPRDUP_REDUCE,
            ) as *mut crate::src::headers::sqliteInt_h::Select;
            if !pWhen.is_null() {
                pWhen = crate::src::src::expr::sqlite3PExpr(
                    pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                    crate::src::parse::TK_NOT,
                    pWhen as *mut crate::src::headers::sqliteInt_h::Expr,
                    ::core::ptr::null_mut::<crate::src::headers::sqliteInt_h::Expr>()
                ...
                (*pTrigger).pWhen = crate::src::src::expr::sqlite3ExprDup(
                    db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        ...
        != 0
    {
        ...
        while !pFKey.is_null() {
            if aChange.is_null() || fkParentIsModified(pTab, pFKey, aChange, bChngRowid) != 0 {
                let pAct: *mut crate::src::headers::sqliteInt_h::Trigger =
                    fkActionTrigger(pParse, pTab, pFKey, pChanges);
                if !pAct.is_null() {
...
pub unsafe extern "C" fn sqlite3FkDelete(
    db: *mut crate::src::headers::sqliteInt_h::sqlite3,
    pTab: *mut crate::src::headers::sqliteInt_h::Table,
) {
    let mut pFKey: *mut crate::src::headers::sqliteInt_h::FKey;
    let mut pNext: *mut crate::src::headers::sqliteInt_h::FKey;
    pFKey = (*pTab).u.tab.pFKey;
    while !pFKey.is_null() {
        if (*db).pnBytesFreed.is_null() {
            if !(*pFKey).pPrevTo.is_null() {
                ...
                let z: *const ::core::ffi::c_char = if !(*pFKey).pNextTo.is_null() {
                    (*(*pFKey).pNextTo).zTo
                } else {
                    (*pFKey).zTo
                };
                crate::src::src::hash::sqlite3HashInsert(
                    &raw mut (*(*pTab).pSchema).fkeyHash as *mut _
