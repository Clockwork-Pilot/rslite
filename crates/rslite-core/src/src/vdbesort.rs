...
pub use crate::src::headers::sqlite3_h::SQLITE_FCNTL_CHUNK_SIZE_1;
...
pub use crate::src::headers::sqlite3_h::SQLITE_IOERR_ACCESS_1;
...
pub use crate::src::src::threads::SQLiteThread;
pub use crate::src::src::threads::sqlite3ThreadCreate;
pub use crate::src::src::threads::sqlite3ThreadJoin;
...
pub struct VdbeSorter {
    ...
    pub bUsePMA: crate::src::ext::rtree::rtree::U8_0,
    pub bUseThreads: crate::src::ext::rtree::rtree::U8_0,
    pub iPrev: crate::src::ext::rtree::rtree::U8_0,
    pub nTask: crate::src::ext::rtree::rtree::U8_0,
    pub typeMask: crate::src::ext::rtree::rtree::U8_0,
    pub aTask: [SortSubtask; 0],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct SortSubtask {
    pub pThread: *mut crate::src::src::threads::SQLiteThread,
...
pub struct SorterList {
    ...
    pub aMemory: *mut crate::src::ext::rtree::rtree::U8_0,
    pub szPMA: crate::src::ext::rtree::rtree::I64_0,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct PmaReader {
    pub iReadOff: crate::src::ext::rtree::rtree::I64_0,
    pub iEof: crate::src::ext::rtree::rtree::I64_0,
    ...
    pub aMap: *mut crate::src::ext::rtree::rtree::U8_0,
...
pub struct IncrMerger {
    pub pTask: *mut SortSubtask,
    pub pMerger: *mut MergeEngine,
    pub iStartOff: crate::src::ext::rtree::rtree::I64_0,
...
unsafe extern "C" fn vdbePmaReaderClear(pReadr: *mut PmaReader) {
    ...
    vdbeIncrFree(__pReadr_ref.pIncr);
    ::libc::memset(
        pReadr as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<PmaReader>() as crate::__stddef_size_t_h::SizeT,
    );
}
...
unsafe extern "C" fn vdbePmaReadBlob(
    ...
    let iBuf: ::core::ffi::c_int = (__p_ref.iReadOff % __p_ref.nBuffer as crate::src::ext::rtree::rtree::I64_0)
        as ::core::ffi::c_int;
    if iBuf == 0 as ::core::ffi::c_int {
        ...
        if __p_ref.iEof - __p_ref.iReadOff > __p_ref.nBuffer as crate::src::ext::rtree::rtree::I64_0
        {
            ...
            nRead = (__p_ref.iEof - __p_ref.iReadOff) as ::core::ffi::c_int;
        }
    ...
    let nAvail: ::core::ffi::c_int = __p_ref.nBuffer - iBuf;
    if nByte <= nAvail {
        *ppOut = __p_ref.aBuffer.offset(iBuf as isize) as *mut crate::src::ext::rtree::rtree::U8_0;
        ...
        if __p_ref.nAlloc < nByte {
            ...
            let mut nNew: crate::src::headers::sqlite3_h::Sqlite3Int64 = if 128
                ...
                > 2 as crate::src::headers::sqlite3_h::Sqlite3Int64
                    * __p_ref.nAlloc as crate::src::headers::sqlite3_h::Sqlite3Int64
            {
                128 as crate::src::headers::sqlite3_h::Sqlite3Int64
            } else {
                2 as crate::src::headers::sqlite3_h::Sqlite3Int64
                    * __p_ref.nAlloc as crate::src::headers::sqlite3_h::Sqlite3Int64
            };
            while nByte as crate::src::headers::sqlite3_h::Sqlite3Int64 > nNew {
                nNew *= 2 as crate::src::headers::sqlite3_h::Sqlite3Int64;
            }
            let aNew: *mut crate::src::ext::rtree::rtree::U8_0 = crate::src::src::malloc::sqlite3Realloc(
        ...
        ::core::ptr::copy_nonoverlapping(
            __p_ref.aBuffer.offset(iBuf as isize) as *mut crate::src::ext::rtree::rtree::U8_0
                as *const u8,
        ...
        while nRem > 0 as ::core::ffi::c_int {
            ...
            nCopy = nRem;
            if nRem > __p_ref.nBuffer {
                nCopy = __p_ref.nBuffer;
            }
            let rc_0: ::core::ffi::c_int = vdbePmaReadBlob(p, nCopy, &raw mut aNext);
            if rc_0 != crate::src::headers::sqlite3_h::SQLITE_OK {
                return rc_0;
            }
            ::core::ptr::copy_nonoverlapping(
                aNext as *const u8,
                __p_ref.aAlloc.offset((nByte - nRem) as isize)
...
unsafe extern "C" fn vdbePmaReadVarint(
    ...
    if !(*p).aMap.is_null() {
        ...
        __p_ref.iReadOff += crate::src::src::util::sqlite3GetVarint(
            __p_ref.aMap.offset(__p_ref.iReadOff as isize)
                as *mut crate::src::ext::rtree::rtree::U8_0,
            pnOut,
        ...
        iBuf = (__p_ref.iReadOff % __p_ref.nBuffer as crate::src::ext::rtree::rtree::I64_0)
            as ::core::ffi::c_int;
        if iBuf != 0 && __p_ref.nBuffer - iBuf >= 9 as ::core::ffi::c_int {
            __p_ref.iReadOff += crate::src::src::util::sqlite3GetVarint(
                __p_ref.aBuffer.offset(iBuf as isize) as *mut crate::src::ext::rtree::rtree::U8_0,
                pnOut,
            ) as crate::src::ext::rtree::rtree::I64_0;
        } else {
            let mut aVarint: [crate::src::ext::rtree::rtree::U8_0; 16] = [0; 16];
            ...
            loop {
                ...
                let fresh0 = i;
                i += 1;
                aVarint[(fresh0 & 0xf as ::core::ffi::c_int) as usize] = *a.offset(0_isize);
                if (*a.offset(0_isize) as ::core::ffi::c_int & 0x80 as ::core::ffi::c_int == 0 as ::core::ffi::c_int)
                {
                    break;
                }
            }
            crate::src::src::util::sqlite3GetVarint(
                &raw mut aVarint as *mut crate::src::ext::rtree::rtree::U8_0,
                pnOut,
            );
        }
    }
...
unsafe extern "C" fn vdbePmaReaderSeek(
    ...
    if !__pReadr_ref.aMap.is_null() {
        ...
        __pReadr_ref.aMap = ::core::ptr::null_mut::<crate::src::ext::rtree::rtree::U8_0>();
    }
    __pReadr_ref.iReadOff = iOff;
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK && __pReadr_ref.aMap.is_null() {
        ...
        if __pReadr_ref.aBuffer.is_null() {
            __pReadr_ref.aBuffer = crate::src::src::malloc::sqlite3Malloc(
                pgsz as crate::src::ext::rtree::rtree::U64_0,
            ) as *mut crate::src::ext::rtree::rtree::U8_0;
            if __pReadr_ref.aBuffer.is_null() {
        ...
        if rc == crate::src::headers::sqlite3_h::SQLITE_OK && iBuf != 0 {
            ...
            if __pReadr_ref.iReadOff + nRead as crate::src::ext::rtree::rtree::I64_0
                > __pReadr_ref.iEof
            {
            ...
            rc = crate::src::src::os::sqlite3OsRead(
                __pReadr_ref.pFd as *mut crate::src::headers::sqlite3_h::sqlite3_file,
                __pReadr_ref.aBuffer.offset(iBuf as isize)
                    as *mut crate::src::ext::rtree::rtree::U8_0
...
unsafe extern "C" fn vdbePmaReaderNext(pReadr: *mut PmaReader) -> ::core::ffi::c_int {
    ...
    if (*pReadr).iReadOff >= (*pReadr).iEof {
        ...
        if !pIncr.is_null() {
            ...
            if rc == crate::src::headers::sqlite3_h::SQLITE_OK
                && (*pIncr).bEof == 0 as ::core::ffi::c_int
            {
                let __pIncr_ref = unsafe { &mut *pIncr };
                rc = vdbePmaReaderSeek(
                    __pIncr_ref.pTask,
                    pReadr,
                    (&raw mut __pIncr_ref.aFile as *mut SorterFile).offset(0_isize)
                        as *mut SorterFile,
                    __pIncr_ref.iStartOff,
                );
...
unsafe extern "C" fn vdbePmaReaderInit(
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        ...
        (*pReadr).iEof = ((*pReadr).iReadOff as crate::src::ext::rtree::rtree::U64_0)
            .wrapping_add(nByte) as crate::src::ext::rtree::rtree::I64_0;
        *pnByte = (*pnByte as crate::src::ext::rtree::rtree::U64_0).wrapping_add(nByte)
            as crate::src::ext::rtree::rtree::I64_0
            as crate::src::ext::rtree::rtree::I64_0;
    }
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
...
unsafe extern "C" fn vdbeSorterCompareTail(
    ...
    if *pbKey2Cached == 0 as ::core::ffi::c_int {
        crate::src::src::vdbeaux::sqlite3VdbeRecordUnpack(
            nKey2,
            pKey2,
            r2 as *mut crate::src::headers::sqliteInt_h::UnpackedRecord,
        );
        *pbKey2Cached = 1 as ::core::ffi::c_int;
    }
    crate::src::src::vdbeaux::sqlite3VdbeRecordCompareWithSkip(
        nKey1,
        pKey1,
        r2 as *mut crate::src::headers::sqliteInt_h::UnpackedRecord,
        1 as ::core::ffi::c_int,
...
unsafe extern "C" fn vdbeSorterCompare(
    ...
    crate::src::src::vdbeaux::sqlite3VdbeRecordCompare(
        nKey1,
        pKey1,
        r2 as *mut crate::src::headers::sqliteInt_h::UnpackedRecord,
    )
...
unsafe extern "C" fn vdbeSorterCompareText(
    ...
    let p2: *const crate::src::ext::rtree::rtree::U8_0 =
        pKey2 as *const crate::src::ext::rtree::rtree::U8_0;
    let v1: *const crate::src::ext::rtree::rtree::U8_0 =
        p1.offset(*p1.offset(0_isize) as isize) as *const crate::src::ext::rtree::rtree::U8_0;
    let v2: *const crate::src::ext::rtree::rtree::U8_0 =
        p2.offset(*p2.offset(0_isize) as isize) as *const crate::src::ext::rtree::rtree::U8_0;
    let mut n1: ::core::ffi::c_int;
    let mut n2: ::core::ffi::c_int;
    let mut res: ::core::ffi::c_int;
    n1 = *p1.offset(1_isize) as crate::src::ext::rtree::rtree::U32_0 as ::core::ffi::c_int;
    if n1 >= 0x80 as ::core::ffi::c_int {
        crate::src::src::util::sqlite3GetVarint32(
            p1.offset(1_isize) as *const ::core::ffi::c_uchar,
            &raw mut n1 as *mut crate::src::ext::rtree::rtree::U32_0,
        );
    }
    n2 = *p2.offset(1_isize) as crate::src::ext::rtree::rtree::U32_0 as ::core::ffi::c_int;
    if n2 >= 0x80 as ::core::ffi::c_int {
        crate::src::src::util::sqlite3GetVarint32(
            p2.offset(1_isize) as *const ::core::ffi::c_uchar,
            &raw mut n2 as *mut crate::src::ext::rtree::rtree::U32_0,
        );
    }
    res = ::libc::memcmp(
...
unsafe extern "C" fn vdbeSorterCompareInt(
    ...
    let p2: *const crate::src::ext::rtree::rtree::U8_0 =
        pKey2 as *const crate::src::ext::rtree::rtree::U8_0;
    let s1: ::core::ffi::c_int = *p1.offset(1_isize) as ::core::ffi::c_int;
    let s2: ::core::ffi::c_int = *p2.offset(1_isize) as ::core::ffi::c_int;
    let v1: *const crate::src::ext::rtree::rtree::U8_0 =
        p1.offset(*p1.offset(0_isize) as isize) as *const crate::src::ext::rtree::rtree::U8_0;
    let v2: *const crate::src::ext::rtree::rtree::U8_0 =
        p2.offset(*p2.offset(0_isize) as isize) as *const crate::src::ext::rtree::rtree::U8_0;
    ...
    if s1 == s2 {
        ...
        while i < n as ::core::ffi::c_int {
            ...
            if res != 0 as ::core::ffi::c_int {
                if (*v1.offset(0_isize) as ::core::ffi::c_int
                    ^ *v2.offset(0_isize) as ::core::ffi::c_int)
                    & 0x80 as ::core::ffi::c_int
                    != 0 as ::core::ffi::c_int
                {
                    res = if *v1.offset(0_isize) as ::core::ffi::c_int
                        & 0x80 as ::core::ffi::c_int
                        != 0
                    {
                        -(1 as ::core::ffi::c_int)
...
pub unsafe extern "C" fn sqlite3VdbeSorterInit(
            ...
            == 0 as ::core::ffi::c_int
    {
        ...
        nWorker =
            (*db).aLimit[crate::src::headers::sqlite3_h::SQLITE_LIMIT_WORKER_THREADS as usize];
    }
    let szKeyInfo: ::core::ffi::c_int = 32_usize.wrapping_add(((*(*pCsr).pKeyInfo).nAllField as usize).wrapping_mul(
        ::core::mem::size_of::<*mut crate::src::headers::sqliteInt_h::CollSeq>() as usize,
    )) as ::core::ffi::c_int;
    let sz: crate::src::ext::rtree::rtree::I64_0 = 96_usize.wrapping_add(
        ((nWorker + 1 as ::core::ffi::c_int) as usize)
            .wrapping_mul(::core::mem::size_of::<SortSubtask>() as usize),
    ) as crate::src::ext::rtree::rtree::I64_0;
    let pSorter: *mut VdbeSorter = crate::src::src::malloc::sqlite3DbMallocZero(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        (sz + szKeyInfo as crate::src::ext::rtree::rtree::I64_0)
    ...
    if pSorter.is_null() {
        ...
        pgsz = crate::src::src::btree::sqlite3BtreeGetPageSize(pBt);
        __pSorter_ref.pgsz = pgsz;
        crate::src::src::btmutex::sqlite3BtreeLeave(pBt);
        __pSorter_ref.nTask =
            (nWorker + 1 as ::core::ffi::c_int) as crate::src::ext::rtree::rtree::U8_0;
        __pSorter_ref.iPrev =
            (nWorker - 1 as ::core::ffi::c_int) as crate::src::ext::rtree::rtree::U8_0;
        __pSorter_ref.bUseThreads = (__pSorter_ref.nTask as ::core::ffi::c_int
        ...
        ) == 0
        {
            ...
            __pSorter_ref.mnPmaSize = szPma
                ...
                as ::core::ffi::c_int;
            mxCache = (*(*(*db).aDb.offset(0_isize)).pSchema).cache_size
                as crate::src::ext::rtree::rtree::I64_0;
            ...
            __pSorter_ref.mxPmaSize = if __pSorter_ref.mnPmaSize > mxCache as ::core::ffi::c_int {
                __pSorter_ref.mnPmaSize
            } else {
                mxCache as ::core::ffi::c_int
            };
            if crate::src::src::global::sqlite3Config.bSmallMalloc as ::core::ffi::c_int
                == 0 as ::core::ffi::c_int
            {
                __pSorter_ref.nMemory = pgsz;
                __pSorter_ref.list.aMemory = crate::src::src::malloc::sqlite3Malloc(
                    pgsz as crate::src::ext::rtree::rtree::U64_0,
                )
                    as *mut crate::src::ext::rtree::rtree::U8_0;
        ...
        if ((*pKeyInfo).nAllField as ::core::ffi::c_int) < 13 as ::core::ffi::c_int
            ...
            .is_null()
                || *(&raw mut (*pKeyInfo).aColl
                    ...
                    .offset(0_isize)
                    == (*db).pDfltColl)
            && *(*pKeyInfo).aSortFlags.offset(0_isize) as ::core::ffi::c_int
                & crate::src::headers::sqliteInt_h::KEYINFO_ORDER_BIGNULL
                == 0 as ::core::ffi::c_int
        {
            __pSorter_ref.typeMask =
                (SORTER_TYPE_INTEGER | SORTER_TYPE_TEXT) as crate::src::ext::rtree::rtree::U8_0;
        }
    }
    rc
}
...
unsafe extern "C" fn vdbeSortSubtaskCleanup(
    ...
    crate::src::src::malloc::sqlite3DbFree(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        __pTask_ref.pUnpacked as *mut ::core::ffi::c_void,
    );
    if !__pTask_ref.list.aMemory.is_null() {
        ...
        vdbeSorterRecordFree(
            ...
            __pTask_ref.list.pList,
        );
    }
    if !__pTask_ref.file.pFd.is_null() {
        crate::src::src::os::sqlite3OsCloseFree(
            __pTask_ref.file.pFd as *mut crate::src::headers::sqlite3_h::sqlite3_file,
        );
    }
    if !__pTask_ref.file2.pFd.is_null() {
        crate::src::src::os::sqlite3OsCloseFree(
            __pTask_ref.file2.pFd as *mut crate::src::headers::sqlite3_h::sqlite3_file,
        );
    }
    ::libc::memset(
        pTask as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<SortSubtask>() as crate::__stddef_size_t_h::SizeT,
    );
}
...
unsafe extern "C" fn vdbeSorterJoinThread(pTask: *mut SortSubtask) -> ::core::ffi::c_int {
    ...
    if !(*pTask).pThread.is_null() {
        let mut pRet: *mut ::core::ffi::c_void = 1 as ::core::ffi::c_int
            ...
            as *mut ::core::ffi::c_void;
        let __pTask_ref = unsafe { &mut *pTask };
        crate::src::src::threads::sqlite3ThreadJoin(__pTask_ref.pThread, &raw mut pRet);
        rc = pRet as crate::src::headers::stdlib::IntptrT as ::core::ffi::c_int;
...
unsafe extern "C" fn vdbeMergeEngineNew(nReader: ::core::ffi::c_int) -> *mut MergeEngine {
    ...
    let nByte: crate::src::ext::rtree::rtree::I64_0 = (::core::mem::size_of::<MergeEngine>() as usize).wrapping_add(
        (N as usize).wrapping_mul(
            (::core::mem::size_of::<::core::ffi::c_int>() as usize)
                .wrapping_add(::core::mem::size_of::<PmaReader>() as usize),
        ),
    ) as crate::src::ext::rtree::rtree::I64_0;
    let pNew: *mut MergeEngine = if crate::src::src::util::sqlite3FaultSim(100 as ::core::ffi::c_int) != 0 {
        ::core::ptr::null_mut::<MergeEngine>()
    } else {
        crate::src::src::malloc::sqlite3MallocZero(nByte as crate::src::ext::rtree::rtree::U64_0)
            as *mut MergeEngine
    };
    if !pNew.is_null() {
        let __pNew_ref = unsafe { &mut *pNew };
        __pNew_ref.nTree = N;
        __pNew_ref.pTask = ::core::ptr::null_mut::<SortSubtask>();
        __pNew_ref.aReadr = pNew.offset(1_isize) as *mut MergeEngine as *mut PmaReader;
        __pNew_ref.aTree =
...
unsafe extern "C" fn vdbeIncrFree(pIncr: *mut IncrMerger) {
    if !pIncr.is_null() {
        if (*pIncr).bUseThread != 0 {
            let __pIncr_ref = unsafe { &mut *pIncr };
            vdbeSorterJoinThread(__pIncr_ref.pTask);
            if !__pIncr_ref.aFile[0 as ::core::ffi::c_int as usize]
                .pFd
                .is_null()
            {
                crate::src::src::os::sqlite3OsCloseFree(
                    __pIncr_ref.aFile[0 as ::core::ffi::c_int as usize].pFd
            ...
            {
                crate::src::src::os::sqlite3OsCloseFree(
                    __pIncr_ref.aFile[1 as ::core::ffi::c_int as usize].pFd
                        as *mut crate::src::headers::sqlite3_h::sqlite3_file,
                );
            }
        }
...
pub unsafe extern "C" fn sqlite3VdbeSorterReset(
    ...
    if !__pSorter_ref.pReader.is_null() {
        ...
        crate::src::src::malloc::sqlite3DbFree(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            __pSorter_ref.pReader as *mut ::core::ffi::c_void,
        );
    ...
    crate::src::src::malloc::sqlite3DbFree(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        __pSorter_ref.pUnpacked as *mut ::core::ffi::c_void,
    );
    __pSorter_ref.pUnpacked =
...
pub unsafe extern "C" fn sqlite3VdbeSorterClose(
    ...
    let pSorter: *mut VdbeSorter = (*pCsr).uc.pSorter;
    if !pSorter.is_null() {
        ...
        crate::src::src::malloc::sqlite3DbFree(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
            pSorter as *mut ::core::ffi::c_void,
        );
...
unsafe extern "C" fn vdbeSorterExtendFile(
        ...
        && (*(*pFd).pMethods).iVersion >= 3 as ::core::ffi::c_int
    {
        ...
        crate::src::src::os::sqlite3OsFetch(
            pFd as *mut crate::src::headers::sqlite3_h::sqlite3_file,
            0 as crate::src::ext::rtree::rtree::I64_0,
...
unsafe extern "C" fn vdbeSorterOpenTempFile(
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        let mut max: crate::src::ext::rtree::rtree::I64_0 =
...
unsafe extern "C" fn vdbeSortAllocUnpacked(pTask: *mut SortSubtask) -> ::core::ffi::c_int {
    if (*pTask).pUnpacked.is_null() {
        ...
        __pTask_ref.pUnpacked = crate::src::src::vdbeaux::sqlite3VdbeAllocUnpackedRecord(
            (*__pTask_ref.pSorter).pKeyInfo as *mut crate::src::headers::sqliteInt_h::KeyInfo,
...
unsafe extern "C" fn vdbeSorterMerge(
    ...
    loop {
        ...
        let res: ::core::ffi::c_int = (*pTask).xCompare.expect("non-null function pointer")(
            pTask,
            &raw mut bCached,
            p1.offset(1_isize) as *mut ::core::ffi::c_void,
            (*p1).nVal,
            p2.offset(1_isize) as *mut ::core::ffi::c_void,
            (*p2).nVal,
        );
        if res <= 0 as ::core::ffi::c_int {
            *pp = p1;
...
unsafe extern "C" fn vdbeSorterSort(
    ...
    let rc: ::core::ffi::c_int = vdbeSortAllocUnpacked(pTask);
    if rc != crate::src::headers::sqlite3_h::SQLITE_OK {
        return rc;
    }
    p = (*pList).pList;
    ...
    while !p.is_null() {
        ...
        if !(*pList).aMemory.is_null() {
            if p as *mut crate::src::ext::rtree::rtree::U8_0 == (*pList).aMemory {
                ...
                pNext = (*pList).aMemory.offset((*p).u.iNext as isize)
                    as *mut crate::src::ext::rtree::rtree::U8_0
                    as *mut SorterRecord;
            }
        } else {
...
unsafe extern "C" fn vdbePmaWriterInit(
    ...
    ::libc::memset(
        p as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<PmaWriter>() as crate::__stddef_size_t_h::SizeT,
    );
    (*p).aBuffer =
        crate::src::src::malloc::sqlite3Malloc(nBuf as crate::src::ext::rtree::rtree::U64_0)
            as *mut crate::src::ext::rtree::rtree::U8_0;
    if (*p).aBuffer.is_null() {
        ...
        let __p_ref = unsafe { &mut *p };
        __p_ref.iBufStart =
            (iStart % nBuf as crate::src::ext::rtree::rtree::I64_0) as ::core::ffi::c_int;
        __p_ref.iBufEnd = __p_ref.iBufStart;
        __p_ref.iWriteOff = iStart - __p_ref.iBufStart as crate::src::ext::rtree::rtree::I64_0;
        __p_ref.nBuffer = nBuf;
        __p_ref.pFd = pFd;
    };
}
...
unsafe extern "C" fn vdbePmaWriteBlob(
    ...
    while nRem > 0 as ::core::ffi::c_int && (*p).eFWErr == 0 as ::core::ffi::c_int {
        ...
        ::core::ptr::copy_nonoverlapping(
            pData.offset((nData - nRem) as isize) as *mut crate::src::ext::rtree::rtree::U8_0
                as *const u8,
            __p_ref.aBuffer.offset(__p_ref.iBufEnd as isize)
                as *mut crate::src::ext::rtree::rtree::U8_0 as *mut u8,
            nCopy as usize,
        );
        ...
        if __p_ref.iBufEnd == __p_ref.nBuffer {
            __p_ref.eFWErr = crate::src::src::os::sqlite3OsWrite(
                __p_ref.pFd as *mut crate::src::headers::sqlite3_h::sqlite3_file,
                __p_ref.aBuffer.offset(__p_ref.iBufStart as isize)
                    as *mut crate::src::ext::rtree::rtree::U8_0
                    as *const ::core::ffi::c_void,
                __p_ref.iBufEnd - __p_ref.iBufStart,
                __p_ref.iWriteOff + __p_ref.iBufStart as crate::src::ext::rtree::rtree::I64_0,
            );
            __p_ref.nPmaSpill = (*p).nPmaSpill.wrapping_add(
                (__p_ref.iBufEnd - __p_ref.iBufStart) as crate::src::ext::rtree::rtree::U64_0,
            );
            __p_ref.iBufEnd = 0 as ::core::ffi::c_int;
            __p_ref.iBufStart = __p_ref.iBufEnd;
            __p_ref.iWriteOff += __p_ref.nBuffer as crate::src::ext::rtree::rtree::I64_0;
        }
        nRem -= nCopy;
    }
}
...
unsafe extern "C" fn vdbePmaWriterFinish(
    ...
    *piEof = __p_ref.iWriteOff + __p_ref.iBufEnd as crate::src::ext::rtree::rtree::I64_0;
    *pnSpill = (*pnSpill).wrapping_add(__p_ref.nPmaSpill);
    crate::src::src::malloc::sqlite3_free(__p_ref.aBuffer as *mut ::core::ffi::c_void);
    let rc: ::core::ffi::c_int = __p_ref.eFWErr;
    ::libc::memset(
        p as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<PmaWriter>() as crate::__stddef_size_t_h::SizeT,
...
unsafe extern "C" fn vdbePmaWriteVarint(
    ...
    let nByte: ::core::ffi::c_int = crate::src::src::util::sqlite3PutVarint(&raw mut aByte as *mut ::core::ffi::c_uchar, iVal);
    vdbePmaWriteBlob(
        p,
        &raw mut aByte as *mut crate::src::ext::rtree::rtree::U8_0,
        nByte,
    );
}
...
unsafe extern "C" fn vdbeSorterListToPMA(
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        ...
        vdbePmaWriterInit(
            ...
            &raw mut writer,
            (*__pTask_ref.pSorter).pgsz,
            __pTask_ref.file.iEof,
        );
        __pTask_ref.nPMA += 1;
        let __pList_ref = unsafe { &mut *pList };
        vdbePmaWriteVarint(
            &raw mut writer,
            __pList_ref.szPMA as crate::src::ext::rtree::rtree::U64_0,
        );
        p = __pList_ref.pList;
        while !p.is_null() {
            pNext = (*p).u.pNext;
            vdbePmaWriteVarint(
                &raw mut writer,
                (*p).nVal as crate::src::ext::rtree::rtree::U64_0,
            );
            vdbePmaWriteBlob(
                &raw mut writer,
                p.offset(1_isize) as *mut ::core::ffi::c_void
                    as *mut crate::src::ext::rtree::rtree::U8_0,
                (*p).nVal,
            );
            if __pList_ref.aMemory.is_null() {
...
unsafe extern "C" fn vdbeMergeEngineStep(
    ...
    let iPrev: ::core::ffi::c_int = *__pMerger_ref.aTree.offset(1_isize);
    let pTask: *mut SortSubtask = __pMerger_ref.pTask;
    let rc: ::core::ffi::c_int = vdbePmaReaderNext(__pMerger_ref.aReadr.offset(iPrev as isize) as *mut PmaReader);
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        let mut i: ::core::ffi::c_int;
        ...
        while i > 0 as ::core::ffi::c_int {
            ...
            {
                *__pMerger_ref.aTree.offset(i as isize) = pReadr1.offset_from(__pMerger_ref.aReadr)
                    as ::core::ffi::c_long
                    as ::core::ffi::c_int;
                pReadr2 = __pMerger_ref.aReadr.offset(
                    *(*pMerger)
                        .aTree
                ...
                *__pMerger_ref.aTree.offset(i as isize) = pReadr2.offset_from(__pMerger_ref.aReadr)
                    as ::core::ffi::c_long
                    as ::core::ffi::c_int;
                pReadr1 = __pMerger_ref.aReadr.offset(
                    *(*pMerger)
                        .aTree
                        .offset((i ^ 0x1 as ::core::ffi::c_int) as isize)
                        as isize,
...
unsafe extern "C" fn vdbeSorterFlushThread(
    ...
    let rc: ::core::ffi::c_int = vdbeSorterListToPMA(pTask, &raw mut (*pTask).list);
...
unsafe extern "C" fn vdbeSorterFlushPMA(pSorter: *mut VdbeSorter) -> ::core::ffi::c_int {
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        if i == nWorker {
            ...
            let aMem: *mut crate::src::ext::rtree::rtree::U8_0 = (*pTask).list.aMemory;
            let pCtx: *mut ::core::ffi::c_void = pTask as *mut ::core::ffi::c_void;
            let __pSorter_ref = unsafe { &mut *pSorter };
            __pSorter_ref.iPrev =
                pTask.offset_from(&raw mut __pSorter_ref.aTask as *mut SortSubtask)
                    as ::core::ffi::c_long as crate::src::ext::rtree::rtree::U8_0;
            (*pTask).list = __pSorter_ref.list;
            __pSorter_ref.list.pList = ::core::ptr::null_mut::<SorterRecord>();
            __pSorter_ref.list.szPMA = 0 as crate::src::ext::rtree::rtree::I64_0;
            if !aMem.is_null() {
                __pSorter_ref.list.aMemory = aMem;
                __pSorter_ref.nMemory =
                    crate::src::src::malloc::sqlite3MallocSize(aMem as *const ::core::ffi::c_void);
            } else if !__pSorter_ref.list.aMemory.is_null() {
                __pSorter_ref.list.aMemory = crate::src::src::malloc::sqlite3Malloc(
                    __pSorter_ref.nMemory as crate::src::ext::rtree::rtree::U64_0,
                )
                    as *mut crate::src::ext::rtree::rtree::U8_0;
                if __pSorter_ref.list.aMemory.is_null() {
                    return crate::src::headers::sqliteInt_h::SQLITE_NOMEM_BKPT;
...
pub unsafe extern "C" fn sqlite3VdbeSorterWrite(
    ...
    t = *(__pVal_ref.z.offset(1_isize) as *mut ::core::ffi::c_char
        as *const crate::src::ext::rtree::rtree::U8_0)
        as crate::src::ext::rtree::rtree::U32_0 as ::core::ffi::c_int;
    if t >= 0x80 as ::core::ffi::c_int {
        crate::src::src::util::sqlite3GetVarint32(
            __pVal_ref.z.offset(1_isize) as *mut ::core::ffi::c_char
                as *const ::core::ffi::c_uchar,
            &raw mut t as *mut crate::src::ext::rtree::rtree::U32_0,
        );
    }
    if t > 0 as ::core::ffi::c_int && t < 10 as ::core::ffi::c_int && t != 7 as ::core::ffi::c_int {
        (*pSorter).typeMask = ((*pSorter).typeMask as ::core::ffi::c_int & SORTER_TYPE_INTEGER)
            as crate::src::ext::rtree::rtree::U8_0;
    } else if t > 10 as ::core::ffi::c_int && t & 0x1 as ::core::ffi::c_int != 0 {
        (*pSorter).typeMask = ((*pSorter).typeMask as ::core::ffi::c_int & SORTER_TYPE_TEXT)
            as crate::src::ext::rtree::rtree::U8_0;
    } else {
        (*pSorter).typeMask = 0 as crate::src::ext::rtree::rtree::U8_0;
    }
    let nReq: crate::src::ext::rtree::rtree::I64_0 = (__pVal_ref.n as usize).wrapping_add(::core::mem::size_of::<SorterRecord>() as usize)
        as crate::src::ext::rtree::rtree::I64_0;
    let nPMA: crate::src::ext::rtree::rtree::I64_0 = (__pVal_ref.n
        + crate::src::src::util::sqlite3VarintLen(
            __pVal_ref.n as crate::src::ext::rtree::rtree::U64_0,
        )) as crate::src::ext::rtree::rtree::I64_0;
    if (*pSorter).mxPmaSize != 0 {
        if !(*pSorter).list.aMemory.is_null() {
            let __pSorter_ref = unsafe { &*pSorter };
            bFlush = (__pSorter_ref.iMemory != 0
                && __pSorter_ref.iMemory as crate::src::ext::rtree::rtree::I64_0 + nReq
                    > __pSorter_ref.mxPmaSize as crate::src::ext::rtree::rtree::I64_0)
                as ::core::ffi::c_int;
        } else {
            let __pSorter_ref = unsafe { &*pSorter };
            bFlush = (__pSorter_ref.list.szPMA
                > __pSorter_ref.mxPmaSize as crate::src::ext::rtree::rtree::I64_0
                || __pSorter_ref.list.szPMA
                    > __pSorter_ref.mnPmaSize as crate::src::ext::rtree::rtree::I64_0
                    && crate::src::src::malloc::sqlite3HeapNearlyFull() != 0)
                as ::core::ffi::c_int;
        }
        if bFlush != 0 {
            rc = vdbeSorterFlushPMA(pSorter);
            (*pSorter).list.szPMA = 0 as crate::src::ext::rtree::rtree::I64_0;
            (*pSorter).iMemory = 0 as ::core::ffi::c_int;
        }
    }
    (*pSorter).list.szPMA += nPMA;
    if nPMA > (*pSorter).mxKeysize as crate::src::ext::rtree::rtree::I64_0 {
    ...
    if !(*pSorter).list.aMemory.is_null() {
        ...
        if nMin > __pSorter_ref.nMemory {
            ...
            if !__pSorter_ref.list.pList.is_null() {
                iListOff = (__pSorter_ref.list.pList as *mut crate::src::ext::rtree::rtree::U8_0)
                    .offset_from(__pSorter_ref.list.aMemory)
                    as ::core::ffi::c_long as ::core::ffi::c_int;
            }
            while nNew < nMin as crate::src::headers::sqlite3_h::Sqlite3Int64 {
                nNew *= 2 as crate::src::headers::sqlite3_h::Sqlite3Int64;
            }
            if nNew > __pSorter_ref.mxPmaSize as crate::src::headers::sqlite3_h::Sqlite3Int64 {
                nNew = __pSorter_ref.mxPmaSize as crate::src::headers::sqlite3_h::Sqlite3Int64;
            }
            if nNew < nMin as crate::src::headers::sqlite3_h::Sqlite3Int64 {
                nNew = nMin as crate::src::headers::sqlite3_h::Sqlite3Int64;
            }
            let aNew: *mut crate::src::ext::rtree::rtree::U8_0 = crate::src::src::malloc::sqlite3Realloc(
            ...
            if iListOff >= 0 as ::core::ffi::c_int {
                __pSorter_ref.list.pList = aNew.offset(iListOff as isize)
                    as *mut crate::src::ext::rtree::rtree::U8_0
                    as *mut SorterRecord;
            }
            __pSorter_ref.list.aMemory = aNew;
            __pSorter_ref.nMemory = nNew as ::core::ffi::c_int;
        }
        pNew = __pSorter_ref
            .list
            .aMemory
        ...
        pNew = crate::src::src::malloc::sqlite3Malloc(nReq as crate::src::ext::rtree::rtree::U64_0)
            as *mut SorterRecord;
        if pNew.is_null() {
            return crate::src::headers::sqliteInt_h::SQLITE_NOMEM_BKPT;
        }
...
unsafe extern "C" fn vdbeIncrPopulate(pIncr: *mut IncrMerger) -> ::core::ffi::c_int {
    ...
    let pOut: *mut SorterFile =
        (&raw mut __pIncr_ref.aFile as *mut SorterFile).offset(1_isize) as *mut SorterFile;
    ...
    while rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        ...
        let pReader: *mut PmaReader = (*pMerger)
            .aReadr
            .offset(*(*pMerger).aTree.offset(1_isize) as isize)
            as *mut PmaReader;
        ...
        if iEof
            ...
            + crate::src::src::util::sqlite3VarintLen(nKey as crate::src::ext::rtree::rtree::U64_0)
                as crate::src::ext::rtree::rtree::I64_0
            > iStart + __pIncr_ref.mxSz as crate::src::ext::rtree::rtree::I64_0
        {
            break;
        }
        vdbePmaWriteVarint(
            &raw mut writer,
            nKey as crate::src::ext::rtree::rtree::U64_0,
        );
        vdbePmaWriteBlob(&raw mut writer, __pReader_ref.aKey, nKey);
        rc = vdbeMergeEngineStep(__pIncr_ref.pMerger, &raw mut dummy);
    }
    let rc2: ::core::ffi::c_int = vdbePmaWriterFinish(
        &raw mut writer,
        &raw mut (*pOut).iEof,
...
unsafe extern "C" fn vdbeIncrSwap(pIncr: *mut IncrMerger) -> ::core::ffi::c_int {
    ...
    if (*pIncr).bUseThread != 0 {
        ...
        __pIncr_ref.aFile[0 as ::core::ffi::c_int as usize] =
            __pIncr_ref.aFile[1 as ::core::ffi::c_int as usize];
        if __pIncr_ref.aFile[0 as ::core::ffi::c_int as usize].iEof == __pIncr_ref.iStartOff {
...
unsafe extern "C" fn vdbeIncrMergerNew(
    ...
    *ppOut = (if crate::src::src::util::sqlite3FaultSim(100 as ::core::ffi::c_int) != 0 {
        ...
        crate::src::src::malloc::sqlite3MallocZero(
    ...
    if !pIncr.is_null() {
        ...
        __pIncr_ref.pTask = pTask;
        let __pTask_ref = unsafe { &mut *pTask };
        __pIncr_ref.mxSz = if (*__pTask_ref.pSorter).mxKeysize + 9 as ::core::ffi::c_int
            > (*__pTask_ref.pSorter).mxPmaSize / 2 as ::core::ffi::c_int
        {
            (*__pTask_ref.pSorter).mxKeysize + 9 as ::core::ffi::c_int
        } else {
            (*__pTask_ref.pSorter).mxPmaSize / 2 as ::core::ffi::c_int
        };
...
unsafe extern "C" fn vdbeMergeEngineCompare(
    ...
    let p1: *mut PmaReader = __pMerger_ref.aReadr.offset(i1 as isize) as *mut PmaReader;
    let p2: *mut PmaReader = __pMerger_ref.aReadr.offset(i2 as isize) as *mut PmaReader;
    if (*p1).pFd.is_null() {
        iRes = i2;
    ...
    *__pMerger_ref.aTree.offset(iOut as isize) = iRes;
}
...
unsafe extern "C" fn vdbeMergeEngineInit(
    ...
    let nTree: ::core::ffi::c_int = __pMerger_ref.nTree;
    i = 0 as ::core::ffi::c_int;
    while i < nTree {
            ...
            && eMode == INCRINIT_ROOT
        {
            ...
            rc = vdbePmaReaderIncrInit(
                __pMerger_ref.aReadr.offset(i as isize) as *mut PmaReader,
                INCRINIT_NORMAL,
            );
        }
        if rc != crate::src::headers::sqlite3_h::SQLITE_OK {
    ...
    i = __pMerger_ref.nTree - 1 as ::core::ffi::c_int;
    while i > 0 as ::core::ffi::c_int {
...
unsafe extern "C" fn vdbePmaReaderIncrMergeInit(
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        ...
        if __pIncr_ref.bUseThread != 0 {
            rc = vdbeSorterOpenTempFile(
                ...
                &raw mut (*(&raw mut __pIncr_ref.aFile as *mut SorterFile).offset(0_isize)).pFd,
            );
            if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
                rc = vdbeSorterOpenTempFile(
                    db,
                    mxSz as crate::src::ext::rtree::rtree::I64_0,
                    &raw mut (*(&raw mut __pIncr_ref.aFile as *mut SorterFile).offset(1_isize))
                        .pFd,
                );
            }
        } else {
            if (*pTask).file2.pFd.is_null() {
                ...
                rc = vdbeSorterOpenTempFile(
                    db,
                    __pTask_ref.file2.iEof,
                    &raw mut __pTask_ref.file2.pFd,
                );
            ...
            if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
                ...
                __pTask_ref.file2.iEof += mxSz as crate::src::ext::rtree::rtree::I64_0;
            }
        }
    }
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK
        && (crate::src::headers::sqliteInt_h::SQLITE_MAX_WORKER_THREADS == 0 as ::core::ffi::c_int
            || eMode != INCRINIT_TASK)
    {
        rc = vdbePmaReaderNext(pReadr);
    }
...
unsafe extern "C" fn vdbeMergeEngineLevel0(
    ...
    let mut i: ::core::ffi::c_int;
    let mut rc: ::core::ffi::c_int = crate::src::headers::sqlite3_h::SQLITE_OK;
    let pNew: *mut MergeEngine = vdbeMergeEngineNew(nPMA);
    *ppOut = pNew;
    if pNew.is_null() {
        rc = crate::src::headers::sqliteInt_h::SQLITE_NOMEM_BKPT;
    }
...
unsafe extern "C" fn vdbeSorterAddToTree(
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        let fresh3 = &mut (*(*p).aReadr.offset((iSeq % SORTER_MAX_MERGE_COUNT) as isize)).pIncr;
        *fresh3 = pIncr;
    } else {
        vdbeIncrFree(pIncr);
    }
            ...
            || (*pTask).nPMA != 0
        {
            ...
            if (*pTask).nPMA <= SORTER_MAX_MERGE_COUNT {
                ...
                while i < (*pTask).nPMA && rc == crate::src::headers::sqlite3_h::SQLITE_OK {
                    ...
                    let nReader: ::core::ffi::c_int = if (*pTask).nPMA - i < 16 as ::core::ffi::c_int {
                        (*pTask).nPMA - i
                    } else {
...
unsafe extern "C" fn vdbeSorterSetupMerge(pSorter: *mut VdbeSorter) -> ::core::ffi::c_int {
    ...
    let pTask0: *mut SortSubtask =
        (&raw mut (*pSorter).aTask as *mut SortSubtask).offset(0_isize) as *mut SortSubtask;
    let mut pMain: *mut MergeEngine = ::core::ptr::null_mut::<MergeEngine>();
    ...
    while i < (*pSorter).nTask as ::core::ffi::c_int {
        let fresh1 = &mut (*(&raw mut (*pSorter).aTask as *mut SortSubtask).offset(i as isize)).xCompare;
        *fresh1 = xCompare;
        i += 1;
    }
    ...
    if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
        if (*pSorter).bUseThreads != 0 {
            ...
            if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
                pReadr = crate::src::src::malloc::sqlite3DbMallocZero(
                    db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                    ::core::mem::size_of::<PmaReader>() as crate::src::ext::rtree::rtree::U64_0,
                ) as *mut PmaReader;
            ...
            if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
                ...
                if rc == crate::src::headers::sqlite3_h::SQLITE_OK {
                    ...
                    while iTask < (*pSorter).nTask as ::core::ffi::c_int - 1 as ::core::ffi::c_int {
                        ...
                        let pIncr: *mut IncrMerger = (*(*pMain).aReadr.offset(iTask as isize)).pIncr;
                        if !pIncr.is_null() {
    ...
    if (*pSorter).bUsePMA as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
        if !(*pSorter).list.pList.is_null() {
            *pbEof = 0 as ::core::ffi::c_int;
            rc = vdbeSorterSort(
                (&raw mut (*pSorter).aTask as *mut SortSubtask).offset(0_isize)
                    as *mut SortSubtask,
                &raw mut (*pSorter).list,
            );
        } else {
...
unsafe extern "C" fn vdbeSorterRowkey(
    ...
    if (*pSorter).bUsePMA != 0 {
        ...
        *pnKey = (*(*pSorter).list.pList).nVal;
        pKey = (*pSorter).list.pList.offset(1_isize) as *mut ::core::ffi::c_void;
    }
    pKey
}
#[cfg_attr(feature = "test", unsafe(no_mangle))]
...
pub unsafe extern "C" fn sqlite3VdbeSorterRowkey(
    ...
    let pSorter: *mut VdbeSorter = (*pCsr).uc.pSorter;
    let pKey: *mut ::core::ffi::c_void = vdbeSorterRowkey(pSorter, &raw mut nKey);
...
pub unsafe extern "C" fn sqlite3VdbeSorterCompare(
    ...
    let pKeyInfo: *mut crate::src::headers::sqliteInt_h::KeyInfo = (*pCsr).pKeyInfo;
    if r2.is_null() {
        (*pSorter).pUnpacked = crate::src::src::vdbeaux::sqlite3VdbeAllocUnpackedRecord(
    ...
    i = 0 as ::core::ffi::c_int;
    while i < nKeyCol {
        if (*(*r2).aMem.offset(i as isize)).flags as ::core::ffi::c_int
    ...
    *pRes = crate::src::src::vdbeaux::sqlite3VdbeRecordCompare(
        (*pVal).n,
