...
pub use crate::src::headers::opcodes_h::OP_LoadAnalysis;
...
pub use crate::src::headers::sqlite3_h::SQLITE_ANALYZE;
...
pub use crate::src::headers::sqliteInt_h::TRowcnt;
...
pub use crate::src::src::build::sqlite3DefaultRowEst;
pub use crate::src::src::build::sqlite3FindDb;
...
unsafe extern "C" fn openStatTable(
    ...
    iDb: ::core::ffi::c_int,
    iStatCur: ::core::ffi::c_int,
    zWhere: *const ::core::ffi::c_char,
    zWhereType: *const ::core::ffi::c_char,
) {
    ...
    while i
        < (::core::mem::size_of::<[C2RustUnnamed; 3]>() as usize)
            ...
            as ::core::ffi::c_int
    {
        let zTab: *const ::core::ffi::c_char = aTable[i as usize].zName;
        
        aCreateTbl[i as usize] = 0 as crate::src::ext::rtree::rtree::U8_0;
        let pStat: *mut crate::src::headers::sqliteInt_h::Table = crate::src::src::build::sqlite3FindTable(
        ...
        if pStat.is_null() {
            if i < nToOpen {
                ...
                aCreateTbl[i as usize] = crate::src::headers::sqliteInt_h::OPFLAG_P2ISREG
    ...
    while i < nToOpen {
        ...
        crate::src::src::vdbeaux::sqlite3VdbeChangeP5(
            v,
            aCreateTbl[i as usize] as crate::src::fts5::U16_0,
        );
        i += 1;
    }
}

unsafe extern "C" fn statAccumDestructor(pOld: *mut ::core::ffi::c_void) {
    let p: *mut StatAccum = pOld as *mut StatAccum;
...
unsafe extern "C" fn statInit(
    ...
    let nCol: ::core::ffi::c_int = crate::src::src::vdbeapi::sqlite3_value_int(*argv.offset(0_isize));
    ...
    let nKeyCol: ::core::ffi::c_int = crate::src::src::vdbeapi::sqlite3_value_int(*argv.offset(1_isize));
    let n: crate::src::ext::rtree::rtree::I64_0 = (::core::mem::size_of::<StatAccum>() as usize).wrapping_add(
        (::core::mem::size_of::<crate::src::headers::sqliteInt_h::TRowcnt>() as usize)
            .wrapping_mul(nColUp as usize),
    ) as crate::src::ext::rtree::rtree::I64_0;
    let p: *mut StatAccum = crate::src::src::malloc::sqlite3DbMallocZero(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
    ...
    (*p).db = db;
    (*p).nEst = crate::src::src::vdbeapi::sqlite3_value_int64(*argv.offset(2_isize))
        as crate::src::headers::sqliteInt_h::TRowcnt;
    (*p).nRow = 0 as crate::src::headers::sqliteInt_h::TRowcnt;
    (*p).nLimit = crate::src::src::vdbeapi::sqlite3_value_int(*argv.offset(3_isize));
    (*p).nCol = nCol;
    (*p).nKeyCol = nKeyCol;
    (*p).nSkipAhead = 0 as crate::src::ext::rtree::rtree::U8_0;
    (*p).current.anDLt =
        p.offset(1_isize) as *mut StatAccum as *mut crate::src::headers::sqliteInt_h::TRowcnt;
...
static mut statInitFuncdef: crate::src::headers::sqliteInt_h::FuncDef = {
    crate::src::headers::sqliteInt_h::FuncDef {
        ...
        funcFlags: crate::src::headers::sqlite3_h::SQLITE_UTF8
...
unsafe extern "C" fn statPush(
    ...
    let mut i: ::core::ffi::c_int;
    let p: *mut StatAccum =
        crate::src::src::vdbeapi::sqlite3_value_blob(*argv.offset(0_isize)) as *mut StatAccum;
    let iChng: ::core::ffi::c_int =
        crate::src::src::vdbeapi::sqlite3_value_int(*argv.offset(1_isize));
    let __p_ref = { &mut *p };
    if (__p_ref.nRow != 0 as crate::src::headers::sqliteInt_h::TRowcnt) {
        i = iChng;
        while i < __p_ref.nCol {
            let fresh11 = &mut *__p_ref.current.anDLt.offset(i as isize);
    ...
    if __p_ref.nLimit != 0
        && __p_ref.nRow
            > (__p_ref.nLimit as crate::src::headers::sqliteInt_h::TRowcnt).wrapping_mul(
                (__p_ref.nSkipAhead as ::core::ffi::c_int + 1 as ::core::ffi::c_int)
                    as crate::src::headers::sqliteInt_h::TRowcnt,
            )
    {
        ...
        crate::src::src::vdbeapi::sqlite3_result_int(
            context,
            (*__p_ref.current.anDLt.offset(0_isize)
                > 0 as crate::src::headers::sqliteInt_h::TRowcnt) as ::core::ffi::c_int,
        );
    }
}
...
unsafe extern "C" fn statGet(
    ...
    while i < __p_ref.nKeyCol {
        let nDistinct: crate::src::ext::rtree::rtree::U64_0 =
            (*__p_ref.current.anDLt.offset(i as isize) as crate::src::ext::rtree::rtree::U64_0)
                .wrapping_add(1 as crate::src::ext::rtree::rtree::U64_0);
        let mut iVal: crate::src::ext::rtree::rtree::U64_0 = (__p_ref.nRow
        ...
        if iVal == 2 as crate::src::ext::rtree::rtree::U64_0
            && __p_ref
                ...
                <= nDistinct.wrapping_mul(11 as crate::src::ext::rtree::rtree::U64_0)
        {
...
unsafe extern "C" fn analyzeOneTable(
    ...
    pOnlyIdx: *mut crate::src::headers::sqliteInt_h::Index,
    iStatCur: ::core::ffi::c_int,
    ...
    let mut i: ::core::ffi::c_int;
    let jZeroRows: ::core::ffi::c_int;
    
    let mut needTableCnt: crate::src::ext::rtree::rtree::U8_0 =
        1 as crate::src::ext::rtree::rtree::U8_0;
    let fresh0 = iMem;
    iMem += 1;
    let regNewRowid: ::core::ffi::c_int = fresh0;
    let fresh1 = iMem;
    iMem += 1;
    let regStat: ::core::ffi::c_int = fresh1;
    let fresh2 = iMem;
    iMem += 1;
    let regChng: ::core::ffi::c_int = fresh2;
    let fresh3 = iMem;
    iMem += 1;
    let regRowid: ::core::ffi::c_int = fresh3;
    let fresh4 = iMem;
    iMem += 1;
    let regTemp: ::core::ffi::c_int = fresh4;
    let fresh5 = iMem;
    iMem += 1;
    let regTemp2: ::core::ffi::c_int = fresh5;
    let fresh6 = iMem;
    iMem += 1;
    let regTabname: ::core::ffi::c_int = fresh6;
    let fresh7 = iMem;
    iMem += 1;
    let regIdxname: ::core::ffi::c_int = fresh7;
    let fresh8 = iMem;
    iMem += 1;
    let regStat1: ::core::ffi::c_int = fresh8;
    let regPrev: ::core::ffi::c_int = iMem;
    let mut pStat1: *mut crate::src::headers::sqliteInt_h::Table =
    ...
    if (*db).xPreUpdateCallback.is_some() {
        pStat1 = crate::src::src::malloc::sqlite3DbMallocZero(
            ...
            (::core::mem::size_of::<crate::src::headers::sqliteInt_h::Table>() as usize)
                .wrapping_add(13_usize) as crate::src::ext::rtree::rtree::U64_0,
        ) as *mut crate::src::headers::sqliteInt_h::Table;
        if pStat1.is_null() {
            return;
        }
        (*pStat1).zName = pStat1.offset(1_isize) as *mut crate::src::headers::sqliteInt_h::Table
    ...
    let fresh9 = iTab;
    iTab += 1;
    let iTabCur: ::core::ffi::c_int = fresh9;
    let fresh10 = iTab;
    iTab += 1;
    let iIdxCur: ::core::ffi::c_int = fresh10;
    ...
    while !pIdx.is_null() {
        ...
        let mut addrGotoEnd: ::core::ffi::c_int;
        let mut addrNextRow: ::core::ffi::c_int;
        let zIdxName: *const ::core::ffi::c_char;
        let nColTest: ::core::ffi::c_int;
        if !(!pOnlyIdx.is_null() && pOnlyIdx != pIdx) {
            ...
            if (__pTab_ref.tabFlags
                ...
                && __pIdx_ref.idxType() as ::core::ffi::c_int
            ...
            crate::src::src::vdbeaux::sqlite3VdbeAddOp3(
                ...
                iIdxCur,
                regTemp,
                ((*db).dbOptFlags & 0x800 as crate::src::ext::rtree::rtree::U32_0
            ...
            crate::src::src::vdbeaux::sqlite3VdbeAddFunctionCall(
                ...
                regStat,
                4 as ::core::ffi::c_int,
                &raw const statInitFuncdef as *const _
                    as *const crate::src::headers::sqliteInt_h::FuncDef,
                0 as ::core::ffi::c_int,
            );
            addrGotoEnd = crate::src::src::vdbeaux::sqlite3VdbeAddOp1(
                v,
            ...
            if nColTest > 0 as ::core::ffi::c_int {
                let endDistinctTest: ::core::ffi::c_int =
                    crate::src::src::vdbeaux::sqlite3VdbeMakeLabel(
                        pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                    );
                
                let aGotoChng: *mut ::core::ffi::c_int = crate::src::src::malloc::sqlite3DbMallocRawNN(
                    db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                    (::core::mem::size_of::<::core::ffi::c_int>() as usize)
                        .wrapping_mul(nColTest as usize)
                        as crate::src::ext::rtree::rtree::U64_0,
                ...
                if aGotoChng.is_null() {
                    ...
                    if nColTest == 1 as ::core::ffi::c_int
                        && __pIdx_ref.nKeyCol as ::core::ffi::c_int == 1 as ::core::ffi::c_int
                        && __pIdx_ref.onError as ::core::ffi::c_int
                    ...
                    i = 0 as ::core::ffi::c_int;
                    while i < nColTest {
                        let pColl: *mut ::core::ffi::c_char =
                            crate::src::src::callback::sqlite3LocateCollSeq(
                                pParse as *mut crate::src::headers::sqliteInt_h::Parse,
                                *__pIdx_ref.azColl.offset(i as isize),
                            )
                    ...
                    crate::src::src::vdbeaux::sqlite3VdbeJumpHere(
                        v,
                        addrNextRow - 1 as ::core::ffi::c_int,
                    );
                    i = 0 as ::core::ffi::c_int;
                    while i < nColTest {
                        crate::src::src::vdbeaux::sqlite3VdbeJumpHere(
                            v,
                            *aGotoChng.offset(i as isize),
                        );
                        crate::src::src::vdbeaux::sqlite3VdbeAddOp3(
                            v,
                            crate::src::headers::opcodes_h::OP_Column,
                    ...
                    crate::src::src::malloc::sqlite3DbFree(
                        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                        aGotoChng as *mut ::core::ffi::c_void,
                    );
            ...
            match current_block_123 {
                ...
                _ => {
                    crate::src::src::vdbeaux::sqlite3VdbeAddFunctionCall(
                        ...
                        &raw const statPushFuncdef as *const _
                            as *const crate::src::headers::sqliteInt_h::FuncDef,
                        0 as ::core::ffi::c_int,
                    );
                    if (*db).nAnalysisLimit != 0 {
                        ...
                        let j1: ::core::ffi::c_int = crate::src::src::vdbeaux::sqlite3VdbeAddOp1(
                            v,
                            crate::src::headers::opcodes_h::OP_IsNull,
                            regTemp,
                        );
                        let j2: ::core::ffi::c_int = crate::src::src::vdbeaux::sqlite3VdbeAddOp1(
                            v,
                            crate::src::headers::opcodes_h::OP_If,
                            regTemp,
                        );
                        let j3: ::core::ffi::c_int = crate::src::src::vdbeaux::sqlite3VdbeAddOp4Int(
                            v,
    ...
    if pOnlyIdx.is_null() && needTableCnt as ::core::ffi::c_int != 0 {
        ...
        jZeroRows = crate::src::src::vdbeaux::sqlite3VdbeAddOp1(
            v,
...
unsafe extern "C" fn loadAnalysis(
    pParse: *mut crate::src::headers::sqliteInt_h::Parse,
    iDb: ::core::ffi::c_int,
) {
    let v: *mut crate::src::headers::vdbeInt_h::Vdbe = crate::src::src::select::sqlite3GetVdbe(
    ...
    if !v.is_null() {
        crate::src::src::vdbeaux::sqlite3VdbeAddOp1(
            v,
            crate::src::headers::opcodes_h::OP_LoadAnalysis,
            iDb,
        );
    }
}

unsafe extern "C" fn analyzeDatabase(
    pParse: *mut crate::src::headers::sqliteInt_h::Parse,
    iDb: ::core::ffi::c_int,
) {
    let __pParse_ref = { &mut *pParse };
    ...
    let pSchema: *mut crate::src::headers::sqliteInt_h::Schema =
        (*(*db).aDb.offset(iDb as isize)).pSchema;
    ...
    let iStatCur: ::core::ffi::c_int = __pParse_ref.nTab;
    ...
    let iMem: ::core::ffi::c_int = __pParse_ref.nMem + 1 as ::core::ffi::c_int;
    let iTab: ::core::ffi::c_int = __pParse_ref.nTab;
...
pub unsafe extern "C" fn sqlite3Analyze(
    ...
    let mut pTableName: *mut crate::src::headers::sqliteInt_h::Token =
    ...
    if pName1.is_null() {
        ...
        iDb = crate::src::src::build::sqlite3FindDb(
            db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        ...
        iDb = crate::src::src::build::sqlite3TwoPartName(
            ...
            &raw mut pTableName as *mut _ as *mut *mut crate::src::headers::sqliteInt_h::Token,
        );
        if iDb >= 0 as ::core::ffi::c_int {
            ...
            z = crate::src::src::build::sqlite3NameFromToken(
                db as *mut crate::src::headers::sqliteInt_h::sqlite3,
                pTableName as *const crate::src::headers::sqliteInt_h::Token,
            );
            if !z.is_null() {
...
unsafe extern "C" fn decodeIntArray(
    ...
    while *z as ::core::ffi::c_int != 0 && i < nOut {
        ...
        *aLog.offset(i as isize) =
            crate::src::src::util::sqlite3LogEst(v as crate::src::ext::rtree::rtree::U64_0);
    ...
    while *z.offset(0_isize) != 0 {
        ...
        ) == 0 as ::core::ffi::c_int
        {
            ...
            b"sz=[0-9]*\0" as *const u8 as *const ::core::ffi::c_char,
            z,
        ) == 0 as ::core::ffi::c_int
        {
            let mut sz: ::core::ffi::c_int =
                crate::src::src::util::sqlite3Atoi(z.offset(3_isize));
            if sz < 2 as ::core::ffi::c_int {
                sz = 2 as ::core::ffi::c_int;
            }
            (*pIndex).szIdxRow =
                crate::src::src::util::sqlite3LogEst(sz as crate::src::ext::rtree::rtree::U64_0);
        } else if crate::src::src::func::sqlite3_strglob(
        ...
        while *z.offset(0_isize) as ::core::ffi::c_int != 0 as ::core::ffi::c_int
            && *z.offset(0_isize) as ::core::ffi::c_int != ' ' as i32
        {
            z = z.offset(1);
        }
        while *z.offset(0_isize) as ::core::ffi::c_int == ' ' as i32 {
            z = z.offset(1);
        }
    }
}
...
unsafe extern "C" fn analysisLoader(
    ...
    let pInfo: *mut analysisInfo = pData as *mut analysisInfo;
    let pIndex: *mut crate::src::headers::sqliteInt_h::Index;
    
    
    if argv.is_null()
        || (*argv.offset(0_isize)).is_null()
        || (*argv.offset(2_isize)).is_null()
    {
        return 0 as ::core::ffi::c_int;
    }
    let pTable: *mut crate::src::headers::sqliteInt_h::Table = crate::src::src::build::sqlite3FindTable(
    ...
    if (*argv.offset(1_isize)).is_null() {
    ...
    {
        pIndex = crate::src::src::build::sqlite3PrimaryKeyIndex(
    ...
    let z: *const ::core::ffi::c_char = *argv.offset(2_isize);
    if !pIndex.is_null() {
        let aiRowEst: *mut crate::src::headers::sqliteInt_h::TRowcnt =
        ...
        if __pIndex_ref.pPartIdxWhere.is_null() {
            (*pTable).nRowLogEst = *(*pIndex).aiRowLogEst.offset(0_isize);
            (*pTable).tabFlags |= crate::src::headers::sqliteInt_h::TF_HasStat1
                as crate::src::ext::rtree::rtree::U32_0;
        }
    } else {
...
pub unsafe extern "C" fn sqlite3DeleteIndexSamples(
    mut _db: *mut crate::src::headers::sqliteInt_h::sqlite3,
    mut _pIdx: *mut crate::src::headers::sqliteInt_h::Index,
) {
}
pub unsafe extern "C" fn sqlite3AnalysisLoad(
    ...
    while !i.is_null() {
        let pIdx: *mut crate::src::headers::sqliteInt_h::Index =
            (*i).data as *mut crate::src::headers::sqliteInt_h::Index;
        (*pIdx).set_hasStat1(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
        i = (*i).next;
    }
    sInfo.db = db;
    sInfo.zDatabase = (*(*db).aDb.offset(iDb as isize)).zDbSName;
    let pStat1: *const crate::src::headers::sqliteInt_h::Table = crate::src::src::build::sqlite3FindTable(
        db as *mut crate::src::headers::sqliteInt_h::sqlite3,
        b"sqlite_stat1\0" as *const u8 as *const ::core::ffi::c_char,
        sInfo.zDatabase,
    ) as *mut crate::src::headers::sqliteInt_h::Table;
    if !pStat1.is_null()
        && (*pStat1).eTabType as ::core::ffi::c_int == crate::src::headers::sqliteInt_h::TABTYP_NORM
    {
        zSql = crate::src::printf_c_variadic::sqlite3MPrintf_args(
            ...
            &[crate::src::src::printf::PrintfArg::Str(
                sInfo.zDatabase as *mut ::core::ffi::c_char,
            )],
        );
        if zSql.is_null() {
    ...
    i = __pSchema_ref.idxHash.first;
    while !i.is_null() {
        let pIdx_0: *mut crate::src::headers::sqliteInt_h::Index =
            (*i).data as *mut crate::src::headers::sqliteInt_h::Index;
        if (*pIdx_0).hasStat1() == 0 {
            crate::src::src::build::sqlite3DefaultRowEst(
